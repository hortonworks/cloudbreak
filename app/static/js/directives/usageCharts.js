    ...
    return {
        ...
        link: function(scope, element) {
            ...
            function createUsageCharts(value) {
                ...
                if (value.cloud == 'all') {
                    element.append('<div class="col-xs-12 col-sm-12 col-md-12">' + '<div id="unitedChartLegend" class="col-xs-1 col-sm-2 col-md-2 legend" />' + '<div id="unitedChart" class="col-xs-8 col-sm-10 col-md-10" /></div>');
