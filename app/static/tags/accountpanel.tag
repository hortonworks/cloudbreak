                                    ...
                                    <table class="table table-bordered table-striped responsive-utilities">
                                        ...
                                        <tbody >
                                            <tr>
                                                ...
                                                <td class="is-visible"><input type="checkbox" disabled name="bpch1" id="bpch1" ng-checked="isWriteScope('blueprints', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Recipes</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="recch1" id="recch1" ng-checked="isWriteScope('recipes', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Templates</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="tmch1" id="tmch1" ng-checked="isWriteScope('templates', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Credentials</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="crch1" id="crch1" ng-checked="isWriteScope('credentials', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Stacks</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="stch1" id="stch1" ng-checked="isWriteScope('stacks', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Networks</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="nwcrch1" id="nwcrch1" ng-checked="isWriteScope('templates', userDetails.groups)"></td>
                                            </tr>
                                            <tr>
                                                <th scope="row">Security Groups</th>
                                                <td class="is-visible"><input type="checkbox" disabled name="sgstch1" id="sgstch1" ng-checked="isWriteScope('templates', userDetails.groups)"></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
