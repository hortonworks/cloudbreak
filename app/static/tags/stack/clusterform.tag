                ...
                <form class="form-horizontal" role="form" name="$parent.clusterCreationForm">
                    ...
                    <div class="form-group" ng-show="activeCredential.cloudPlatform == 'AZURE' || activeCredential.cloudPlatform == 'AZURE_RM' || activeCredential.cloudPlatform == 'GCP'">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" id="selectFileSystem" ng-model="cluster.fileSystem.type" >
                                ...
                                <option value="DASH" ng-show="activeCredential.cloudPlatform == 'AZURE' || activeCredential.cloudPlatform == 'AZURE_RM'">{{msg.filesystem_dash_label}}</option>
                                <!--<option value="GCS" ng-show="activeCredential.cloudPlatform == 'GCP'">{{msg.filesystem_gcs_label}}</option>-->
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group" name="cluster_security1">
                         ...
                         <div class="col-sm-9">
                             ...
                             <div class="help-block"
                                  ng-show="cluster.enableSecurity"><i class="fa fa-warning"></i> {{msg.cluster_form_enable_security_hint}}
                             </div>
                         </div>
                    </div>
                    <div class="form-group" name="kerberos_master_key1" ng-show="cluster.enableSecurity" ng-class="{ 'has-error': clusterCreationForm.kerberos_master_key.$dirty && clusterCreationForm.kerberos_master_key.$invalid }">
                       ...
                       <div class="col-sm-9">
                          ...
                          <div class="help-block"
                               ng-show="clusterCreationForm.kerberos_master_key.$dirty && clusterCreationForm.kerberos_master_key.$invalid"><i class="fa fa-warning"></i> {{msg.cluster_kerberos_master_key_invalid}}
                          </div>
                       </div>
                    </div>
                    <div class="form-group" name="kerberos_admin1" ng-show="cluster.enableSecurity" ng-class="{ 'has-error': clusterCreationForm.kerberos_admin.$dirty && clusterCreationForm.kerberos_admin.$invalid }">
                       ...
                       <div class="col-sm-9">
                          ...
                          <div class="help-block"
                               ng-show="clusterCreationForm.kerberos_admin.$dirty && clusterCreationForm.kerberos_admin.$invalid"><i class="fa fa-warning"></i> {{msg.cluster_kerberos_admin}}
                          </div>
                       </div>
                    </div>
                    <div class="form-group" name="kerberos_password1" ng-show="cluster.enableSecurity" ng-class="{ 'has-error': clusterCreationForm.kerberos_password.$dirty && clusterCreationForm.kerberos_password.$invalid }">
                       ...
                       <div class="col-sm-9">
                          ...
                          <div class="help-block"
                               ng-show="clusterCreationForm.kerberos_password.$dirty && clusterCreationForm.kerberos_password.$invalid"><i class="fa fa-warning"></i> {{msg.cluster_kerberos_password}}
                          </div>
                       </div>
                    </div>
                    <div class="form-group" ng-show="showAdvancedOptionForm">
