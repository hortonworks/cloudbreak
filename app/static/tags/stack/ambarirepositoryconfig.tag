...
<div class="btn-group btn-group-justified" role="group" style="padding-top: 40px" aria-label="...">
    <div class="btn-group" role="group">
        <button type="button" class="btn btn-default" ng-click="showWizardActualElement('configureFailureAction')"><i class="fa fa-angle-double-left"></i> Configure Failure Action</button>
    </div>
