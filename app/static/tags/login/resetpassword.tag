<form role="form" autocomplete="on" name="resetPasswordForm">
    <div class="form-group" ng-class="{ 'has-error has-feedback': showResetPasswordError && resetPasswordForm.resetPasswField.$invalid }">
    ...
    <div class="form-group" ng-class="{ 'has-error has-feedback': resetPasswordForm.resetPassw2Field.$dirty && resetPasswordForm.resetPassw2Field.$invalid }">
