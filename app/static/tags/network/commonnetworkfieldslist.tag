<div class="form-group">
    <label class="col-sm-3 control-label" for="{{network.name}}">Name</label>
...
<div class="form-group" ng-show="network.description" ng-if="network.description != 'null'">
    <label class="col-sm-3 control-label" for="{{network.name}}-desc">Description</label>
...
<div class="form-group">
    <label class="col-sm-3 control-label" for="{{network.name}}-subnet">Subnet (CIDR)</label>
