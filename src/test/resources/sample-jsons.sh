...
curl -u cbuser@sequenceiq.com:test123 -sX POST -H "Content-Type:application/json" -d '{"cloudPlatform":"AWS","name":"awsinstancestemplate","parameters":{"region":"EU_WEST_1", "amiId":"ami-2f39f458", "keyName":"sequence-eu","sshLocation":"0.0.0.0/0","instanceType":"M1Small"}}' http://localhost:8080/templates | jq .
