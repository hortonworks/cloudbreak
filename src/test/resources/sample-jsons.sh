...
curl -u user@seq.com:test123 -X POST -H "Content-Type:application/json" -d '{"name":"smap123","url":"https://raw.githubusercontent.com/sequenceiq/ambari-rest-client/master/src/main/resources/blueprints/multi-node-hdfs-yarn"}' http://localhost:8080/blueprint | jq .
...
curl -u user@seq.com:test123 -sX POST -H "Content-Type:application/json" -d '{"url":"https://raw.githubusercontent.com/sequenceiq/ambari-rest-client/master/src/main/resources/blueprints/multi-node-hdfs-yarn"}' http://localhost:8080/blueprint | jq .
curl -u user@seq.com:test123 -sX POST -H "Content-Type:application/json" -d '{"clusterName":"full-cloudbreak-api","blueprintId":52}' http://localhost:8080/stack/51/cluster | jq .

curl -u user@seq.com:test123 -sX GET -H "Content-Type:application/json" http://localhost:8080/credential/51 | jq .
curl -u user@seq.com:test123 -sX GET -H "Content-Type:application/json" http://localhost:8080/template/51 | jq .
curl -u user@seq.com:test123 -sX GET -H "Content-Type:application/json" http://localhost:8080/stack/51 | jq .
curl -u user@seq.com:test123 -sX GET -H "Content-Type:application/json" http://localhost:8080/blueprint/52 | jq .
curl -u user@seq.com:test123 -sX GET -H "Content-Type:application/json" http://localhost:8080/stack/51/cluster | jq .
