...
curl -u user@seq.com:test123 -sX POST -H "Content-Type: application/json" -d '{"cloudPlatform":"AWS","name":"my-infra-1","parameters":{"region":"EU_WEST_1", "amiId":"1234", "keyName":"sequence-eu","addressPrefix":"172.16.0.0/16","subnetAddressPrefix":"172.16.0.0/24","instanceType":"M3Xlarge"}}' http://localhost:8080/template | jq .

curl -u user@seq.com:test123 -sX POST -H "Content-Type: application/json" -d '{"cloudPlatform":"AWS","name":"my-infra-1","parameters":{"region":"eu-west-1","keyName":"sequence-eu","addressPrefix":"172.16.0.0/16","subnetAddressPrefix":"172.16.0.0/24","instanceType":"M3.XLARGE"}}' http://localhost:8080/template | jq .
