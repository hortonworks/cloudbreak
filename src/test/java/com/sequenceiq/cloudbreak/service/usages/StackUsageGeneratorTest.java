...
public class StackUsageGeneratorTest {
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodThatIsLongerThanADay() throws Exception {
        ...
        Assert.assertEquals("The calculated hours of the last day is invalid", "24", usageList.get(4).getInstanceHours());
        Assert.assertEquals("The calculated hours of the last day is invalid", "2", usageList.get(usageList.size() - 1).getInstanceHours());
        Assert.assertEquals("The calculated hours of the first day is invalid", "1", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodThatIsLongerThanADayWithRounding() throws Exception {
        ...
        Assert.assertEquals("The calculated hours of the last day is invalid", "24", usageList.get(4).getInstanceHours());
        Assert.assertEquals("The calculated hours of the last day is invalid", "24", usageList.get(usageList.size() - 1).getInstanceHours());
        Assert.assertEquals("The calculated hours of the first day is invalid", "1", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodThatIsShorterThanAnHour() throws Exception {
        ...
        Assert.assertEquals("The start day is wrong", "1", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodThatIsShorterThanADay() throws Exception {
        ...
        //THEN
        Assert.assertTrue("The number of the generated usages is not the expected", usageList.size() == 1);
        Assert.assertEquals("The start day is wrong", "10", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateTwoUsageForBillingPeriodThatIsShorterThanADayAndBillingEventsOnDifferentDays() throws Exception {
        ...
        Assert.assertEquals("The start day is wrong", "10", usageList.get(0).getInstanceHours());
        Assert.assertEquals("The start day is wrong", "6", usageList.get(1).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodThatIsShorterThanADayAndRoundingNecessary() throws Exception {
        ...
        Assert.assertEquals("The start day is wrong", "4", usageList.get(0).getInstanceHours());
        Assert.assertEquals("The start day is wrong", "3", usageList.get(1).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateExactUsageForBillingPeriodWhenMultipleStartEventsExistOnTheSameDay() {
        ...
        // THEN
        Assert.assertTrue("The number of the generated usages is not the expected", usageList.size() == 1);
        Assert.assertEquals("The start day is wrong", "3", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateUsageForMultipleBillingPeriod() throws Exception {
        ...
        Assert.assertEquals("The number of the running hours is not the expected", "23", usageList.get(0).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "24", usageList.get(1).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "1", usageList.get(2).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "1", usageList.get(3).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateUsageForMultipleBillingPeriodOnTheSameDay() throws Exception {
        ...
        // THEN
        Assert.assertEquals("The number of the generated usages is not the expected", 2, usageList.size());
        Assert.assertEquals("The number of the running hours is not the expected", "1", usageList.get(0).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "1", usageList.get(1).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateUsageForStackThatIsStillRunningAndUsageTableIsNotEmpty() throws Exception {
        ...
        Assert.assertEquals("The number of the running hours is not the expected", "14", usageList.get(0).getInstanceHours());
    }
    ...
    public void testGenerateShouldCreateUsageForStackThatIsStillRunningAndUsageTableIsEmptyWithExactStartHour() throws Exception {
        ...
        Assert.assertEquals("The number of the running hours is not the expected", "14", usageList.get(0).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "24", usageList.get(1).getInstanceHours());
        Assert.assertEquals("The number of the running hours is not the expected", "24", usageList.get(2).getInstanceHours());
    }
