...
public class AutoScalingGroupReadyPollerObject extends StackDependentPollerObject {
    ...
    public AutoScalingGroupReadyPollerObject(Stack stack, AmazonEC2Client amazonEC2Client, AmazonAutoScalingClient amazonASClient,
