...
public class KeyGeneratorService {
    ...
    public void generateSshKey(String path) throws IOException, InterruptedException {
        String[] commands = new String[]{
                ...
                String.format("keytool -importkeystore -destkeystore %s.jks -srcstoretype PKCS12 -srckeystore %s.p12 -storepass password -srcstorepass password -noprompt", path, path)
        };
