...
public class ReactorConfig {
    ...
    public static final String ADD_NODE_REQUEST_EVENT = "ADD_NODE_REQUEST_EVENT";
    public static final String ADD_NODE_COMPLETE_EVENT = "ADD_NODE_COMPLETE_EVENT";
    public static final String ADD_NODE_UPDATE_METADATA_EVENT_COMPLETE = "ADD_NODE_UPDATE_METADATA_EVENT_COMPLETE";
    public static final String ADD_NODE_AMBARI_UPDATE_NODE_EVENT = "ADD_NODE_AMBARI_UPDATE_NODE_EVENT";
    public static final String ADD_NODE_AMBARI_UPDATE_NODE_SUCCESS_EVENT = "ADD_NODE_AMBARI_UPDATE_NODE_SUCCESS_EVENT";
    public static final String ADD_NODE_AMBARI_UPDATE_NODE_FAILED_EVENT = "ADD_NODE_AMBARI_UPDATE_NODE_FAILED_EVENT";
