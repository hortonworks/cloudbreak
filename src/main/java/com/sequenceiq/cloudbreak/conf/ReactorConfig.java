...
public class ReactorConfig {
    ...
    public static final String UPDATE_SUBNET_REQUEST_EVENT = "UPDATE_SUBNET_REQUEST";
    public static final String ADD_INSTANCES_COMPLETE_EVENT = "ADD_INSTANCES_COMPLETE";
    public static final String UPDATE_SUBNET_COMPLETE_EVENT = "UPDATE_SUBNET_COMPLETE";
    public static final String REMOVE_INSTANCES_COMPLETE_EVENT = "REMOVE_INSTANCES_COMPLETE_EVENT";
