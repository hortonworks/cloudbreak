...
@Service
public class StackStopHandler extends AbstractFlowHandler<StackStatusUpdateContext> implements FlowHandler {
    ...
    protected Object execute(Event<StackStatusUpdateContext> event) throws CloudbreakException {
        ...
        StackStatusUpdateContext stackStatusUpdateContext = (StackStatusUpdateContext) getFlowFacade().stopStack(event.getData());
