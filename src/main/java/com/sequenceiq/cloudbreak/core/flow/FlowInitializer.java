...
import com.sequenceiq.cloudbreak.core.flow.handlers.StackScalingFailureHandler;
...
public class FlowInitializer implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        flowManager.registerTransition(StackUpscaleHandler.class, ReactorFlowManager.TransitionFactory
                .createTransition(Phases.STACK_UPSCALE.name(), Phases.SUCCESS.name(), Phases.STACK_SCALING_FAILED.name()));

        flowManager.registerTransition(StackDownscaleHandler.class, ReactorFlowManager.TransitionFactory
                .createTransition(Phases.STACK_DOWNSCALE.name(), Phases.SUCCESS.name(), Phases.STACK_SCALING_FAILED.name()));
        ...
        reactor.on($(Phases.STACK_SCALING_FAILED.name()), getHandlerForClass(StackScalingFailureHandler.class));
