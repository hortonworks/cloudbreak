...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <!-- .navbar-toggle -->
            <a class="navbar-brand"> <span class="label label-danger">${status}</span>
            </a>
        </div>
        <!-- .navbar-header -->
...
<section id="home-intro-1" style="padding-top: 60px !important">
    <div class="container">
        <div class="row container">
            ...
            <!-- .col-md-6 -->
            <div class="col-md-12">
                <h2>Your cluster installation request completed with ${status} status</h2>

                <p>    Something went terribly wrong - we are happy to help, please let us know your cluster details, time, etc - and we will check the logs and get a fix for you.
                </p>
