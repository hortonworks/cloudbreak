...
public class ParameterGenerator {
    ...
    public CloudStack createCloudStack() {
        ...
        return new CloudStack(groups, network, image, null, new HashMap<>(), new HashMap<>(), null, instanceAuthentication,
                instanceAuthentication.getLoginUserName(), instanceAuthentication.getPublicKey());
    }
