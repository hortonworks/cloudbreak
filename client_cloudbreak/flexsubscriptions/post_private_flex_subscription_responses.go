...
func (o *PostPrivateFlexSubscriptionReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PostPrivateFlexSubscriptionOK) Error() string {
	return fmt.Sprintf("[POST /flexsubscriptions/user][%d] postPrivateFlexSubscriptionOK  %+v", 200, o.Payload)
}

func (o *PostPrivateFlexSubscriptionOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
