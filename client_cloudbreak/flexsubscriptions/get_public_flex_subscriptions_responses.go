...
func (o *GetPublicFlexSubscriptionsReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPublicFlexSubscriptionsOK) Error() string {
	return fmt.Sprintf("[GET /flexsubscriptions/account][%d] getPublicFlexSubscriptionsOK  %+v", 200, o.Payload)
}

func (o *GetPublicFlexSubscriptionsOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
