...
func (o *GetEncryptionKeysForOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetEncryptionKeysForOrganizationOK()
...
func NewGetEncryptionKeysForOrganizationOK() *GetEncryptionKeysForOrganizationOK {
	return &GetEncryptionKeysForOrganizationOK{}
}
...
func (o *GetEncryptionKeysForOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/connectors/encryptionkeys][%d] getEncryptionKeysForOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetEncryptionKeysForOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
