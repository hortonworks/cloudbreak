...
func (o *GetIPPoolsCredentialIDForOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetIPPoolsCredentialIDForOrganizationOK()
...
func NewGetIPPoolsCredentialIDForOrganizationOK() *GetIPPoolsCredentialIDForOrganizationOK {
	return &GetIPPoolsCredentialIDForOrganizationOK{}
}
...
func (o *GetIPPoolsCredentialIDForOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/connectors/ippools][%d] getIpPoolsCredentialIdForOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetIPPoolsCredentialIDForOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
