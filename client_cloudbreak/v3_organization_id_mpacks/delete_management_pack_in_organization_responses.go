...
func (o *DeleteManagementPackInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteManagementPackInOrganizationOK()
...
func NewDeleteManagementPackInOrganizationOK() *DeleteManagementPackInOrganizationOK {
	return &DeleteManagementPackInOrganizationOK{}
}
...
func (o *DeleteManagementPackInOrganizationOK) Error() string {
	return fmt.Sprintf("[DELETE /v3/{organizationId}/mpacks/{name}][%d] deleteManagementPackInOrganizationOK  %+v", 200, o.Payload)
}

func (o *DeleteManagementPackInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
