...
func (o *CreateManagementPackInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateManagementPackInOrganizationOK()
...
func NewCreateManagementPackInOrganizationOK() *CreateManagementPackInOrganizationOK {
	return &CreateManagementPackInOrganizationOK{}
}
...
func (o *CreateManagementPackInOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/mpacks][%d] createManagementPackInOrganizationOK  %+v", 200, o.Payload)
}

func (o *CreateManagementPackInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
