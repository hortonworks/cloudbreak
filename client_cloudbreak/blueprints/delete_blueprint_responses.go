...
func (o *DeleteBlueprintReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *DeleteBlueprintDefault) Error() string {
	return fmt.Sprintf("[DELETE /blueprints/{id}][%d] deleteBlueprint default ", o._statusCode)
}

func (o *DeleteBlueprintDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
