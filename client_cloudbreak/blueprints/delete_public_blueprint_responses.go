...
func (o *DeletePublicBlueprintReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *DeletePublicBlueprintDefault) Error() string {
	return fmt.Sprintf("[DELETE /blueprints/account/{name}][%d] deletePublicBlueprint default ", o._statusCode)
}

func (o *DeletePublicBlueprintDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
