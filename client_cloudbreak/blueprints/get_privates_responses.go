...
func (o *GetPrivatesOK) Error() string {
	return fmt.Sprintf("[GET /blueprints/user][%d] getPrivatesOK  %+v", 200, o.Payload)
}

func (o *GetPrivatesOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
