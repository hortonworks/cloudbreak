...
func (o *GetBlueprintReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetBlueprintOK) Error() string {
	return fmt.Sprintf("[GET /blueprints/{id}][%d] getBlueprintOK  %+v", 200, o.Payload)
}

func (o *GetBlueprintOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
