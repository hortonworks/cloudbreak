...
func (o *CreateFlexSubscriptionInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateFlexSubscriptionInOrganizationOK()
...
func NewCreateFlexSubscriptionInOrganizationOK() *CreateFlexSubscriptionInOrganizationOK {
	return &CreateFlexSubscriptionInOrganizationOK{}
}
...
func (o *CreateFlexSubscriptionInOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/flexsubscriptions][%d] createFlexSubscriptionInOrganizationOK  %+v", 200, o.Payload)
}

func (o *CreateFlexSubscriptionInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
