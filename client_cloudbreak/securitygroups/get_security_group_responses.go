...
func (o *GetSecurityGroupReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetSecurityGroupOK) Error() string {
	return fmt.Sprintf("[GET /securitygroups/{id}][%d] getSecurityGroupOK  %+v", 200, o.Payload)
}

func (o *GetSecurityGroupOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
