...
func (o *GetPrivateSecurityGroupReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivateSecurityGroupOK) Error() string {
	return fmt.Sprintf("[GET /securitygroups/user/{name}][%d] getPrivateSecurityGroupOK  %+v", 200, o.Payload)
}

func (o *GetPrivateSecurityGroupOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
