...
func (o *PostPrivateSecurityGroupReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PostPrivateSecurityGroupOK) Error() string {
	return fmt.Sprintf("[POST /securitygroups/user][%d] postPrivateSecurityGroupOK  %+v", 200, o.Payload)
}

func (o *PostPrivateSecurityGroupOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
