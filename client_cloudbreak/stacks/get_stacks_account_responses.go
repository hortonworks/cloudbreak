...
func (o *GetStacksAccountOK) Error() string {
	return fmt.Sprintf("[GET /stacks/account][%d] getStacksAccountOK  %+v", 200, o.Payload)
}

func (o *GetStacksAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
