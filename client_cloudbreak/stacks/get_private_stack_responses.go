...
func (o *GetPrivateStackReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivateStackOK) Error() string {
	return fmt.Sprintf("[GET /stacks/user/{name}][%d] getPrivateStackOK  %+v", 200, o.Payload)
}

func (o *GetPrivateStackOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
