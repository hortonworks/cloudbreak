...
// WithOrganizationID adds the organizationID to the get file system parameters v3 params
func (o *GetFileSystemParametersV3Params) WithOrganizationID(organizationID int64) *GetFileSystemParametersV3Params {
	o.SetOrganizationID(organizationID)
	return o
}

// SetOrganizationID adds the organizationId to the get file system parameters v3 params
func (o *GetFileSystemParametersV3Params) SetOrganizationID(organizationID int64) {
