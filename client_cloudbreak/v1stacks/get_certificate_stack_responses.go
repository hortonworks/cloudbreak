...
func (o *GetCertificateStackOK) Error() string {
	return fmt.Sprintf("[GET /v1/stacks/{id}/certificate][%d] getCertificateStackOK  %+v", 200, o.Payload)
}

func (o *GetCertificateStackOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
