...
func (o *GetStackForAmbariOK) Error() string {
	return fmt.Sprintf("[POST /v1/stacks/ambari][%d] getStackForAmbariOK  %+v", 200, o.Payload)
}

func (o *GetStackForAmbariOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
