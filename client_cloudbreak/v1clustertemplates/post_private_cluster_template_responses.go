...
func (o *PostPrivateClusterTemplateOK) Error() string {
	return fmt.Sprintf("[POST /v1/clustertemplates/user][%d] postPrivateClusterTemplateOK  %+v", 200, o.Payload)
}

func (o *PostPrivateClusterTemplateOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
