...
func (o *DeletePrivateClusterTemplateDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/clustertemplates/user/{name}][%d] deletePrivateClusterTemplate default ", o._statusCode)
}

func (o *DeletePrivateClusterTemplateDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
