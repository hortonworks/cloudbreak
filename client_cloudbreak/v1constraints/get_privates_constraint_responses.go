...
func (o *GetPrivatesConstraintOK) Error() string {
	return fmt.Sprintf("[GET /v1/constraints/user][%d] getPrivatesConstraintOK  %+v", 200, o.Payload)
}

func (o *GetPrivatesConstraintOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
