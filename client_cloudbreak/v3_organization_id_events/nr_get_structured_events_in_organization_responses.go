...
func (o *NrGetStructuredEventsInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetStructuredEventsInOrganizationOK()
...
func NewGetStructuredEventsInOrganizationOK() *GetStructuredEventsInOrganizationOK {
	return &GetStructuredEventsInOrganizationOK{}
}
...
func (o *GetStructuredEventsInOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/events/struct/{name}][%d] getStructuredEventsInOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetStructuredEventsInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
