...
func (o *GetEventsBySTackIDReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetEventsBySTackIDOK) Error() string {
	return fmt.Sprintf("[GET /events/{id}][%d] getEventsBySTackIdOK  %+v", 200, o.Payload)
}

func (o *GetEventsBySTackIDOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
