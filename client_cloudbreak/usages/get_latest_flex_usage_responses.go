...
func (o *GetLatestFlexUsageReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetLatestFlexUsageOK) Error() string {
	return fmt.Sprintf("[GET /usages/flex/latest][%d] getLatestFlexUsageOK  %+v", 200, o.Payload)
}

func (o *GetLatestFlexUsageOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
