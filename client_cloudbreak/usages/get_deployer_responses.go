...
func (o *GetDeployerOK) Error() string {
	return fmt.Sprintf("[GET /usages][%d] getDeployerOK  %+v", 200, o.Payload)
}

func (o *GetDeployerOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
