...
func (o *GetPublicsNetworkOK) Error() string {
	return fmt.Sprintf("[GET /v1/networks/account][%d] getPublicsNetworkOK  %+v", 200, o.Payload)
}

func (o *GetPublicsNetworkOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
