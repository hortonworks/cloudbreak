...
func (o *CreateRecipeInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateRecipeInOrganizationOK()
...
func NewCreateRecipeInOrganizationOK() *CreateRecipeInOrganizationOK {
	return &CreateRecipeInOrganizationOK{}
}
...
func (o *CreateRecipeInOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/recipes][%d] createRecipeInOrganizationOK  %+v", 200, o.Payload)
}

func (o *CreateRecipeInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
