...
func (o *ListRecipesByOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListRecipesByOrganizationOK()
...
func NewListRecipesByOrganizationOK() *ListRecipesByOrganizationOK {
	return &ListRecipesByOrganizationOK{}
}
...
func (o *ListRecipesByOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/recipes][%d] listRecipesByOrganizationOK  %+v", 200, o.Payload)
}

func (o *ListRecipesByOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
