...
func (o *GetImageCatalogInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetImageCatalogInOrganizationOK()
...
func NewGetImageCatalogInOrganizationOK() *GetImageCatalogInOrganizationOK {
	return &GetImageCatalogInOrganizationOK{}
}
...
func (o *GetImageCatalogInOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/imagecatalogs/{name}][%d] getImageCatalogInOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetImageCatalogInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
