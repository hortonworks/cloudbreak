...
func (o *GetImagesByStackNameAndDefaultImageCatalogInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetImagesByStackNameAndDefaultImageCatalogInOrganizationOK()
...
func NewGetImagesByStackNameAndDefaultImageCatalogInOrganizationOK() *GetImagesByStackNameAndDefaultImageCatalogInOrganizationOK {
	return &GetImagesByStackNameAndDefaultImageCatalogInOrganizationOK{}
}
...
func (o *GetImagesByStackNameAndDefaultImageCatalogInOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/imagecatalogs/upgrade/{stackName}][%d] getImagesByStackNameAndDefaultImageCatalogInOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetImagesByStackNameAndDefaultImageCatalogInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
