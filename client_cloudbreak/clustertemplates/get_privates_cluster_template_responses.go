...
func (o *GetPrivatesClusterTemplateReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivatesClusterTemplateOK) Error() string {
	return fmt.Sprintf("[GET /clustertemplates/user][%d] getPrivatesClusterTemplateOK  %+v", 200, o.Payload)
}

func (o *GetPrivatesClusterTemplateOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
