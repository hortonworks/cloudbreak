...
func (o *GetPublicLdapReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPublicLdapOK) Error() string {
	return fmt.Sprintf("[GET /ldap/account/{name}][%d] getPublicLdapOK  %+v", 200, o.Payload)
}

func (o *GetPublicLdapOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
