...
func (o *PostPrivateLdapReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PostPrivateLdapOK) Error() string {
	return fmt.Sprintf("[POST /ldap/user][%d] postPrivateLdapOK  %+v", 200, o.Payload)
}

func (o *PostPrivateLdapOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
