...
func (o *PostPublicLdapReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PostPublicLdapOK) Error() string {
	return fmt.Sprintf("[POST /ldap/account][%d] postPublicLdapOK  %+v", 200, o.Payload)
}

func (o *PostPublicLdapOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
