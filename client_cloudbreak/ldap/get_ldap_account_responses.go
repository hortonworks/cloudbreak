...
func (o *GetLdapAccountOK) Error() string {
	return fmt.Sprintf("[GET /ldap/account][%d] getLdapAccountOK  %+v", 200, o.Payload)
}

func (o *GetLdapAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
