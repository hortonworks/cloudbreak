...
func (o *GetLdapUserOK) Error() string {
	return fmt.Sprintf("[GET /ldap/user][%d] getLdapUserOK  %+v", 200, o.Payload)
}

func (o *GetLdapUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
