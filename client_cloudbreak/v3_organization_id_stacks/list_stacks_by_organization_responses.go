...
func (o *ListStacksByOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListStacksByOrganizationOK()
...
func NewListStacksByOrganizationOK() *ListStacksByOrganizationOK {
	return &ListStacksByOrganizationOK{}
}
...
func (o *ListStacksByOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/stacks][%d] listStacksByOrganizationOK  %+v", 200, o.Payload)
}

func (o *ListStacksByOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
