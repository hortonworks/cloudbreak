...
// NewListStacksByOrganizationParams creates a new ListStacksByOrganizationParams object
// with the default values initialized.
func NewListStacksByOrganizationParams() *ListStacksByOrganizationParams {
	var ()
	return &ListStacksByOrganizationParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewListStacksByOrganizationParamsWithTimeout creates a new ListStacksByOrganizationParams object
...
// NewListStacksByOrganizationParamsWithContext creates a new ListStacksByOrganizationParams object
...
// NewListStacksByOrganizationParamsWithHTTPClient creates a new ListStacksByOrganizationParams object
...
/*ListStacksByOrganizationParams contains all the parameters to send to the API endpoint
for the list stacks by organization operation typically these are written to a http.Request
*/
...
func (o *ListStacksByOrganizationParams) WithTimeout(timeout time.Duration) *ListStacksByOrganizationParams {
...
func (o *ListStacksByOrganizationParams) WithContext(ctx context.Context) *ListStacksByOrganizationParams {
	o.SetContext(ctx)
	return o
}
...
func (o *ListStacksByOrganizationParams) WithHTTPClient(client *http.Client) *ListStacksByOrganizationParams {
...
func (o *ListStacksByOrganizationParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
