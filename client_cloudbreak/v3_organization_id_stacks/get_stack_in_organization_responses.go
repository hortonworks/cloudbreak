...
func (o *GetStackInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetStackInOrganizationOK()
...
func NewGetStackInOrganizationOK() *GetStackInOrganizationOK {
	return &GetStackInOrganizationOK{}
}
...
func (o *GetStackInOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/stacks/{name}][%d] getStackInOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetStackInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
