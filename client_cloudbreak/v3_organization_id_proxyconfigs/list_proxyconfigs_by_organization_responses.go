...
func (o *ListProxyconfigsByOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListProxyconfigsByOrganizationOK()
...
func NewListProxyconfigsByOrganizationOK() *ListProxyconfigsByOrganizationOK {
	return &ListProxyconfigsByOrganizationOK{}
}
...
func (o *ListProxyconfigsByOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/proxyconfigs][%d] listProxyconfigsByOrganizationOK  %+v", 200, o.Payload)
}

func (o *ListProxyconfigsByOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
