...
func (o *HasResourcesUserReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *HasResourcesUserOK) Error() string {
	return fmt.Sprintf("[GET /users/{id}/resources][%d] hasResourcesUserOK  %+v", 200, o.Payload)
}

func (o *HasResourcesUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
