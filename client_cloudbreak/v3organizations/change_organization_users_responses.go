...
func (o *ChangeOrganizationUsersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewChangeOrganizationUsersOK()
...
func NewChangeOrganizationUsersOK() *ChangeOrganizationUsersOK {
	return &ChangeOrganizationUsersOK{}
}
...
func (o *ChangeOrganizationUsersOK) Error() string {
	return fmt.Sprintf("[PUT /v3/organizations/name/{name}][%d] changeOrganizationUsersOK  %+v", 200, o.Payload)
}

func (o *ChangeOrganizationUsersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
