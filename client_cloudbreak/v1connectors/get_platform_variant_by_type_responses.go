...
func (o *GetPlatformVariantByTypeOK) Error() string {
	return fmt.Sprintf("[GET /v1/connectors/variants/{type}][%d] getPlatformVariantByTypeOK  %+v", 200, o.Payload)
}

func (o *GetPlatformVariantByTypeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
