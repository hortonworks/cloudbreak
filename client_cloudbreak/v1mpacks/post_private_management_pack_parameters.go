...
func (o *PostPrivateManagementPackParams) WithBody(body *models_cloudbreak.MpackRequest) *PostPrivateManagementPackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post private management pack params
func (o *PostPrivateManagementPackParams) SetBody(body *models_cloudbreak.MpackRequest) {
	o.Body = body
}
