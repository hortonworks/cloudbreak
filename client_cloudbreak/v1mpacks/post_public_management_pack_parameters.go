...
func (o *PostPublicManagementPackParams) WithBody(body *models_cloudbreak.MpackRequest) *PostPublicManagementPackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post public management pack params
func (o *PostPublicManagementPackParams) SetBody(body *models_cloudbreak.MpackRequest) {
	o.Body = body
}
