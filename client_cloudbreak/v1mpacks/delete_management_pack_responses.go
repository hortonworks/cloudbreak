...
func (o *DeleteManagementPackReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	result := NewDeleteManagementPackDefault(response.Code())
...
func NewDeleteManagementPackDefault(code int) *DeleteManagementPackDefault {
	return &DeleteManagementPackDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteManagementPackDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/mpacks/{id}][%d] deleteManagementPack default ", o._statusCode)
}

func (o *DeleteManagementPackDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
