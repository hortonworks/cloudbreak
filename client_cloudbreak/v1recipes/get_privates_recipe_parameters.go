...
// NewGetPrivatesRecipeParams creates a new GetPrivatesRecipeParams object
// with the default values initialized.
func NewGetPrivatesRecipeParams() *GetPrivatesRecipeParams {

	return &GetPrivatesRecipeParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetPrivatesRecipeParamsWithTimeout creates a new GetPrivatesRecipeParams object
...
// NewGetPrivatesRecipeParamsWithContext creates a new GetPrivatesRecipeParams object
...
// NewGetPrivatesRecipeParamsWithHTTPClient creates a new GetPrivatesRecipeParams object
...
/*GetPrivatesRecipeParams contains all the parameters to send to the API endpoint
for the get privates recipe operation typically these are written to a http.Request
*/
...
func (o *GetPrivatesRecipeParams) WithTimeout(timeout time.Duration) *GetPrivatesRecipeParams {
...
func (o *GetPrivatesRecipeParams) WithContext(ctx context.Context) *GetPrivatesRecipeParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetPrivatesRecipeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
