...
func (o *TestRdsConnectionInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTestRdsConnectionInOrganizationOK()
...
func NewTestRdsConnectionInOrganizationOK() *TestRdsConnectionInOrganizationOK {
	return &TestRdsConnectionInOrganizationOK{}
}
...
func (o *TestRdsConnectionInOrganizationOK) Error() string {
	return fmt.Sprintf("[POST /v3/{organizationId}/rdsconfigs/testconnect][%d] testRdsConnectionInOrganizationOK  %+v", 200, o.Payload)
}

func (o *TestRdsConnectionInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
