...
func (o *GetConstraintsUserReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetConstraintsUserOK()
...
func (o *GetConstraintsUserOK) Error() string {
	return fmt.Sprintf("[GET /constraints/user][%d] getConstraintsUserOK  %+v", 200, o.Payload)
}

func (o *GetConstraintsUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
