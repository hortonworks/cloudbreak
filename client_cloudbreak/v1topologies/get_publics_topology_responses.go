...
func (o *GetPublicsTopologyOK) Error() string {
	return fmt.Sprintf("[GET /v1/topologies/account][%d] getPublicsTopologyOK  %+v", 200, o.Payload)
}

func (o *GetPublicsTopologyOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
