...
func (o *GetCredentialsUserReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCredentialsUserOK()
...
func (o *GetCredentialsUserOK) Error() string {
	return fmt.Sprintf("[GET /credentials/user][%d] getCredentialsUserOK  %+v", 200, o.Payload)
}

func (o *GetCredentialsUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
