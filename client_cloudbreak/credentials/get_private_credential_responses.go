...
func (o *GetPrivateCredentialReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivateCredentialOK) Error() string {
	return fmt.Sprintf("[GET /credentials/user/{name}][%d] getPrivateCredentialOK  %+v", 200, o.Payload)
}

func (o *GetPrivateCredentialOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
