...
func (o *GetPrivatesCredentialReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivatesCredentialOK) Error() string {
	return fmt.Sprintf("[GET /credentials/user][%d] getPrivatesCredentialOK  %+v", 200, o.Payload)
}

func (o *GetPrivatesCredentialOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
