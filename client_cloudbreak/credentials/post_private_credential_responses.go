...
func (o *PostPrivateCredentialReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *PostPrivateCredentialOK) Error() string {
	return fmt.Sprintf("[POST /credentials/user][%d] postPrivateCredentialOK  %+v", 200, o.Payload)
}

func (o *PostPrivateCredentialOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
