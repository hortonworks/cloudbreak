...
func (o *ListBlueprintsByOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewListBlueprintsByOrganizationOK()
...
func NewListBlueprintsByOrganizationOK() *ListBlueprintsByOrganizationOK {
	return &ListBlueprintsByOrganizationOK{}
}
...
func (o *ListBlueprintsByOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/blueprints][%d] listBlueprintsByOrganizationOK  %+v", 200, o.Payload)
}

func (o *ListBlueprintsByOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
