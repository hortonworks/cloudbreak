...
func (o *GetBlueprintInOrganizationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetBlueprintInOrganizationOK()
...
func NewGetBlueprintInOrganizationOK() *GetBlueprintInOrganizationOK {
	return &GetBlueprintInOrganizationOK{}
}
...
func (o *GetBlueprintInOrganizationOK) Error() string {
	return fmt.Sprintf("[GET /v3/{organizationId}/blueprints/{name}][%d] getBlueprintInOrganizationOK  %+v", 200, o.Payload)
}

func (o *GetBlueprintInOrganizationOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
