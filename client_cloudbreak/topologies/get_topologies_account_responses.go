...
func (o *GetTopologiesAccountReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetTopologiesAccountOK()
...
func (o *GetTopologiesAccountOK) Error() string {
	return fmt.Sprintf("[GET /topologies/account][%d] getTopologiesAccountOK  %+v", 200, o.Payload)
}

func (o *GetTopologiesAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
