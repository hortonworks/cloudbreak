...
func (o *GetRecipesAccountOK) Error() string {
	return fmt.Sprintf("[GET /recipes/account][%d] getRecipesAccountOK  %+v", 200, o.Payload)
}

func (o *GetRecipesAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
