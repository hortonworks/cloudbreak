...
func (o *GetPrivateRecipeReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivateRecipeOK) Error() string {
	return fmt.Sprintf("[GET /recipes/user/{name}][%d] getPrivateRecipeOK  %+v", 200, o.Payload)
}

func (o *GetPrivateRecipeOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
