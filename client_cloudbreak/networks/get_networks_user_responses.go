...
func (o *GetNetworksUserOK) Error() string {
	return fmt.Sprintf("[GET /networks/user][%d] getNetworksUserOK  %+v", 200, o.Payload)
}

func (o *GetNetworksUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
