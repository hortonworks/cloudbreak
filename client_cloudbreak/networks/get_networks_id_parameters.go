...
// NewGetNetworksIDParams creates a new GetNetworksIDParams object
// with the default values initialized.
func NewGetNetworksIDParams() *GetNetworksIDParams {
	var ()
	return &GetNetworksIDParams{}
}

/*GetNetworksIDParams contains all the parameters to send to the API endpoint
for the get networks ID operation typically these are written to a http.Request
*/
