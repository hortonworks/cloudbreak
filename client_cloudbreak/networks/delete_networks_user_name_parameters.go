...
// NewDeleteNetworksUserNameParams creates a new DeleteNetworksUserNameParams object
// with the default values initialized.
func NewDeleteNetworksUserNameParams() *DeleteNetworksUserNameParams {
	var ()
	return &DeleteNetworksUserNameParams{}
}

/*DeleteNetworksUserNameParams contains all the parameters to send to the API endpoint
for the delete networks user name operation typically these are written to a http.Request
*/
