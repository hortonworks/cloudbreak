...
func (o *GetNetworkReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetNetworkOK) Error() string {
	return fmt.Sprintf("[GET /networks/{id}][%d] getNetworkOK  %+v", 200, o.Payload)
}

func (o *GetNetworkOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
