...
func (o *GetSssdAccountNameReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetSssdAccountNameOK()
...
func (o *GetSssdAccountNameOK) Error() string {
	return fmt.Sprintf("[GET /sssd/account/{name}][%d] getSssdAccountNameOK  %+v", 200, o.Payload)
}

func (o *GetSssdAccountNameOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
