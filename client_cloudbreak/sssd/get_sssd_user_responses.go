...
func (o *GetSssdUserOK) Error() string {
	return fmt.Sprintf("[GET /sssd/user][%d] getSssdUserOK  %+v", 200, o.Payload)
}

func (o *GetSssdUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
