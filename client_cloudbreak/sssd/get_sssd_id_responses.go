...
func (o *GetSssdIDOK) Error() string {
	return fmt.Sprintf("[GET /sssd/{id}][%d] getSssdIdOK  %+v", 200, o.Payload)
}

func (o *GetSssdIDOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
