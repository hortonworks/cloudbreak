...
func (o *GetSssdAccountOK) Error() string {
	return fmt.Sprintf("[GET /sssd/account][%d] getSssdAccountOK  %+v", 200, o.Payload)
}

func (o *GetSssdAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
