...
func (o *GetTemplatesAccountNameReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetTemplatesAccountNameOK()
...
func NewGetTemplatesAccountNameOK() *GetTemplatesAccountNameOK {
	return &GetTemplatesAccountNameOK{}
}
...
func (o *GetTemplatesAccountNameOK) Error() string {
	return fmt.Sprintf("[GET /templates/account/{name}][%d] getTemplatesAccountNameOK  %+v", 200, o.Payload)
}

func (o *GetTemplatesAccountNameOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
