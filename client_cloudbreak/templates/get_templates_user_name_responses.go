...
func (o *GetTemplatesUserNameReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetTemplatesUserNameOK()
...
func (o *GetTemplatesUserNameOK) Error() string {
	return fmt.Sprintf("[GET /templates/user/{name}][%d] getTemplatesUserNameOK  %+v", 200, o.Payload)
}

func (o *GetTemplatesUserNameOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
