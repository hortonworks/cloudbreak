...
func (o *DeleteTemplateReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *DeleteTemplateDefault) Error() string {
	return fmt.Sprintf("[DELETE /templates/{id}][%d] deleteTemplate default ", o._statusCode)
}

func (o *DeleteTemplateDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
