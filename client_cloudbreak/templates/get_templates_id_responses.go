...
func (o *GetTemplatesIDOK) Error() string {
	return fmt.Sprintf("[GET /templates/{id}][%d] getTemplatesIdOK  %+v", 200, o.Payload)
}

func (o *GetTemplatesIDOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
