...
func (o *PostTemplatesAccountReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostTemplatesAccountOK()
...
func (o *PostTemplatesAccountOK) Error() string {
	return fmt.Sprintf("[POST /templates/account][%d] postTemplatesAccountOK  %+v", 200, o.Payload)
}

func (o *PostTemplatesAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
