...
func (o *GetPrivateTemplateReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *GetPrivateTemplateOK) Error() string {
	return fmt.Sprintf("[GET /templates/user/{name}][%d] getPrivateTemplateOK  %+v", 200, o.Payload)
}

func (o *GetPrivateTemplateOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
