...
func (o *DeletePrivateRdsReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *DeletePrivateRdsDefault) Error() string {
	return fmt.Sprintf("[DELETE /rdsconfigs/user/{name}][%d] deletePrivateRds default ", o._statusCode)
}

func (o *DeletePrivateRdsDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
