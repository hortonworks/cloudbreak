...
func (o *GetRdsconfigsAccountReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetRdsconfigsAccountOK()
...
func (o *GetRdsconfigsAccountOK) Error() string {
	return fmt.Sprintf("[GET /rdsconfigs/account][%d] getRdsconfigsAccountOK  %+v", 200, o.Payload)
}

func (o *GetRdsconfigsAccountOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
