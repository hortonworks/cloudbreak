...
func (o *TestRdsConnectionUtilReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *TestRdsConnectionUtilOK) Error() string {
	return fmt.Sprintf("[POST /util/rds][%d] testRdsConnectionUtilOK  %+v", 200, o.Payload)
}

func (o *TestRdsConnectionUtilOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
