...
func (o *TestAmbariDatabaseUtilReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *TestAmbariDatabaseUtilOK) Error() string {
	return fmt.Sprintf("[POST /util/ambari-database][%d] testAmbariDatabaseUtilOK  %+v", 200, o.Payload)
}

func (o *TestAmbariDatabaseUtilOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
