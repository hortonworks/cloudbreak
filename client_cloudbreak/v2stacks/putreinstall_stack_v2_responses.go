...
func (o *PutreinstallStackV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	result := NewPutreinstallStackV2Default(response.Code())
...
func NewPutreinstallStackV2Default(code int) *PutreinstallStackV2Default {
	return &PutreinstallStackV2Default{
		_statusCode: code,
	}
}
...
func (o *PutreinstallStackV2Default) Error() string {
	return fmt.Sprintf("[PUT /v2/stacks/reinstall/{name}][%d] putreinstallStackV2 default ", o._statusCode)
}

func (o *PutreinstallStackV2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
