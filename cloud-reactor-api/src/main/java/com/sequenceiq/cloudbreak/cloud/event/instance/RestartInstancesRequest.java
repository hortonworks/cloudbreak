...
public class RestartInstancesRequest<T> extends CloudPlatformRequest<T> {

    private final List<CloudInstance> cloudInstances;

    private final List<CloudResource> cloudResources;

    public RestartInstancesRequest(CloudContext cloudContext, CloudCredential cloudCredential,
