...
public class GetPlatformCloudAccessConfigsRequest extends CloudPlatformRequest<GetPlatformCloudAccessConfigsResult> {
    ...
    public String toString() {
        return "GetPlatformCloudAccessConfigsRequest{}";
    }
    //END GENERATED CODE
}
