...
public interface ClusterModificationService {
    ...
    void installKraftAsStopped(StackDtoDelegate stackDtoDelegate) throws CloudbreakException;
    ...
    void rollingRestartServiceRoleByType(String serviceType, String roleType, boolean staleConfigsOnly);
