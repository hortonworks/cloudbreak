...
public class ClouderaManagerModificationService implements ClusterModificationService {
    ...
    private void deployConfigAndRefreshStaleServices(ClustersResourceApi clustersResourceApi, List<ApiService> notFreshServices,
        ...
        Integer deployCommandId = clouderaManagerCommonCommandService.getDeployClientConfigCommandId(stack, clustersResourceApi, commands);
    ...
    @VisibleForTesting
    void pollDeployConfig(Integer commandId) throws CloudbreakException {
