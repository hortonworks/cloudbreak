...
public class ClouderaManagerConfigService {
    ...
    public Optional<String> getRoleConfigValueByServiceType(ApiClient apiClient, String clusterName, String roleType, String serviceType, String configName) {
        ...
        try {
            ...
            String roleConfigGroupName = getRoleConfigGroupName(roleType, clusterName, serviceName, roleConfigGroupsResourceApi);
    ...
    private String getRoleConfigGroupName(String roleType, String clusterName, String serviceName, RoleConfigGroupsResourceApi roleConfigGroupsResourceApi)
            throws ApiException {
