...
public class TestUtil {
    ...
    public static List<Cluster> generateCluster(int count) {
        ...
        for (int i = 0; i < count; i++) {
            clusters.add(cluster(blueprint(), stack(AVAILABLE, azureCredential()), (long) i));
        }
        return clusters;
    }
    ...
    public static HostGroup hostGroup() {
        ...
        hostGroup.setInstanceGroup(instanceGroup(1L, InstanceGroupType.CORE, azureTemplate(1L)));
        return hostGroup;
    }
