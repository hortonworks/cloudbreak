package com.sequenceiq.externalizedcompute.openapi;
...
import com.sequenceiq.externalizedcompute.config.EndpointConfig;
...
public class OpenApiGenerator {
    ...
    public void generateSwaggerJson() throws Exception {
        ...
        OpenAPI openAPI = new JaxrsOpenApiContextBuilder<>()
                ...
                .buildContext(true)
                .read();
        Path path = Paths.get("./build/openapi/externalizedcompute.json");
