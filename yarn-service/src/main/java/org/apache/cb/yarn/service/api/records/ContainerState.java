...
public class ContainerState {
    ...
    public ContainerState state(StateEnum state) {
        this.state = state;
        return this;
    }

    public ContainerState(String state) {
     ...
     * @return state
     **/
    @ApiModelProperty(value = "enum of the state of the container")
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.state, containerState.state);
    }
