...
public enum EnvironmentStatus {
    ...
    NETWORK_CIDRS_MODIFICATION_IN_PROGRESS("Starting network CIDRs modification"),
    NETWORK_CIDRS_MODIFICATION_ON_FREEIPA_IN_PROGRESS("Modifying network CIDRs on FreeIPA"),
    NETWORK_CIDRS_MODIFICATION_ON_FREEIPA_FAILED("Failed to modify network CIDRs on FreeIPA"),
    NETWORK_CIDRS_MODIFICATION_ON_DATALAKE_AND_DATAHUBS_IN_PROGRESS("Modifying network CIDRs on Data Lake and Data Hubs"),
    NETWORK_CIDRS_MODIFICATION_ON_DATALAKE_AND_DATAHUBS_FAILED("Failed to modify network CIDRs on Data Lake and Data Hubs"),
    NETWORK_CIDRS_MODIFICATION_FAILED("Failed to modify network CIDRs on attached resources"),
    ...
    ENABLE_ENCRYPTION_PROFILE_IN_PROGRESS("Enable encryption profile in progress"),
    ENABLE_ENCRYPTION_PROFILE_FAILED("Enable encryption profile failed");
