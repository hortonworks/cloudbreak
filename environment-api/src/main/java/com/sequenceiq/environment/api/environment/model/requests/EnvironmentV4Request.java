...
@ApiModel
public class EnvironmentV4Request extends com.sequenceiq.environment.api.environment.model.requests.EnvironmentV4BaseRequest implements com.sequenceiq.environment.api.environment.model.requests.CredentialAwareEnvRequest {
    ...
    private com.sequenceiq.environment.api.environment.model.requests.EnvironmentNetworkV4Request network;
    ...
    public com.sequenceiq.environment.api.environment.model.requests.LocationV4Request getLocation() {
        return location;
    }

    public void setLocation(com.sequenceiq.environment.api.environment.model.requests.LocationV4Request location) {
        this.location = location;
    }

    public com.sequenceiq.environment.api.environment.model.requests.EnvironmentNetworkV4Request getNetwork() {
        return network;
    }

    public void setNetwork(com.sequenceiq.environment.api.environment.model.requests.EnvironmentNetworkV4Request network) {
