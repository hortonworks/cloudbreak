...
@Schema(name = "AttachedFreeIpaRequestAwsSpotParameters")
@JsonIgnoreProperties(ignoreUnknown = true)
public class AwsFreeIpaSpotParameters implements Serializable {

    @Schema(description = EnvironmentModelDescription.FREEIPA_AWS_SPOT_PERCENTAGE)
    ...
    @Schema(description = EnvironmentModelDescription.FREEIPA_AWS_SPOT_MAX_PRICE)
