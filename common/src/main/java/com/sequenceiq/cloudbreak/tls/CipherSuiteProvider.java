...
public class CipherSuiteProvider {
    ...
    public List<CipherSuite> getCipherSuitesByLimitType(CipherSuitesLimitType cipherSuitesLimitType) {
        return switch (cipherSuitesLimitType) {
            ...
            case CipherSuitesLimitType.TLS_1_2_RECOMMENDED ->
                    List.of(
                    TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256,
            ...
            case CipherSuitesLimitType.TLS_1_3_RECOMMENDED ->
                    List.of(
