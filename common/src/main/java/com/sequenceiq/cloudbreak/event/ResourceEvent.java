...
public enum ResourceEvent {
    ...
    SDX_STORAGE_CONSUMPTION_COLLECTION_SCHEDULING_STARTED("resource.sdx.storage.consumption.collection.scheduling.started"),
    SDX_STORAGE_CONSUMPTION_COLLECTION_UNSCHEDULING_STARTED("resource.sdx.storage.consumption.collection.unscheduling.started"),
