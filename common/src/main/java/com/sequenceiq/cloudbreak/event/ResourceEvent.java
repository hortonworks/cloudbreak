...
public enum ResourceEvent {
    ...
    DATALAKE_ENABLE_SELINUX_VALIDATION_IN_PROGRESS("datalake.enableselinux.validation.in.progress"),
    DATALAKE_ENABLE_SELINUX_VALIDATION_FAILED("datalake.enableselinux.validation.failed"),
