...
public class InternalCrnBuilderTest {
    ...
    private String internalCrn = "crn:altus:freeipa:us-west-1:altus:user:__internal__actor__";
    ...
    public void generateCrnAsStringWhenFreeIpaIs() {
        ...
        assertEquals("crn:altus:freeipa:us-west-1:altus:user:__internal__actor__", internalCrnBuilder.getInternalCrnForServiceAsString());
    }
