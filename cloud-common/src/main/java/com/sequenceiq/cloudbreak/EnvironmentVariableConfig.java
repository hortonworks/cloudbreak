...
public class EnvironmentVariableConfig {
    ...
    public static final String CB_AZURE_IMAGE_NAME = "cb-centos71-amb212-2015-12-05_2015-12-05_21-41-os-2015-12-05.vhd";
    ...
    public static final String CB_AZURE_RM_IMAGE = new StringBuilder()
            ...
            .append(String.format("EAST_US:https://sequenceiqeastus12.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("CENTRAL_US:https://sequenceiqcentralus2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("NORTH_EUROPE:https://sequenceiqnortheurope2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("SOUTH_CENTRAL_US:https://sequenceiqouthcentralus2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("NORTH_CENTRAL_US:https://sequenceiqorthcentralus2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("EAST_US_2:https://sequenceiqeastus22.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("JAPAN_EAST:https://sequenceiqjapaneast2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("JAPAN_WEST:https://sequenceiqjapanwest2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("SOUTHEAST_ASIA:https://sequenceiqsoutheastasia2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("WEST_US:https://sequenceiqwestus2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("WEST_EUROPE:https://sequenceiqwesteurope2.blob.core.windows.net/images/%s,", CB_AZURE_IMAGE_NAME))
            .append(String.format("BRAZIL_SOUTH:https://sequenceiqbrazilsouth2.blob.core.windows.net/images/%s", CB_AZURE_IMAGE_NAME))
            .toString();
    public static final String CB_AWS_AMI_MAP = new StringBuilder()
            .append("ap-northeast-1:ami-9297b9fc,")
            .append("ap-southeast-1:ami-11111111,")
            .append("ap-southeast-2:ami-11111111,")
            .append("eu-central-1:ami-41bca12d,")
            .append("eu-west-1:ami-80ca6bf3,")
            .append("sa-east-1:ami-11111111,")
            .append("us-east-1:ami-dd2966b7,")
            .append("us-west-1:ami-ae4129ce,")
            .append("us-west-2:ami-a93d20c8")
            .toString();
    public static final String CB_OPENSTACK_IMAGE = "cb-centos71-amb212-2015-12-05";
    public static final String CB_GCP_SOURCE_IMAGE_PATH = "sequenceiqimage/cb-centos71-amb212-2015-12-05.tar.gz";
