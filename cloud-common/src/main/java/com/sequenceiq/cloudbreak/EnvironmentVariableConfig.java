...
public class EnvironmentVariableConfig {
    ...
    public static final String CB_AZURE_IMAGE_NAME = "cb-centos71-amb212-2015-12-22_2015-12-22_10-56-os-2015-12-22.vhd";
    ...
    public static final String CB_AWS_AMI_MAP = new StringBuilder()
            .append("ap-northeast-1:ami-31466f5f,")
            .append("ap-southeast-1:ami-297bbb4a,")
            .append("ap-southeast-2:ami-bfd68edc,")
            .append("eu-central-1:ami-d3bea3bf,")
            .append("eu-west-1:ami-1edc7d6d,")
            .append("sa-east-1:ami-3ca82c50,")
            .append("us-east-1:ami-b94d02d3,")
            .append("us-west-1:ami-6a472f0a,")
            .append("us-west-2:ami-f43b2695")
            .toString();
    public static final String CB_OPENSTACK_IMAGE = "cb-centos71-amb212-2015-12-06";
    public static final String CB_GCP_SOURCE_IMAGE_PATH = "sequenceiqimage/cb-centos71-amb212-2015-12-06.tar.gz";
