...
import static com.sequenceiq.cloudbreak.datalakedr.converter.GrpcStatusResponseToDatalakeBackupRestoreStatusResponseConverter.VALIDATION_FAILED;
    ...
    public void testPreCheckBackupFailed() {
        datalakeDRProto.BackupDatalakeResponse.Builder builder =
                datalakeDRProto.BackupDatalakeResponse.newBuilder()
                        .setOverallState(VALIDATION_FAILED)
