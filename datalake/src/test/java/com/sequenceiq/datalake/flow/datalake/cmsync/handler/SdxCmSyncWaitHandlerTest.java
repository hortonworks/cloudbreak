...
public class SdxCmSyncWaitHandlerTest {
    ...
    void testAccept() {
        ...
        SdxWaitTaskForCloudbreakFlow sdxWaitTaskForCloudbreakFlow = mock(SdxWaitTaskForCloudbreakFlow.class);
        when(sdxWaitTaskFactory.createCloudbreakFlowWaitTask(eq(sdxCluster), any(), eq(SYNC_CM))).thenReturn(sdxWaitTaskForCloudbreakFlow);
        ...
        verify(sdxWaitService).waitFor(sdxWaitTaskForCloudbreakFlow);
    }
    ...
    void testAcceptWhenSdxWaitServiceThrows() {
        ...
        SdxWaitTaskForCloudbreakFlow sdxWaitTaskForCloudbreakFlow = mock(SdxWaitTaskForCloudbreakFlow.class);
        when(sdxWaitTaskFactory.createCloudbreakFlowWaitTask(eq(sdxCluster), any(), eq(SYNC_CM))).thenReturn(sdxWaitTaskForCloudbreakFlow);
        doThrow(new SdxWaitException("Polling threw", new RuntimeException())).when(sdxWaitService).waitFor(sdxWaitTaskForCloudbreakFlow);
    ...
    private void verifyPollingConfig(SdxCluster sdxCluster) {
        ...
        verify(sdxWaitTaskFactory).createCloudbreakFlowWaitTask(eq(sdxCluster), pollingConfigArgumentCaptor.capture(), eq(SYNC_CM));
