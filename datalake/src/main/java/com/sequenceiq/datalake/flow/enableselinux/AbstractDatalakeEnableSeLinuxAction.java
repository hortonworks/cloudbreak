...
abstract class AbstractDatalakeEnableSeLinuxAction<P extends ResourceCrnPayload>
        extends AbstractAction<DatalakeEnableSeLinuxState, DatalakeEnableSeLinuxStateSelectors, CommonContext, P> {
    ...
    protected CommonContext createFlowContext(FlowParameters flowParameters,
            StateContext<DatalakeEnableSeLinuxState, DatalakeEnableSeLinuxStateSelectors> stateContext,
            P payload) {
