...
public enum SdxDetachEvent implements FlowEvent {
    ...
    SDX_DETACH_STACK_SUCCESS_WITH_CCMV1_EVENT(),
    SDX_DETACH_STACK_SUCCESS_WITH_EXTERNAL_DB_EVENT(),
    SDX_DETACH_STACK_FAILED_EVENT(),
    SDX_DETACH_CCMV1_CLUSTER_PROXY_MAPPING_SUCCESS_EVENT(),
    SDX_DETACH_CCMV1_CLUSTER_PROXY_MAPPING_SUCCESS_WITH_EXTERNAL_DB_EVENT(),
    SDX_DETACH_CCMV1_CLUSTER_PROXY_MAPPING_FAILED_EVENT(),
