...
@Component
public class DatalakeUpgradeFlowConfig extends AbstractFlowConfiguration<DatalakeUpgradeState, DatalakeUpgradeEvent> implements RetryableFlowConfiguration<DatalakeUpgradeEvent> {
