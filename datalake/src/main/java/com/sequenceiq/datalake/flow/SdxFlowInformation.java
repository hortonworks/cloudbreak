...
import com.sequenceiq.datalake.flow.dr.backup.DatalakeDatabaseBackupFlowConfig;
import com.sequenceiq.datalake.flow.dr.restore.DatalakeDatabaseRestoreFlowConfig;
...
public class SdxFlowInformation implements ApplicationFlowInformation {
    ...
    private static final List<Class<? extends FlowConfiguration<?>>> RESTARTABLE_FLOWS = Arrays.asList(
            ...
            DatalakeDatabaseBackupFlowConfig.class,
            DatalakeDatabaseRestoreFlowConfig.class);
