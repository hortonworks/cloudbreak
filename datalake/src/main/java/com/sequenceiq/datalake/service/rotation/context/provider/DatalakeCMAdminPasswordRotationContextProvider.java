...
@Component
public class DatalakeCMAdminPasswordRotationContextProvider extends AbstractDatalakeRotationContextProvider {
    ...
    public Map<RotationSource, SecretType> getPollingTypes() {
        return Map.of(RotationSource.CLOUDBREAK, CloudbreakSecretType.CM_ADMIN_PASSWORD);
    }
}
