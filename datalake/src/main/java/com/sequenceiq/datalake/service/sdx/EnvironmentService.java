...
public class EnvironmentService implements ResourcePropertyProvider {
    ...
    public String getResourceCrnByResourceName(String resourceName) {
        ...
        return dlsByEnv.stream().findFirst().orElseThrow(() -> new NotFoundException(String.format("There is no environment with name %s", resourceName)))
    ...
    public Map<String, Optional<String>> getNamesByCrns(Collection<String> crns) {
        ...
        dlByEnvCrns.stream().forEach(dl -> result.putIfAbsent(dl.getEnvCrn(), Optional.of(dl.getEnvName())));
        return result;
    }
