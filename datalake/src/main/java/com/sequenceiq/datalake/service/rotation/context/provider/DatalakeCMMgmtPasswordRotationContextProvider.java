...
public class DatalakeCMMgmtPasswordRotationContextProvider implements RotationContextProvider {
    ...
    public Map<SecretRotationStep, RotationContext> getContexts(String resourceCrn) {
        return Map.of(CLOUDBREAK_ROTATE_POLLING, new CloudbreakPollerRotationContext(resourceCrn, CLUSTER_MGMT_CM_ADMIN_PASSWORD));
    }

    @Override
    public SecretType getSecret() {
        return DATALAKE_MGMT_CM_ADMIN_PASSWORD;
    }
}
