...
@Component
public class DatalakeComputeMonitoringCredentialsRotationContextProvider implements RotationContextProvider {
    ...
    public Map<SecretRotationStep, ? extends RotationContext> getContexts(String resourceCrn) {
        ...
        context.put(CLOUDBREAK_ROTATE_POLLING, new PollerRotationContext(resourceCrn, CloudbreakSecretType.COMPUTE_MONITORING_CREDENTIALS));
        return context;
    }
