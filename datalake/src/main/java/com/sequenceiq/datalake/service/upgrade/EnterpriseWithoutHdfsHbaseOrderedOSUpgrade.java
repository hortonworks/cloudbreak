...
@Component
public class EnterpriseWithoutHdfsHbaseOrderedOSUpgrade extends AbstractOrderedOSUpgrade {

    private static final Logger LOGGER = LoggerFactory.getLogger(EnterpriseWithoutHdfsHbaseOrderedOSUpgrade.class);
