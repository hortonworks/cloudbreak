...
@Component
public class DatalakeSaltMasterKeyPairRotationContextProvider extends AbstractDatalakeRotationContextProvider {
    ...
    public Map<RotationSource, SecretType> getPollingTypes() {
        return Map.of(RotationSource.CLOUDBREAK, CloudbreakSecretType.SALT_MASTER_KEY_PAIR);
    }
}
