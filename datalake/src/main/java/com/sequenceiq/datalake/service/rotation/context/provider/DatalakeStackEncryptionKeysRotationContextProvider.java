...
@Component
public class DatalakeStackEncryptionKeysRotationContextProvider implements RotationContextProvider {
    ...
    public Map<SecretRotationStep, ? extends RotationContext> getContexts(String resourceCrn) {
        ...
        context.put(CLOUDBREAK_ROTATE_POLLING, new PollerRotationContext(resourceCrn, CloudbreakSecretType.STACK_ENCRYPTION_KEYS));
        return context;
    }
