...
@Component
public class DatalakeNginxClusterSslCertPrivateKeyRotationContextProvider extends AbstractDatalakeRotationContextProvider {
    ...
    public Map<RotationSource, SecretType> getPollingTypes() {
        return Map.of(RotationSource.CLOUDBREAK, CloudbreakSecretType.NGINX_CLUSTER_SSL_CERT_PRIVATE_KEY);
    }
}
