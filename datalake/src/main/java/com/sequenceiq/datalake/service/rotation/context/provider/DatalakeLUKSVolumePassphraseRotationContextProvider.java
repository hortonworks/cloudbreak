...
@Component
public class DatalakeLUKSVolumePassphraseRotationContextProvider implements RotationContextProvider {
    ...
    public Map<SecretRotationStep, ? extends RotationContext> getContexts(String resourceCrn) {
        ...
        context.put(CLOUDBREAK_ROTATE_POLLING, new PollerRotationContext(resourceCrn, CloudbreakSecretType.LUKS_VOLUME_PASSPHRASE));
        return context;
    }
