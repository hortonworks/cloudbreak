...
public enum MetricType implements Metric {
    ...
    SDX_ENABLE_SELINUX_REQUESTED("sdx.enable.selinux.requested"),
    SDX_ENABLE_SELINUX_FINISHED("sdx.enable.selinux.finished"),
    SDX_ENABLE_SELINUX_FAILED("sdx.enable.selinux.failed"),
