...
public enum DatalakeStatusEnum {
    ...
    DATALAKE_ENABLE_SELINUX_VALIDATION_IN_PROGRESS(ResourceEvent.DATALAKE_ENABLE_SELINUX_VALIDATION_IN_PROGRESS),
    DATALAKE_ENABLE_SELINUX_VALIDATION_FAILED(ResourceEvent.DATALAKE_ENABLE_SELINUX_VALIDATION_FAILED),
    DATALAKE_ENABLE_SELINUX_ON_DATALAKE_IN_PROGRESS(ResourceEvent.DATALAKE_ENABLE_SELINUX_ON_DATALAKE_IN_PROGRESS),
    DATALAKE_ENABLE_SELINUX_ON_DATALAKE_FAILED(ResourceEvent.DATALAKE_ENABLE_SELINUX_ON_DATALAKE_FAILED),
    DATALAKE_ENABLE_SELINUX_FAILED(ResourceEvent.DATALAKE_ENABLE_SELINUX_FAILED),
