...
public enum DatalakeStatusEnum {
    ...
    DATALAKE_UPDATE_TRUSTED_REALM_IN_PROGRESS(ResourceEvent.DATALAKE_UPDATE_TRUSTED_REALM_IN_PROGRESS),
    DATALAKE_UPDATE_TRUSTED_REALM_FAILED(ResourceEvent.DATALAKE_UPDATE_TRUSTED_REALM_FAILED),
    ...
    DATALAKE_ENABLE_ENCRYPTION_PROFILE_IN_PROGRESS(ResourceEvent.DATALAKE_ENABLE_ENCRYPTION_PROFILE_IN_PROGRESS),
    DATALAKE_ENABLE_ENCRYPTION_PROFILE_FAILED(ResourceEvent.DATALAKE_ENABLE_ENCRYPTION_PROFILE_FAILED),
    ...
    DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_IN_PROGRESS(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_IN_PROGRESS),
    DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_FAILED(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_FAILED),
    DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_IN_PROGRESS(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_IN_PROGRESS),
    DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_FAILED(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_FAILED),
    DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_IN_PROGRESS(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_IN_PROGRESS),
    DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_FAILED(ResourceEvent.DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_FAILED),
    ...
    public DatalakeStatusEnum mapToFailedIfInProgress() {
        switch (this) {
            ...
            case DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_IN_PROGRESS:
                return DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_FAILED;
            case DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_IN_PROGRESS:
                return DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_FAILED;
            case DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_IN_PROGRESS:
                return DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_FAILED;
            case DATALAKE_UPDATE_TRUSTED_REALM_IN_PROGRESS:
                return DATALAKE_UPDATE_TRUSTED_REALM_FAILED;
            case DATALAKE_ENABLE_ENCRYPTION_PROFILE_IN_PROGRESS:
                return DATALAKE_ENABLE_ENCRYPTION_PROFILE_FAILED;
            default:
                return this;
        }
    }
