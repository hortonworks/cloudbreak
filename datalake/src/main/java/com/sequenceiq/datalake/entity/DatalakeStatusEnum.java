...
public enum DatalakeStatusEnum {
    ...
    VERTICAL_SCALE_VALIDATION_IN_PROGRESS(ResourceEvent.VERTICAL_SCALE_VALIDATION_IN_PROGRESS),
    VERTICAL_SCALE_VALIDATION_FAILED(ResourceEvent.VERTICAL_SCALE_VALIDATION_FAILED),
    VERTICAL_SCALE_ON_DATALAKE_IN_PROGRESS(ResourceEvent.VERTICAL_SCALE_ON_DATALAKE_IN_PROGRESS),
    VERTICAL_SCALE_ON_DATALAKE_FAILED(ResourceEvent.VERTICAL_SCALE_ON_DATALAKE_FAILED),
    VERTICAL_SCALE_FAILED(ResourceEvent.VERTICAL_SCALE_FAILED);
