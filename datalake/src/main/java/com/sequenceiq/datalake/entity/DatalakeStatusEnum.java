...
public enum DatalakeStatusEnum {
    ...
    DATALAKE_SECRET_ROTATION_IN_PROGRESS(ResourceEvent.DATALAKE_SECRET_ROTATION_IN_PROGRESS),
    DATALAKE_SECRET_ROTATION_FINISHED(ResourceEvent.DATALAKE_SECRET_ROTATION_FINISHED),
    DATALAKE_SECRET_ROTATION_FAILED(ResourceEvent.DATALAKE_SECRET_ROTATION_FAILED),
    DATALAKE_SECRET_ROTATION_ROLLBACK_IN_PROGRESS(ResourceEvent.DATALAKE_SECRET_ROTATION_ROLLBACK_IN_PROGRESS),
    DATALAKE_SECRET_ROTATION_ROLLBACK_FINISHED(ResourceEvent.DATALAKE_SECRET_ROTATION_ROLLBACK_FINISHED),
    DATALAKE_SECRET_ROTATION_ROLLBACK_FAILED(ResourceEvent.DATALAKE_SECRET_ROTATION_ROLLBACK_FAILED),
    DATALAKE_SECRET_ROTATION_FINALIZE_IN_PROGRESS(ResourceEvent.DATALAKE_SECRET_ROTATION_FINALIZE_IN_PROGRESS),
    DATALAKE_SECRET_ROTATION_FINALIZE_FAILED(ResourceEvent.DATALAKE_SECRET_ROTATION_FINALIZE_FAILED);
