...
class StructuredSynchronizerJobInitializerTest {
    ...
    void testInitJobs(boolean structuredSyncEnabled) {
        ...
        lenient().when(stackService.findAllAliveForAutoSync(EnumSet.of(Status.DELETE_COMPLETED))).thenReturn(List.of(jobResource1, jobResource2));
        ...
        if (structuredSyncEnabled) {
            ...
            verifyNoInteractions(stackService, jobService);
        }
    }
