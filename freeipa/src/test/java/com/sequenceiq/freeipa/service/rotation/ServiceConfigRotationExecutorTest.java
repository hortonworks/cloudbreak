...
import com.sequenceiq.freeipa.service.rotation.saltboot.ServiceConfigRotationExecutor;
...
class ServiceConfigRotationExecutorTest {
    ...
    public void rotateWithOldSaltBootSecrets() throws Exception {
        ServiceConfigRotationContext context = getServiceConfigRotationContext();
    ...
    private ServiceConfigRotationContext getServiceConfigRotationContext() {
        return new ServiceConfigRotationContext(RESOURCE_CRN) {
            @Override
