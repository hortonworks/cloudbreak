...
class BootstrapServiceTest {
    ...
    public static final String INSTANCE_WITH_FQDN = "instanceWithFqdn";

    public static final String INSTANCE_WO_FQDN = "instanceWOFqdn";

    public static final String INSTANCE_WRONG_DOMAIN = "instanceWrongDomain";

    public static final String DOMAIN = "bootstrap.test";

    public static final String HOSTNAME = "ipaHostname";
    ...
    public void testBootstrapWIthInstanceIds() throws CloudbreakOrchestratorException, IOException {
        when(instanceMetaDataRepository.findNotTerminatedForStack(STACK_ID)).thenReturn(Set.of(
