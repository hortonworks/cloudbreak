...
import com.sequenceiq.freeipa.service.rotation.saltboot.SaltBootConfigRotationContext;
import com.sequenceiq.freeipa.service.rotation.saltboot.SaltBootConfigRotationExecutor;
import com.sequenceiq.freeipa.service.rotation.saltboot.SaltBootUpdateConfiguration;
...
class SaltBootConfigRotationExecutorTest {
    ...
    public void rotateWithOldSaltBootSecrets() throws Exception {
        SaltBootConfigRotationContext context = getSaltBootConfigRotationContext();
    ...
    private SaltBootConfigRotationContext getSaltBootConfigRotationContext() {
