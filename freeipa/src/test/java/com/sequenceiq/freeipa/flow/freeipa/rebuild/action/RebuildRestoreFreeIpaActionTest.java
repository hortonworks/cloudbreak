...
class RebuildRestoreFreeIpaActionTest {
    ...
    @InjectMocks
    private RebuildRestoreFreeIpaAction underTest;
    ...
    void doExecute() throws Exception {
        ...
        underTest.doExecute(context, new InstallFreeIpaServicesSuccess(3L), variables);

        verify(stackUpdater).updateStackStatus(stack, DetailedStackStatus.REBUILD_IN_PROGRESS, "Restoring FreeIPA from backup");
        ...
        FreeIpaRestoreRequest payload = (FreeIpaRestoreRequest) payloadCapture.getValue();
    ...
    void getFailurePayload() {
        ...
        FreeIpaRestoreFailed result = (FreeIpaRestoreFailed) underTest.getFailurePayload(new InstallFreeIpaServicesSuccess(3L), Optional.empty(), ex);
