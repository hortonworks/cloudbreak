...
class RebuildFailedActionTest {
    ...
    private static final int PAYLOAD_CONVERTER_COUNT = 3;
    ...
    void initPayloadConverterMap() {
        ...
        assertTrue(Stream.of(UpscaleStackResult.class, DownscaleStackCollectResourcesResult.class, DownscaleStackResult.class)
