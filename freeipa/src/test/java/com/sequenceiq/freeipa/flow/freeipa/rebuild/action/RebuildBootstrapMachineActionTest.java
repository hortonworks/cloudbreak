...
class RebuildBootstrapMachineActionTest {
    ...
    @InjectMocks
    private RebuildBootstrapMachineAction underTest;
    ...
    void doExecute() throws Exception {
        ...
        BootstrapMachinesRequest payload = (BootstrapMachinesRequest) payloadCapture.getValue();
        assertEquals(4L, payload.getResourceId());
        verify(stackUpdater).updateStackStatus(stack, DetailedStackStatus.REBUILD_IN_PROGRESS, "Bootstrapping machines");
    }
}