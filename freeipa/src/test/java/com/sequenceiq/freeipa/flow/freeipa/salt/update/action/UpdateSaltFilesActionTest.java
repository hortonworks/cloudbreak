...
class UpdateSaltFilesActionTest {
    ...
    private UpdateSaltFilesAction underTest;

    private StackContext context;

    @BeforeEach
    void setUp() {
        underTest = new UpdateSaltFilesAction(SaltUpdateTriggerEvent.class);
    ...
    @Test
    void updateSaltFilesActionSendsStartedNotification() throws Exception {
        SaltUpdateTriggerEvent payload = new SaltUpdateTriggerEvent(1L, null, false, false, "op-1");
        ...
        verify(eventSenderService).sendEventAndNotification(stack, "user-crn", FREEIPA_SALT_UPDATE_STARTED);
    }
}
