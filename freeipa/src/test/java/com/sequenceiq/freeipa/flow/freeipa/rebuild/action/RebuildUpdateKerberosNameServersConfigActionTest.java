...
class RebuildUpdateKerberosNameServersConfigActionTest {
    ...
    @InjectMocks
    private RebuildUpdateKerberosNameServersConfigAction underTest;
    ...
    void doExecute() throws Exception {
        ...
        verify(stackUpdater).updateStackStatus(stack, DetailedStackStatus.REBUILD_IN_PROGRESS, "Updating kerberos nameserver config");
        ...
        assertEquals(UPDATE_KERBEROS_NAMESERVERS_CONFIG_FINISHED_EVENT.event(), event.selector());
    }
}