...
class MultiAzMigrationInitFlowIntegrationTest {
    ...
    @MockitoBean
    private com.sequenceiq.freeipa.service.EnvironmentService environmentService;
        ...
        environment = DetailedEnvironmentResponse.builder()
                .withNetwork(EnvironmentNetworkResponse.builder()
                        .withSubnetMetas(Map.of(
                                "subnet1", new CloudSubnet.Builder().availabilityZone("az1").build(),
                                "subnet2", new CloudSubnet.Builder().availabilityZone("az2").build()
                        ))
                        .build())
                .build();
    ...
    @Test
    public void testSuccessfulMultiAzMigrationInit() {
    ...
    @Test
    public void testFailedMultiAzMigrationInit() {
        when(cachedEnvironmentClientService.getByCrn(any())).thenThrow(new RuntimeException("Environment lookup failed"));
