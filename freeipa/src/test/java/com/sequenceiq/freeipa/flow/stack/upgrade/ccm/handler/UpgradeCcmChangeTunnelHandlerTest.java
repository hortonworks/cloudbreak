...
class UpgradeCcmChangeTunnelHandlerTest {
    ...
    @InjectMocks
    private UpgradeCcmChangeTunnelHandler underTest;
    ...
    void changeTunnelCalledInAnyCase() {
        ...
        assertThat(eventResult.getData().selector()).isEqualTo(UPGRADE_CCM_TUNNEL_CHANGE_FINISHED_EVENT.event());
