...
class RebuildRegisterClusterProxyActionTest {
    ...
    @InjectMocks
    private RebuildRegisterClusterProxyAction underTest;
    ...
    void doExecute() throws Exception {
        ...
        ClusterProxyRegistrationRequest payload = (ClusterProxyRegistrationRequest) payloadCapture.getValue();
        assertEquals(4L, payload.getResourceId());
        verify(stackUpdater).updateStackStatus(stack, DetailedStackStatus.REBUILD_IN_PROGRESS, "Update cluster proxy registration before bootstrap");
    }
}