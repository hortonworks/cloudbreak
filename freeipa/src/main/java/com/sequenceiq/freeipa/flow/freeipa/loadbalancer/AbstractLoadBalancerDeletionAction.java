...
public abstract class AbstractLoadBalancerDeletionAction<P extends Payload>
        extends AbstractStackAction<FreeIpaLoadBalancerDeletionState, FreeIpaLoadBalancerDeletionEvent, StackContext, P> {
    ...
    protected AbstractLoadBalancerDeletionAction(Class<P> payloadClass) {
        super(payloadClass);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters,
            StateContext<FreeIpaLoadBalancerDeletionState, FreeIpaLoadBalancerDeletionEvent> stateContext, P payload) {
    ...
    protected Object getFailurePayload(P payload, Optional<StackContext> flowContext, Exception ex) {
        return new LoadBalancerDeletionFailureEvent(payload.getResourceId(), ERROR, ex);
    }
}
