...
public class ModifyUserDefinedTagsStackHandlerEvent extends StackEvent {
    ...
    public ModifyUserDefinedTagsStackHandlerEvent(Long resourceId, String operationId, Map<String, String> userDefinedTags) {
        this(resourceId, operationId, userDefinedTags, Set.of());
    }

    @JsonCreator
    public ModifyUserDefinedTagsStackHandlerEvent(
    ...
    public String toString() {
        return super.toString() + ' ' +
                "ModifyUserDefinedTagsStackHandlerEvent{" +
