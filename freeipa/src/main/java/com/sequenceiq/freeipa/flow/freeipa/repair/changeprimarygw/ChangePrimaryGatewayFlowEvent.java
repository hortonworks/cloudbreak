...
public enum ChangePrimaryGatewayFlowEvent implements FlowEvent {
    ...
    CHANGE_PRIMARY_GATEWAY_DISABLE_STATUS_CHECKER_FINISHED_EVENT("CHANGE_PRIMARY_GATEWAY_DISABLE_STATUS_CHECKER_FINISHED_EVENT"),
    CHANGE_PRIMARY_GATEWAY_DISABLE_STATUS_CHECKER_FAILED_EVENT("CHANGE_PRIMARY_GATEWAY_DISABLE_STATUS_CHECKER_FAILED_EVENT"),
    ...
    CHANGE_PRIMARY_GATEWAY_ENABLE_STATUS_CHECKER_FINISHED_EVENT("CHANGE_PRIMARY_GATEWAY_ENABLE_STATUS_CHECKER_FINISHED_EVENT"),
    CHANGE_PRIMARY_GATEWAY_ENABLE_STATUS_CHECKER_FAILED_EVENT("CHANGE_PRIMARY_GATEWAY_ENABLE_STATUS_CHECKER_FAILED_EVENT"),
    CHANGE_PRIMARY_GATEWAY_FINISHED_EVENT("CHANGE_PRIMARY_GATEWAY_FINISHED_EVENT"),
    FAILURE_EVENT("CHANGE_PRIMARY_GATEWAY_FAILURE_EVENT"),
