...
@Component("FreeIpaTrustCancelFinishedAction")
public class FreeIpaTrustCancelFinishedAction extends FreeIpaTrustCancelAction<StackEvent> {

    @Inject
    private OperationService operationService;

    public FreeIpaTrustCancelFinishedAction() {
    ...
    protected void doExecute(StackContext context, StackEvent payload, Map<Object, Object> variables) throws Exception {
        ...
        updateStatuses(stack, AVAILABLE, "Cancel cross-realm trust was successful", TRUST_SETUP_REQUIRED);
