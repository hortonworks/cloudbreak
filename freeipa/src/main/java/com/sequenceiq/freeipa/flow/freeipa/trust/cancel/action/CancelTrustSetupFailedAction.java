...
@Component("CancelTrustSetupFailedAction")
public class CancelTrustSetupFailedAction extends AbstractCancelTrustSetupAction<CancelTrustSetupFailureEvent> {

    @Inject
    private OperationService operationService;

    public CancelTrustSetupFailedAction() {
        super(CancelTrustSetupFailureEvent.class);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters, StateContext<FreeIpaCancelTrustSetupState,
            FreeIpaCancelTrustSetupFlowEvent> stateContext, CancelTrustSetupFailureEvent payload) {
    ...
    @Override
    protected void doExecute(StackContext context, CancelTrustSetupFailureEvent payload, Map<Object, Object> variables) throws Exception {
        ...
        sendEvent(context, new StackEvent(CANCEL_TRUST_SETUP_FAILURE_HANDLED_EVENT.event(), payload.getResourceId()));
    }
}
