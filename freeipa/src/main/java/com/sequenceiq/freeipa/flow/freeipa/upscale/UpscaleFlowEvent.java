...
public enum UpscaleFlowEvent implements FlowEvent {
    ...
    UPSCALE_DISABLE_STATUS_CHECKER_FINISHED_EVENT("UPSCALE_DISABLE_STATUS_CHECKER_FINISHED_EVENT"),
    UPSCALE_DISABLE_STATUS_CHECKER_FAILED_EVENT("UPSCALE_DISABLE_STATUS_CHECKER_FAILED_EVENT"),
    ...
    UPSCALE_ENABLE_STATUS_CHECKER_FINISHED_EVENT("UPSCALE_ENABLE_STATUS_CHECKER_FINISHED_EVENT"),
    UPSCALE_ENABLE_STATUS_CHECKER_FAILED_EVENT("UPSCALE_ENABLE_STATUS_CHECKER_FAILED_EVENT"),
