...
public enum DownscaleFlowEvent implements FlowEvent {
    ...
    DOWNSCALE_DISABLE_STATUS_CHECKER_FINISHED_EVENT("DOWNSCALE_DISABLE_STATUS_CHECKER_FINISHED_EVENT"),
    DOWNSCALE_DISABLE_STATUS_CHECKER_FAILED_EVENT("DOWNSCALE_DISABLE_STATUS_CHECKER_FAILED_EVENT"),
    ...
    DOWNSCALE_ENABLE_STATUS_CHECKER_FINISHED_EVENT("DOWNSCALE_ENABLE_STATUS_CHECKER_FINISHED_EVENT"),
    DOWNSCALE_ENABLE_STATUS_CHECKER_FAILED_EVENT("DOWNSCALE_ENABLE_STATUS_CHECKER_FAILED_EVENT"),
