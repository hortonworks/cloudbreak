...
public class UpgradeCcmState implements FlowState {
    ...
    public static final String UPGRADE_CCM_RECONFIGURE_STATE_NAME = "UPGRADE_CCM_RECONFIGURE_STATE";

    public static final String UPGRADE_CCM_REGISTER_CCM_STATE_NAME = "UPGRADE_CCM_REGISTER_CCM_STATE";
    ...
    public static final UpgradeCcmState UPGRADE_CCM_RECONFIGURE_STATE = new UpgradeCcmState(UPGRADE_CCM_RECONFIGURE_STATE_NAME);

    public static final UpgradeCcmState UPGRADE_CCM_REGISTER_CCM_STATE = new UpgradeCcmState(UPGRADE_CCM_REGISTER_CCM_STATE_NAME);
