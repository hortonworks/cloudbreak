...
public enum UpscaleState implements FlowState {
    ...
    FREEIPA_UPSCALE_IMAGE_FALLBACK_STATE,
    FREEIPA_UPSCALE_IMAGE_FALLBACK_START_STATE,
    ...
    UPSCALE_VALIDATE_NEW_INSTANCES_HEALTH_STATE,
    UPSCALE_UPDATE_KERBEROS_NAMESERVERS_CONFIG_STATE,
    UPSCALE_UPDATE_LOAD_BALANCER_STATE,
