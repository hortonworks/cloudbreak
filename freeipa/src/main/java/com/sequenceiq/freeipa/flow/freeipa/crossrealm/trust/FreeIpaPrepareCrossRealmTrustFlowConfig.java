...
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.CONFIGURE_DNS_FAILED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.CONFIGURE_DNS_FINISHED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_CROSS_REALM_TRUST_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_CROSS_REALM_TRUST_FAILURE_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_CROSS_REALM_TRUST_FAILURE_HANDLED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_CROSS_REALM_TRUST_FINISHED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_IPA_SERVER_FAILED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.PREPARE_IPA_SERVER_FINISHED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.VALIDATION_FAILED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustFlowEvent.VALIDATION_FINISHED_EVENT;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.CONFIGURE_DNS_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.FINAL_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.INIT_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.PREPARE_CROSS_REALM_TRUST_FAILED_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.PREPARE_CROSS_REALM_TRUST_FINISHED_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.PREPARE_IPA_SERVER_STATE;
import static com.sequenceiq.freeipa.flow.freeipa.crossrealm.trust.FreeIpaPrepareCrossRealmTrustState.VALIDATION_STATE;
