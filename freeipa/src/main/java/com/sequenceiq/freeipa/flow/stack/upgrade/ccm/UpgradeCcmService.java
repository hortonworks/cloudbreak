...
public class UpgradeCcmService {
    ...
    public void finishedState(Long stackId, Boolean minaRemoved) throws CloudbreakOrchestratorException {
    ...
    public void failedState(UpgradeCcmContext context, UpgradeCcmFailureEvent payload) {
        ...
        stackUpdater.updateStackStatus(payload.getResourceId(), detailedStatus, payload.getStatusReason());
    }
