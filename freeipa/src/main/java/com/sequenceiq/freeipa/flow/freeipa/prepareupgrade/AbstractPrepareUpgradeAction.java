...
public abstract class AbstractPrepareUpgradeAction<P extends Payload>
        extends AbstractStackAction<PrepareUpgradeState, PrepareUpgradeEvent, StackContext, P>
    ...
    protected AbstractPrepareUpgradeAction(Class<P> payloadClass) {
        super(payloadClass);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters,
            StateContext<PrepareUpgradeState, PrepareUpgradeEvent> stateContext, P payload) {
