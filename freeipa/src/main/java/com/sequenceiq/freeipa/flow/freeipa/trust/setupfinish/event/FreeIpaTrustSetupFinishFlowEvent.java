...
public enum FreeIpaTrustSetupFinishFlowEvent implements FlowEvent {
    ...
    TRUST_SETUP_FINISH_VALIDATE_TRUST_FINISHED_EVENT(EventSelectorUtil.selector(FreeIpaTrustSetupFinishValidateTrustSuccess.class)),
    TRUST_SETUP_FINISH_VALIDATE_TRUST_FAILED_EVENT(EventSelectorUtil.selector(FreeIpaTrustSetupFinishValidateTrustFailed.class)),
