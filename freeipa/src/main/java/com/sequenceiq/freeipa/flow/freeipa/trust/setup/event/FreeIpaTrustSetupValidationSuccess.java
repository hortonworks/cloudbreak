...
public class FreeIpaTrustSetupValidationSuccess extends StackEvent {
    private final TaskResults taskResults;

    @JsonCreator
    public FreeIpaTrustSetupValidationSuccess(@JsonProperty("resourceId") Long stackId, @JsonProperty("taskResults")TaskResults taskResults) {
        super(stackId);
