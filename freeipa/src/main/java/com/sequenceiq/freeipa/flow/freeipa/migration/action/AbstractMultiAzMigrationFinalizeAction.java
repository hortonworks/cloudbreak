...
public abstract class AbstractMultiAzMigrationFinalizeAction<P extends Payload>
        extends AbstractCommonChainAction<MultiAzMigrationFinalizeState, MultiAzMigrationFinalizeFlowEvent, StackContext, P>
    ...
    protected AbstractMultiAzMigrationFinalizeAction(Class<P> payloadClass) {
        super(payloadClass);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters,
            StateContext<MultiAzMigrationFinalizeState, MultiAzMigrationFinalizeFlowEvent> stateContext, P payload) {
    ...
    protected Object getFailurePayload(P payload, Optional<StackContext> flowContext, Exception ex) {
        return new MultiAzMigrationFinalizeFailedEvent(payload.getResourceId(), ex);
    }
}
