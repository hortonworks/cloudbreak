    ...
    private Map<String, String> getMDCParams(Object target, String[] paramNames, Object[] args) {
        ...
        for (int i = 0; i < paramNames.length; i++) {
            ...
            if (paramName.contains("name")) {
                ...
                result.put(LoggerContextKey.ENVIRONMENT_CRN.toString(), paramString);
            } else if (paramName.contains("request")) {
                result.put(LoggerContextKey.ENVIRONMENT_CRN.toString(), MDCBuilder.getFieldValue(paramValue, "environmentCrn"));
