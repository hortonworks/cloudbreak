...
import com.sequenceiq.freeipa.job.stackpatcher.config.ExistingStackPatcherConfig;
import com.sequenceiq.freeipa.service.stack.StackService;
import com.sequenceiq.freeipa.service.stackpatch.StackPatchService;

@Component
public class ExistingStackPatcherJobInitializer implements JobInitializer {
    ...
    private Function<Long, Long> randomLongProvider = RandomUtil::getLong;
    ...
    public void initJobs() {
        ...
        Map<Long, JobResource> stacksById = checkedMeasure(() -> stackService.findAllForAutoSync(), LOGGER,
                ":::Stack patcher::: Stacks are fetched from db in {}ms").stream()
    ...
    private void scheduleForStackChunk(Set<Long> stackIdsChunk, Set<StackPatchType> enabledStackPatchTypes, Map<Long, JobResource> stacksById) {
    ...
    private void scheduleForStack(JobResource stack, Set<StackPatchType> enabledStackPatchTypes,
    ...
    private LocalDateTime calculateNextJobFirstStart(LocalDateTime currentJobFirstStart, LocalDateTime now, long maxInitialStartDelay, long maxJobCount) {
