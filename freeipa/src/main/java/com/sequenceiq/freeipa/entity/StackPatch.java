...
import com.sequenceiq.freeipa.entity.util.StackPatchStatusConverter;
import com.sequenceiq.freeipa.entity.util.StackPatchTypeConverter;

@Entity
@Table(name = "stackpatch", uniqueConstraints = @UniqueConstraint(columnNames = {"stack_id", "type"}))
