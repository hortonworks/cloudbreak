...
import com.sequenceiq.freeipa.api.v1.freeipa.crossrealm.CrossRealmV1Endpoint;
...
public class CrossRealmV1Controller implements CrossRealmV1Endpoint {

    private static final Logger LOGGER = LoggerFactory.getLogger(CrossRealmV1Controller.class);
    ...
    public PrepareCrossRealmTrustResponse prepare(@RequestObject PrepareCrossRealmTrustRequest request) {
    ...
    @Override
    @CheckPermissionByRequestProperty(path = "environmentCrn", type = CRN, action = ADMIN_FREEIPA)
    public FinishCrossRealmTrustResponse finish(@RequestObject FinishCrossRealmTrustRequest request) {
        String accountId = crnService.getCurrentAccountId();
