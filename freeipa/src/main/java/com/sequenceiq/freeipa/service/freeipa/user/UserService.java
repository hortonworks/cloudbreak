...
public class UserService {
    ...
    private SyncStatusDetail synchronizeStack(Stack stack, UsersState umsUsersState) {
        ...
        try {
            ...
            // Get all users fro FreeIPA those are requested. If we use only UMS provided users for this environment and if user's access is being changed (removed user from env),
