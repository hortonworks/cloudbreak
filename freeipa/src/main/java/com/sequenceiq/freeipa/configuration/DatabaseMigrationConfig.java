...
public class DatabaseMigrationConfig {
    ...
    private static final String DEFAULT_SCHEMA_LOCATION_IN_SOURCE = "freeipa/src/main/resources/schema";
    ...
    @Value("${freeipa.schema.scripts.location:" + DEFAULT_SCHEMA_LOCATION_IN_SOURCE + '}')
    private String schemaLocation;

    @Value("${freeipa.schema.migration.auto:true}")
