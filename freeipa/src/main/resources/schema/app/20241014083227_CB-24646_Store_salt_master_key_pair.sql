...
ALTER TABLE saltsecurityconfig ADD COLUMN IF NOT EXISTS saltmasterprivatekeyvault TEXT;

-- //@UNDO
-- SQL to undo the change goes here.

ALTER TABLE saltsecurityconfig DROP COLUMN IF EXISTS saltmasterpublickey;
ALTER TABLE saltsecurityconfig DROP COLUMN IF EXISTS saltmasterprivatekeyvault;
