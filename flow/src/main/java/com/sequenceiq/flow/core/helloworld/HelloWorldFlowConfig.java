...
import static com.sequenceiq.flow.core.helloworld.HelloWorldEvent.HELLO_WORLD_SOMETHING_WENT_WRONG;
import static com.sequenceiq.flow.core.helloworld.HelloWorldEvent.START_HELLO_WORLD_EVENT;
import static com.sequenceiq.flow.core.helloworld.HelloWorldState.FINAL_STATE;
import static com.sequenceiq.flow.core.helloworld.HelloWorldState.HELLO_WORLD_FAILED_STATE;
import static com.sequenceiq.flow.core.helloworld.HelloWorldState.HELLO_WORLD_FINISHED_STATE;
import static com.sequenceiq.flow.core.helloworld.HelloWorldState.HELLO_WORLD_START_STATE;
import static com.sequenceiq.flow.core.helloworld.HelloWorldState.INIT_STATE;
