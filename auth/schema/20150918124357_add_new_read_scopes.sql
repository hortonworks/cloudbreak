...
DELETE FROM group_membership WHERE group_id='2a4f837e-2ab0-4663-8644-de23047d040d';
DELETE FROM group_membership WHERE group_id='9fc82f95-0318-4dda-af65-ea32e2f00497';
DELETE FROM group_membership WHERE group_id='8cbffdab-560d-4e14-9d1e-d5ff3f43bec6';
DELETE FROM group_membership WHERE group_id='7f85eaad-4dac-4f74-9238-aef0e585df07';
DELETE FROM group_membership WHERE group_id='aac2dad1-6a7b-4ae2-9c58-e71d367d0e2d';
DELETE FROM group_membership WHERE group_id='6674545b-295c-4f23-b1b4-953447dc5f40';
DELETE FROM group_membership WHERE group_id='f07b098a-2700-471a-9f0d-f7dd730db95d';
