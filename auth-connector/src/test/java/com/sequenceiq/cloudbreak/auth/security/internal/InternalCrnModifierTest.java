...
public class InternalCrnModifierTest {
    ...
    public void testModificationIfUserCrnIsInternalButThereIsNoResourceCrnParameter() {
        when(reflectionUtil.getParameter(any(), any(), eq(TenantAwareCrnParam.class))).thenReturn(Optional.empty());
    ...
    public void testModificationIfUserCrnIsInternalButResourceCrnParameterIsNotString() {
        when(reflectionUtil.getParameter(any(), any(), eq(TenantAwareCrnParam.class))).thenReturn(Optional.of(2));
    ...
    public void testModificationIfUserCrnIsInternalButResourceCrnParameterIsNotCrn() {
        when(reflectionUtil.getParameter(any(), any(), eq(TenantAwareCrnParam.class))).thenReturn(Optional.of("not_crn"));
    ...
    public void testModificationIfUserCrnIsInternal() {
        when(reflectionUtil.getParameter(any(), any(), eq(TenantAwareCrnParam.class))).thenReturn(Optional.of(STACK_CRN));
