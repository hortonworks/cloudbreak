...
public enum Entitlement {
    ...
    CDP_DATALAKE_KNOX_GATEWAY_DB_DR,
    ...
    CDP_FALLBACK_INSTANCETYPE,
    CDP_FALLBACK_DATABASE_INSTANCETYPE,
    CDP_CUSTOM_DATABASE_INSTANCETYPE,
    ...
    CDP_VALIDATE_DISTROX_OPERATIONS_BY_SDX_HEALTH,
    CDP_PRIVATELINKS,
    CDP_CB_PREFER_MINIFI_LOGGING,
    CDP_DATALAKE_SHAPES_WITHOUT_HBASE_AND_HDFS,
    GP2_TO_GP3_MIGRATION,
    CDP_CHANGE_ENCRYPTION_PROFILE,
    CDP_CB_FREEIPA_MULTI_AZ_MIGRATION,
    CDP_CB_DISABLE_STRICT_IMAGE_CATALOG_URL_VALIDATION,
    CDP_CB_ENABLE_UPDATE_RESOURCE_ATTRIBUTES,
    CDP_GLOBAL_DEFAULT_TEMPLATE,
    CDP_FREEIPA_ROLLING_VERTICAL_SCALE,
    CDP_AZURE_MULTIPLE_RESOURCE_GROUP_REJECT,
    CDP_GCP_RAZ_WITH_CAB;
}
