...
./gradlew -Penv=jenkins -b build.gradle clean build release uploadArchives -Prelease.scope=$SCOPE -Prelease.stage=final --refresh-dependencies --info --stacktrace --parallel
