...
./gradlew -Penv=jenkins -b build.gradle buildInfo build uploadBootArchives -Pversion=$VERSION --parallel -x checkstyleMain -x checkstyleTest -x spotbugsMain -x spotbugsTest --quite
