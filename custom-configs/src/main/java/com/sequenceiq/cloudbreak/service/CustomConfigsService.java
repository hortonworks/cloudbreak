...
public class CustomConfigsService implements ResourcePropertyProvider {
    ...
    public CustomConfigs deleteByCrn(String crn) {
        Optional<CustomConfigs> customServiceConfigsByCrn = Optional.of(customConfigsRepository.findCustomConfigsByResourceCrn(crn)
    ...
    public CustomConfigs deleteByName(String name, String accountId) {
        Optional<CustomConfigs> customServiceConfigsByName = Optional.of(customConfigsRepository.findCustomConfigsByNameAndAccountId(name, accountId)
