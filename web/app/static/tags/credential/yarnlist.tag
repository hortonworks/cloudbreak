<form class="form-horizontal" role="document">
    ...
    <div class="form-group" ng-show="credential.description">
        ...
        <div class="col-sm-9">
            <p id="importedStackDescription" class="form-control-static">{{credential.description}}</p>
        </div>
        <!-- .col-sm-9 -->
    </div>
    <div class="form-group">
        <label class="col-sm-3 control-label" for="orchestratorEndpoint">{{msg.credential_yarn_form_yarn_endpoint}}</label>
