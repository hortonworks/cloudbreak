...
<div class="form-group" ng-class="{ 'has-error': azureRmCredentialForm.azure_sshPublicKey.$dirty && azureRmCredentialForm.azure_sshPublicKey.$invalid }">
    ...
    <div class="col-sm-9">
        <textarea rows="4" type="text" ng-attr-placeholder="{{msg.credential_azure_form_ssh_cert_placeholder}}" class="form-control" ng-model="credentialAzureRm.publicKey" name="azure_sshPublicKey" id="azure_sshPublicKey" required></textarea>
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="topologySelect" name="topologySelect" ng-model="credentialAzureRm.topologyId" ng-options="topology.id as topology.name for topology in $root.topologies | filter: filterByCloudPlatform | orderBy:'name'">
