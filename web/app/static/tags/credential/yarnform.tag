<div class="form-group" ng-class="{ 'has-error': yarnImportStackForm.yarnStackName.$dirty && yarnImportStackForm.yarnStackName.$invalid }">
    ...
    <div class="col-sm-9">
        <input type="text" ng-pattern="/^[a-z][-a-z0-9]*[a-z0-9]$/" class="form-control" ng-model="credentialYarn.name" id="yarnStackName" name="yarnStackName" ng-minlength="5" ng-maxlength="100" required placeholder="{{msg.name_placeholder}}">
...
<div class="form-group" ng-class="{ 'has-error': yarnImportStackForm.yarnStackDescription.$dirty && yarnImportStackForm.yarnStackDescription.$invalid }">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" ng-model="credentialYarn.description" id="yarnStackDescription" name="yarnStackDescription" ng-maxlength="1000" placeholder="{{msg.credential_form_description_placeholder}}">
...
<div class="form-group" ng-class="{ 'has-error': yarnImportStackForm.yarnEndpoint.$dirty && yarnImportStackForm.yarnEndpoint.$invalid }">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" name="yarnEndpoint" ng-model="credentialYarn.parameters.apiEndpoint" ng-minlength="5" required id="yarnEndpoint">
...
<div class="form-group">
    ...
    <div class="col-sm-9">
        <input type="checkbox" name="credPublic" id="credPublic" ng-model="credentialYarn.public">
    </div>
    <!-- .col-sm-9 -->
</div>
...
<div class="row btn-row">
    <div class="col-sm-9 col-sm-offset-3">
        <a id="importYarnStack" ng-disabled="yarnImportStackForm.$invalid" ng-click="createYarnCredential()" class="btn btn-success btn-block" role="button"><i
