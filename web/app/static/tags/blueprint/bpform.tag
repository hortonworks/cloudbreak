<div class="form-group" ng-class="{ 'has-error': blueprintForm.name.$dirty && blueprintForm.name.$invalid }">
    ...
    <div class="col-sm-9">
        <input type="text" class="form-control" id="name" ng-model="blueprint.name" name="name" ng-minlength="1" ng-maxlength="100" placeholder="{{msg.name_placeholder}}" required>
