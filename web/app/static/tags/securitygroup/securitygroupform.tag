...
<div class="panel-group" id="security-accordion" role="tablist" aria-multiselectable="true">
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="security-headingOne">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#security-accordion" href="#security-collapseOne" aria-expanded="true" aria-controls="security-collapseOne" ng-click="selectSecurityGroupType1()">
                    <i class="fa fa-sitemap fa-fw"/><span style="padding-left: 10px">{{msg.security_group_form_type1_title}}</span>
                </a>
            </h4>
        </div>
        <div id="security-collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="security-headingOne">
            <div class="panel-body">
                <div class="form-group col-sm-12">
                    <i class="fa fa-info-circle" /><small>&nbsp;{{msg.security_group_form_type1_info}}</small>
                </div>
                <form class="form-horizontal" role="form" name="securitygroupForm_1">
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_1.sgname.$dirty && securitygroupForm_1.sgname.$invalid }">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="help-block" ng-show="securitygroupForm_1.sgname.$dirty && securitygroupForm_1.sgname.$invalid">
                                <i class="fa fa-warning"></i> {{msg.securitygroup_name_invalid}}
                            </div>
                        </div>
                    </div>
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_1.description.$dirty && securitygroupForm_1.description.$invalid }">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="help-block" ng-show="securitygroupForm_1.description.$dirty && securitygroupForm_1.description.$invalid">
                                <i class="fa fa-warning"></i> {{msg.template_description_invalid}}
                            </div>
                        </div>
                        <!-- .col-sm-9 -->
                    </div>
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_1.securitygroup_publicInAccount.$dirty && securitygroupForm_1.securitygroup_publicInAccount.$invalid }">
                    ...
                    <div class="row btn-row">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a id="createSecurityGroup1" ng-disabled="securitygroupForm_1.$invalid" class="btn btn-success btn-block" ng-click="createSecurityGroup(selectedProvider)" role="button"><i
    ...
    <div class="panel panel-default" ng-show="selectedProvider == 'AWS'">
        <div class="panel-heading" role="tab" id="security-headingTwo">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#security-accordion" href="#security-collapseTwo" aria-expanded="false" aria-controls="security-collapseTwo" ng-click="selectSecurityGroupType()">
                    <i class="fa fa-sitemap fa-fw"/><span style="padding-left: 10px">{{msg.security_group_form_type2_title}}</span>
                </a>
            </h4>
        </div>
        <div id="security-collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="security-headingTwo">
            <div class="panel-body">
                <div class="form-group col-sm-12">
                    <i class="fa fa-info-circle" /><small>&nbsp;{{msg.security_group_form_type2_info}}</small>
                </div>
                <form class="form-horizontal" role="form" name="securitygroupForm_2">
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_2.sgname.$dirty && securitygroupForm_2.sgname.$invalid }">
                        <label class="col-sm-3 control-label" for="name">{{msg.name_label}}</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" ng-pattern="/^[a-z][-a-z0-9]*[a-z0-9]$/" name="sgname" ng-model="securitygroup.name" ng-minlength="5" ng-maxlength="100" required id="sgname" placeholder="{{msg.name_placeholder}}">
                            <div class="help-block" ng-show="securitygroupForm_2.sgname.$dirty && securitygroupForm_2.sgname.$invalid">
                                <i class="fa fa-warning"></i> {{msg.securitygroup_name_invalid}}
                            </div>
                        </div>
                    </div>
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_2.description.$dirty && securitygroupForm_2.description.$invalid }">
                        <label class="col-sm-3 control-label" for="description">{{msg.description_label}}</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="description" ng-model="securitygroup.description" ng-maxlength="1000" id="description" placeholder="{{msg.template_form_description_placeholder}}">
                            <div class="help-block" ng-show="securitygroupForm_2.description.$dirty && securitygroupForm_2.description.$invalid">
                                <i class="fa fa-warning"></i> {{msg.template_description_invalid}}
                            </div>
                        </div>
                        <!-- .col-sm-9 -->
                    ...
                    <div class="form-group" ng-class="{ 'has-error': securitygroupForm_2.securitygroup_publicInAccount.$dirty && securitygroupForm_2.securitygroup_publicInAccount.$invalid }">
                        <label class="col-sm-3 control-label" for="securitygroup_publicInAccount">{{msg.public_in_account_label}}</label>
                        <div class="col-sm-9">
                            <input type="checkbox" name="securitygroup_publicInAccount" id="securitygroup_publicInAccount" ng-model="securitygroup.public">
                        </div>
                    ...
                    <div class="row btn-row">
                        <div class="col-sm-9 col-sm-offset-3">
                            <a id="createSecurityGroup2" ng-disabled="securitygroupForm_2.$invalid" class="btn btn-success btn-block" ng-click="createSecurityGroup(selectedProvider)" role="button"><i
                                    class="fa fa-plus fa-fw"></i> {{msg.securitygroup_form_create}}</a>
                        </div>
                    </div>
                </form>
