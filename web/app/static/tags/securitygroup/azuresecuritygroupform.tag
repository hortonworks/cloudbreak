...
<div class="panel-group" id="azure-security-accordion" role="tablist" aria-multiselectable="true">
	<div class="panel panel-default">
		<div class="panel-heading" role="tab" id="azure-security-headingOne">
            <h4 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#azure-security-accordion" href="#azure-security-collapseOne" aria-expanded="true" aria-controls="azure-security-collapseOne" ng-click="selectSecurityGroupType1()">
                <i class="fa fa-sitemap fa-fw"/><span style="padding-left: 10px">{{msg.security_group_form_type1_title}}</span>
                </a>
            </h4>
    	</div>
    	<div id="azure-security-collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="azure-security-headingOne">
    		<div class="panel-body">
    			<div class="form-group col-sm-12">
                    <i class="fa fa-info-circle" /><small>&nbsp;{{msg.security_group_azure_form_type1_info}}</small>
                </div>
                <form class="form-horizontal" role="form" name="azuresecuritygroupForm_1">
					<div class="form-group" ng-class="{ 'has-error': azuresecuritygroupForm_1.sgname.$dirty && azuresecuritygroupForm_1.sgname.$invalid }">
		        		...
		        		<div class="col-sm-9">
				            ...
				            <div class="help-block" ng-show="azuresecuritygroupForm_1.sgname.$dirty && azuresecuritygroupForm_1.sgname.$invalid">
				                <i class="fa fa-warning"></i> {{msg.securitygroup_name_invalid}}
				            </div>
				        </div>
		    		</div>
				    <div class="form-group" ng-class="{ 'has-error': azuresecuritygroupForm_1.description.$dirty && azuresecuritygroupForm_1.description.$invalid }">
				        ...
				        <div class="col-sm-9">
				            ...
				            <div class="help-block" ng-show="azuresecuritygroupForm_1.description.$dirty && azuresecuritygroupForm_1.description.$invalid">
				                <i class="fa fa-warning"></i> {{msg.template_description_invalid}}
				            </div>
				        </div>
				        <!-- .col-sm-9 -->
				    </div>
				    <div class="form-group" ng-class="{ 'has-error': azuresecuritygroupForm_1.securitygroup_publicInAccount.$dirty && azuresecuritygroupForm_1.securitygroup_publicInAccount.$invalid }">
				    ...
				    <div class="row btn-row">
				        <div class="col-sm-9 col-sm-offset-3">
				            <a id="createSecurityGroup" ng-disabled="azuresecuritygroupForm_1.$invalid" class="btn btn-success btn-block" ng-click="createAzureSecurityGroup()" role="button"><i
