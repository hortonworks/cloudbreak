<div class="form-group" ng-show="activeCredential.cloudPlatform == 'AZURE' || activeCredential.cloudPlatform == 'GCP'">
    ...
    <div class="col-sm-8">
        <select class="form-control" id="selectFileSystem" ng-model="cluster.fileSystem.type">
            ...
            <option value="DASH" ng-if="activeCredential.cloudPlatform == 'AZURE'">{{msg.filesystem_dash_label}}</option>
...
<div class="form-group" ng-class="{ 'has-error': clusterCreationForm.armaccountname.$dirty && clusterCreationForm.armaccountname.$invalid }" ng-show="(activeCredential.cloudPlatform == 'AZURE') && cluster.fileSystem.type == 'DASH'">
...
<div class="form-group" ng-show="(activeCredential.cloudPlatform == 'AZURE') && cluster.fileSystem.type == 'DASH'" ng-class="{ 'has-error': clusterCreationForm.armaccountkey.$dirty && clusterCreationForm.armaccountkey.$invalid }">
