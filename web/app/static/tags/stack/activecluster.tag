                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div ng-if="activeCluster.cluster.ambariServerIp != null">
                                        <a target="_blank" class="form-control-static review-a" href="{{activeCluster.cluster.ambariServerUrl}}">{{activeCluster.cluster.ambariServerUrl}}</a>
                                    </div>
                                    <div ng-if="activeCluster.cluster.ambariServerIp == null">
                                            ...
                                            <form name="ambariStackDetailsreinstallpane">
                                                <div class="form-group" role="form" name="$parent.ambariStackDetailsreinstallpane">
                                                    <div class="form-group" name="ambari_stack1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="string" name="ambari_stack" class="form-control" ng-model="reinstallClusterObject.ambariStackDetails.stack" id="ambari_stack" placeholder="{{msg.cluster_form_hdp_repo_stack_placeholder}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" name="ambari_version1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="string" name="ambari_version" class="form-control" ng-model="reinstallClusterObject.ambariStackDetails.version" id="ambari_version" placeholder="{{msg.cluster_form_hdp_repo_version_placeholder}}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group" name="ambari_stackBaseURL1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="string" name="ambari_stackBaseURL" class="form-control" ng-model="reinstallClusterObject.ambariStackDetails.stackBaseURL" id="ambari_stackBaseURL" placeholder="{{msg.cluster_form_hdp_repo_baseurl_placeholder}}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group" name="ambari_utilsRepoId1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="string" name="ambari_utilsRepoId" class="form-control" ng-model="reinstallClusterObject.ambariStackDetails.utilsRepoId" id="ambari_utilsRepoId" placeholder="{{msg.cluster_form_hdp_repo_utils_repoid_placeholder}}">
                                                    ...
                                                    <div class="form-group" name="ambari_utilsBaseURL1">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="string" name="ambari_utilsBaseURL" class="form-control" ng-model="reinstallClusterObject.ambariStackDetails.utilsBaseURL" id="ambari_utilsBaseURL" placeholder="{{msg.cluster_form_hdp_repo_utils_baseurl_placeholder}}">
                                                        </div>
                                                    </div>
