...
: ${SERVICE_SPECIFIC_CERT_DIR:=/remote-environment/certs}
...
eval "(java $REMOTE_ENVIRONMENT_JAVA_OPTS -jar /environment.jar) & JAVAPID=\$!; trap \"kill \$JAVAPID; wait \$JAVAPID\" SIGINT SIGTERM; wait \$JAVAPID"
