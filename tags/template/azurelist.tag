<form class="form-horizontal" role="document"><!-- role: 'document' - non-editable "form" -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <p id="vmType" class="form-control-static">{{getAzureVmTypeName(template.parameters.vmType)}}</p>
        </div>
        <!-- .col-sm-9 -->
    </div>
    <!-- .form-group -->
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <p id="location" class="form-control-static">{{getAzureRegionName(template.parameters.location)}}</p>
        </div>
        <!-- .col-sm-9 -->
    </div>
    <div class="form-group">
