...
@Component
public class CDPFreeIpaLogger implements CDPTelemetryEventLogger<CDPFreeIpaStructuredFlowEvent> {
    ...
    @Override
    public void log(CDPFreeIpaStructuredFlowEvent cdpStructuredFlowEvent) {
