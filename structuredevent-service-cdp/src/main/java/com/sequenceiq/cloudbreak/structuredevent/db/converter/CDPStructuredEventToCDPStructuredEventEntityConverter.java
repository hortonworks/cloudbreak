...
@Component
public class CDPStructuredEventToCDPStructuredEventEntityConverter extends AbstractConversionServiceAwareConverter<StructuredEvent, StructuredEventEntity> {
