...
public class DockerContainersGetStub extends RestitoStub {

    public static final String PATH = "/containers/.*/json";

    @Override
    public Condition getCondition() {
        return Condition.composite(Condition.method(Method.GET), Condition.matchesUri(Pattern.compile(DOCKER_API_ROOT + PATH)));
    }
