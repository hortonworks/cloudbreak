package com.sequenceiq.it.cloudbreak.newway.dto.clusterdefinition;
...
@Prototype
public class ClusterDefinitionTestDto extends AbstractCloudbreakTestDto<ClusterDefinitionV4Request, ClusterDefinitionV4Response, ClusterDefinitionTestDto> {
