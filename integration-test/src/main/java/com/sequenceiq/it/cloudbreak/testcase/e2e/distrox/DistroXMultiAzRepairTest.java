...
public class DistroXMultiAzRepairTest extends PreconditionSdxE2ETest {

    private static final Logger LOGGER = LoggerFactory.getLogger(DistroXMultiAzRepairTest.class);
    ...
    public void testDistroXMultiAzProvisionAndReapir(TestContext testContext, ITestContext iTestContext) {
