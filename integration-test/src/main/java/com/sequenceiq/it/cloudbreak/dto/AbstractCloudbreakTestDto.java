...
public abstract class AbstractCloudbreakTestDto<R, S, T extends CloudbreakTestDto> extends Entity implements CloudbreakTestDto {
    ...
    public T then(Assertion<T> assertion) {
        return then(assertion, emptyRunningParameter());
    }

    public T then(Assertion<T> assertion, RunningParameter runningParameter) {
        return testContext.then((T) this, assertion, runningParameter);
    }

    public T then(List<Assertion<T>> assertions) {
    ...
    public T then(List<Assertion<T>> assertions, List<RunningParameter> runningParameters) {
