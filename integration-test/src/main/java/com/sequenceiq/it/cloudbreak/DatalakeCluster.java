...
import com.sequenceiq.it.cloudbreak.v4.DatalakeClusterV4Action;
...
public class DatalakeCluster extends AbstractCloudbreakTestDto<StackV4Request, StackV4Response, DatalakeCluster> {
    ...
    public static DatalakeCluster isCreatedWithName(String name) {
        ...
        datalake.setCreationStrategy((testContext, entity) -> DatalakeClusterV4Action.get(testContext, entity, name));
        return datalake;
    }
