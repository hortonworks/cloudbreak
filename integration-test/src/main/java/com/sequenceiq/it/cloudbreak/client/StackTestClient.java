...
import com.sequenceiq.it.cloudbreak.action.v4.stack.StackSkuMigrationAction;
...
public class StackTestClient {
    ...
    public Action<StackTestDto, CloudbreakClient> skuMigration() {
        return new StackSkuMigrationAction();
    }
