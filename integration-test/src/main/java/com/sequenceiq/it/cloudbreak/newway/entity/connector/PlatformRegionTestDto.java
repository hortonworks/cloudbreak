package com.sequenceiq.it.cloudbreak.newway.entity.connector;
...
@Prototype
public class PlatformRegionTestDto extends AbstractCloudbreakEntity<Object, RegionV4Response, PlatformRegionTestDto> {
