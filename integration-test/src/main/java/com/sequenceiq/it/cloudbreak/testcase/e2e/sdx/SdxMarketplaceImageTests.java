...
public class SdxMarketplaceImageTests extends PreconditionSdxE2ETest {
    private static final Logger LOGGER = LoggerFactory.getLogger(SdxMarketplaceImageTests.class);
    ...
    @Description(
            ...
            when = "a valid SDX create request is sent (latest Marketplace Image)",
            then = "SDX should be available AND deletable"
    )
    public void testSDXWithMarketplaceImageCanBeCreatedSuccessfully(TestContext testContext) {
        ...
        testContext
                ...
                .withUrl("https://gist.githubusercontent.com/daszabo/6b53c1a413d9b6cb847b9ad786e7bbf5/raw/0edb66302b7f485527b3bc03fdff1d68695d354c/" +
                        "v3-marketplace-image-catalog.json")
