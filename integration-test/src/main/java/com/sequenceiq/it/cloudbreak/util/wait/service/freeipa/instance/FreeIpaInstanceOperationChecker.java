...
public class FreeIpaInstanceOperationChecker<T extends FreeIpaInstanceWaitObject> extends ExceptionChecker<T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaInstanceOperationChecker.class);
