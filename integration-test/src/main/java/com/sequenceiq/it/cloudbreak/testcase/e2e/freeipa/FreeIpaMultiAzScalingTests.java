...
public class FreeIpaMultiAzScalingTests extends AbstractFreeipaE2ETest {

    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaMultiAzScalingTests.class);
