...
public class SdxTestClient {
    ...
    public Action<SdxInternalTestDto, SdxClient> repairInternalByNodeIds(String... ids) {
        return new SdxRepairInternalByNodeIdsAction(ids);
    }
    ...
    public Action<SdxTestDto, SdxClient> updatePublicDnsEntries() {
        return new SdxUpdatePublicDnsEntriesAction();
    }
