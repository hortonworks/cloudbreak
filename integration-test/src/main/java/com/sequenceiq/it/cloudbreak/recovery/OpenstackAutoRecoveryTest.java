...
public class OpenstackAutoRecoveryTest extends AbstractCloudbreakIntegrationTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.sequenceiq.it.cloudbreak.recovery.OpenstackAutoRecoveryTest.class);
    ...
    @Test
    @Parameters({ "hostGroup", "removedInstanceCount", "tenantName", "userName", "password", "endpoint" })
    public void testAutoRecovery(String hostGroup, @Optional("0") Integer removedInstanceCount, @Optional("") String tenantName, @Optional("") String userName,
