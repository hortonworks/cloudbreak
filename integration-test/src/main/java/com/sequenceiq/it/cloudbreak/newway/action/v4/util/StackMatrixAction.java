...
public class StackMatrixAction implements Action<StackMatrixTestDto> {
    ...
    @Override
    public StackMatrixTestDto action(TestContext testContext, StackMatrixTestDto entity, CloudbreakClient cloudbreakClient) throws Exception {
        String logInitMessage = "Obtaining stack matrix";
        LOGGER.info("{}", logInitMessage);
        entity.setResponse(cloudbreakClient.getCloudbreakClient().utilV4Endpoint().getStackMatrix());
