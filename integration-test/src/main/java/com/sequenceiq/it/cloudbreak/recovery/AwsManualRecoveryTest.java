...
public class AwsManualRecoveryTest extends AbstractCloudbreakIntegrationTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.sequenceiq.it.cloudbreak.recovery.AwsManualRecoveryTest.class);
    ...
    @Test
    @Parameters({ "hostGroup", "removeOnly", "removedInstanceCount", "region" })
    public void testManualRecovery(String hostGroup, @Optional("False") Boolean removeOnly,
            @Optional("0") Integer removedInstanceCount, @Optional Regions region) throws Exception {
