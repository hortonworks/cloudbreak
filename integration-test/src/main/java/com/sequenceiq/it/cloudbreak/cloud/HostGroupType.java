...
public enum HostGroupType {
    ...
    SOLR_SCALE_OUT("solr_scale_out", InstanceGroupType.CORE, InstanceCountParameter.SOLRHG_INSTANCE_COUNT.getName(), 0),
    STORAGE_SCALE_OUT("storage_scale_out", InstanceGroupType.CORE, InstanceCountParameter.STORAGEHG_INSTANCE_COUNT.getName(), 0),
    KAFKA_SCALE_OUT("kafka_scale_out", InstanceGroupType.CORE, InstanceCountParameter.KAFKAHG_INSTANCE_COUNT.getName(), 0),
    RAZ_SCALE_OUT("raz_scale_out", InstanceGroupType.CORE, InstanceCountParameter.RAZHG_INSTANCE_COUNT.getName(), 0),
    ATLAS_SCALE_OUT("atlas_scale_out", InstanceGroupType.CORE, InstanceCountParameter.ATLASHG_INSTANCE_COUNT.getName(), 0),
    HMS_SCALE_OUT("hms_scale_out", InstanceGroupType.CORE, InstanceCountParameter.HMSHG_INSTANCE_COUNT.getName(), 0);
