...
class MockClusterCreationWithSaltSuccessTest : AbstractMockIntegrationTest() {
    ...
    companion object {
        ...
        private val LOGGER = LoggerFactory.getLogger(MockClusterCreationWithSaltSuccessTest::class.java)
    }
}
