...
public class ClusterDefinitionTests extends CloudbreakTest {
    ...
    public void testCreateValidBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), VALID_BP_NAME + " blueprint request has been posted.");
    ...
    public void testCreateSpecialCharacterBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), SPECIAL_BP_NAME + " blueprint name request has been posted.");
        then(ClusterDefinition.assertThis(
    ...
    public void testCreateBlueprintWithIllegalSemicolonCharacterInNameShouldThrowBadRequestException() throws Exception {
        ...
        when(ClusterDefinition.post(), blueprintName + " blueprint name request has been posted.");
    }
    ...
    public void testCreateAgainBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), AGAIN_BP_NAME + " blueprint request has been posted.");
    }
    ...
    public void testCreateInvalidShortBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), "0 char blueprint name request has been posted.");
    }
    ...
    public void testCreateInvalidLongBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), invalidLongName + " blueprint name request has been posted.");
    }
    ...
    public void testCreateLongDescriptionBlueprint() throws Exception {
        ...
        when(ClusterDefinition.post(), LONG_DC_BP_NAME + " blueprint description request has been posted.");
    }
    ...
    public void testCreateEmptyJSONBlueprintException() throws Exception {
        ...
        when(ClusterDefinition.post(), EMPTY_BP_NAME + " blueprint with no content request has been posted.");
    }
    ...
    public void testCreateEmptyFileBlueprintException() throws Exception {
        ...
        when(ClusterDefinition.post(), EMPTY_BP_NAME + " blueprint file with no content on URL request has been posted.");
    }
    ...
    public void testCreateInvalidURLBlueprintException() throws Exception {
        ...
        when(ClusterDefinition.post(), INVALIDURL_BP_NAME + " blueprint with invalid URL request has been posted.");
    }
    ...
    public void testDeleteValidBlueprint() throws Exception {
        ...
        when(ClusterDefinition.delete(), DELETE_BP_NAME + " blueprint delete request has been posted.");
        then(ClusterDefinition.assertThis(
