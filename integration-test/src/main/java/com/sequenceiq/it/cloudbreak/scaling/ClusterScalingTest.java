...
public class ClusterScalingTest extends AbstractCloudbreakIntegrationTest {
    ...
    public void testClusterScaling(@Optional("slave_1") String instanceGroup, int scalingAdjustment) throws Exception {
        ...
        int expectedNodeCount = ScalingUtil.getNodeCountAmbari(stackEndpoint, ambariPort, stackId, ambariUser, ambariPassword, itContext) + scalingAdjustment;
        ...
        // THEN
        ScalingUtil.checkClusterScaled(stackEndpoint, ambariPort, stackId, ambariUser, ambariPassword, expectedNodeCount, itContext);
    }
}
