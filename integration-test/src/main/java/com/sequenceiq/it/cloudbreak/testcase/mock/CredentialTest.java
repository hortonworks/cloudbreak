...
public class CredentialTest extends AbstractIntegrationTest {
    ...
    public void testCreateTwice(MockedTestContext testContext) {
        ...
        testContext
                ...
                .then(CredentialTestAssertion.listContains(credentialName, 1))
                .withName(credentialName)
                .when(credentialTestClient.createV4(), RunningParameter.key(BAD_REQUEST_KEY))
    ...
    public void testCreateCredentialWithInvalidAttribute(
        ...
        testContext
                .given(CredentialTestDto.class)
                .withName(credentialName)
                .when(credentialTestClient.createV4(), RunningParameter.key(requestKey))
                .expect(BadRequestException.class, RunningParameter.expectedMessage(expectedExceptionMessage).withKey(requestKey))
                .validate();
    }
