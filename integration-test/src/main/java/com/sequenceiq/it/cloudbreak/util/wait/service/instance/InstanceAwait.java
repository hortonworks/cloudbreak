...
public class InstanceAwait {
    ...
    public <E extends Enum<E>> CloudbreakTestDto await(CloudbreakTestDto entity, Map<String, E> desiredStatuses, TestContext testContext,
        ...
        try {
            ...
            MicroserviceClient client = testContext.getMicroserviceClient(entity.getClass(), testContext.getWho(runningParameter).getAccessKey());
