...
public class CustomConfigurationsListAction implements RetryableAction<CustomConfigurationsTestDto, CloudbreakClient> {
    ...
    public CustomConfigurationsTestDto action(TestContext testContext, CustomConfigurationsTestDto testDto, CloudbreakClient client) throws Exception {
        ...
        testDto.setCustomConfigsResponses(client.getDefaultClient().customConfigurationsV4Endpoint().list());
