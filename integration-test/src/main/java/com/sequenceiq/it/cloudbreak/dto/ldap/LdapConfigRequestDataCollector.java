...
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.ADMIN_GROUP;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.BIND_DN;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.BIND_PASSWORD;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.DIRECTORY_TYPE;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.GROUP_MEMBER_ATTRIBUTE;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.GROUP_NAME_ATTRIBUTE;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.GROUP_OBJECT_CLASS;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.GROUP_SEARCH_BASE;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.LDAP_CONFIG_NAME;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.LDAP_DOMAIN;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.SERVER_HOST;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.SERVER_PORT;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.SERVER_PROTOCOL;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.USER_DN_PATTERN;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.USER_NAME_ATTRIBUTE;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.USER_OBJECT_CLASS;
import static com.sequenceiq.it.cloudbreak.cloud.RequiredInputParameters.Ldap.USER_SEARCH_BASE;
