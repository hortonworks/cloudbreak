...
public class FreeIpaInstanceTerminationChecker<T extends FreeIpaInstanceWaitObject> extends ExceptionChecker<T> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaInstanceTerminationChecker.class);
