...
public class AzureRmUseAnExistingSubnetInAnExistingVpcNetworkTest extends AbstractCloudbreakIntegrationTest {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(AzureRmUseAnExistingSubnetInAnExistingVpcNetworkTest.class);
