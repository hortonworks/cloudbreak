...
public class DistroXOSUpgradeTests extends AbstractE2ETest {
    ...
    @Ignore("This test case should be re-enabled in case of CB-14877 has been resolved at MOW-Dev")
    @Test(dataProvider = TEST_CONTEXT, description = "We need to wait the CB-14877 to be resolved")
    @Description(
