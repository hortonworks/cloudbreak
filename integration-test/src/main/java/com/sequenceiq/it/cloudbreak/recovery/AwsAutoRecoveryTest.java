...
public class AwsAutoRecoveryTest extends AbstractCloudbreakIntegrationTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(com.sequenceiq.it.cloudbreak.recovery.AwsAutoRecoveryTest.class);
    ...
    @Test
    @Parameters({ "hostGroup", "removedInstanceCount", "region" })
    public void testManualRecovery(String hostGroup, @Optional("0") Integer removedInstanceCount, @Optional Regions region) throws Exception {
        ...
        RecoveryUtil.deleteAWSInstance(region, RecoveryUtil.getInstanceId(stackResponse, hostGroup));
