...
public class FreeIpaMonitoringStatusesAssertions implements Assertion<FreeIpaRemoteTestDto, FreeIpaClient> {

    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaMonitoringStatusesAssertions.class);

    private final List<String> acceptableNokNames;

    public FreeIpaMonitoringStatusesAssertions(List<String> acceptableNokNames) {
        this.acceptableNokNames = acceptableNokNames;
    }

    @Override
    public FreeIpaRemoteTestDto doAssertion(TestContext testContext, FreeIpaRemoteTestDto freeIpaRemoteTestDto, FreeIpaClient freeIpaClient)
            throws Exception {
