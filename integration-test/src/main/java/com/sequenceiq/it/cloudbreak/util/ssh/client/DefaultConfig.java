 ...
 * <p/>
 * <ul>
 * <li>{@link ConfigImpl#setKeyExchangeFactories Key exchange}: {@link net.schmizz.sshj.transport.kex.DHG14}*, {@link net.schmizz.sshj.transport.kex.DHG1}</li>
 * <li>{@link ConfigImpl#setCipherFactories Ciphers}: {@link BlockCiphers}, {@link StreamCiphers} [1]</li>
 * <li>{@link ConfigImpl#setMACFactories MAC}: {@link net.schmizz.sshj.transport.mac.HMACSHA1}, {@link net.schmizz.sshj.transport.mac.HMACSHA196},
 * {@link net.schmizz.sshj.transport.mac.HMACMD5}, {@link net.schmizz.sshj.transport.mac.HMACMD596}</li>
 * <li>{@link ConfigImpl#setCompressionFactories Compression}: {@link NoneCompression}</li>
 * <li>{@link ConfigImpl#setKeyAlgorithms KeyAlgorithm}: {@link net.schmizz.sshj.signature.SignatureRSA}, {@link net.schmizz.sshj.signature.SignatureDSA}</li>
 * <li>{@link ConfigImpl#setRandomFactory BC}: {@link net.schmizz.sshj.transport.random.BouncyCastleRandom}* or {@link JCERandom}</li>
 * <li>{@link ConfigImpl#setRandomFactory BCFIPS}: {@link net.schmizz.sshj.transport.random.BouncyCastleFipsRandom}* or {@link JCERandom}</li>
...
public class DefaultConfig
    ...
    private String readVersionFromProperties() {
        try {
            ...
            // '-' is a disallowed character, see RFC-4253#section-4.2
    ...
    protected void initCipherFactories() {
        ...
        while (factories.hasNext()) {
            ...
            try {
                ...
                log.info("Cipher [{}] disabled: {}", factory.getName(), e.getCause() == null ? "unknown" : e.getCause().getMessage(), e);
                factories.remove();
            }
        }
