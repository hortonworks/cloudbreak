...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-cloudbreak:/integcb/docker-containers/docker-cloudbreak \
 busybox /bin/sh -c "sed -i '/cloudbreak[.]jar/c\ADD cloudbreak.jar /' /integcb/docker-containers/docker-cloudbreak/Dockerfile"
echo -e "\n\033[1;96m--- Build dev cloudbreak test image\033[0m\n"
docker build -t hortonworks/cloudbreak:dev ./integcb/docker-containers/docker-cloudbreak
...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-autoscale:/integcb/docker-containers/docker-autoscale \
 busybox /bin/sh -c "sed -i '/periscope[.]jar/c\ADD periscope.jar /' /integcb/docker-containers/docker-autoscale/Dockerfile"
echo -e "\n\033[1;96m--- Build dev autoscale test image\033[0m\n"
docker build -t hortonworks/cloudbreak-autoscale:dev ./integcb/docker-containers/docker-autoscale
...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-datalake:/integcb/docker-containers/docker-datalake \
 busybox /bin/sh -c "sed -i '/datalake[.]jar/c\ADD datalake.jar /' /integcb/docker-containers/docker-datalake/Dockerfile"
echo -e "\n\033[1;96m--- Build dev datalake test image\033[0m\n"
docker build -t hortonworks/cloudbreak-datalake:dev ./integcb/docker-containers/docker-datalake
...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-freeipa:/integcb/docker-containers/docker-freeipa \
 busybox /bin/sh -c "sed -i '/freeipa[.]jar/c\ADD freeipa.jar /' /integcb/docker-containers/docker-freeipa/Dockerfile"
echo -e "\n\033[1;96m--- Build dev freeipa test image\033[0m\n"
docker build -t hortonworks/cloudbreak-freeipa:dev ./integcb/docker-containers/docker-freeipa
...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-environment:/integcb/docker-containers/docker-environment \
 busybox /bin/sh -c "sed -i '/environment[.]jar/c\ADD environment.jar /' /integcb/docker-containers/docker-environment/Dockerfile"
echo -e "\n\033[1;96m--- Build dev environment test image\033[0m\n"
docker build -t hortonworks/cloudbreak-environment:dev ./integcb/docker-containers/docker-environment
...
docker run -d -v "$(pwd)"/integcb/docker-containers/docker-redbeams:/integcb/docker-containers/docker-redbeams \
 busybox /bin/sh -c "sed -i '/redbeams[.]jar/c\ADD redbeams.jar /' /integcb/docker-containers/docker-redbeams/Dockerfile"
echo -e "\n\033[1;96m--- Build dev redbeams test image\033[0m\n"
docker build -t hortonworks/cloudbreak-redbeams:dev ./integcb/docker-containers/docker-redbeams