...
public class VaultConfig extends AbstractVaultConfiguration {
    ...
    @Value("${periscope.vault.addr:}")
    private String address;

    @Value("${periscope.vault.port:}")
    private int port;

    @Value("${periscope.vault.root.token:}")
    private String rootToken;

    @Value("${periscope.vault.ssl.enabled:}")
    private Boolean sslEnabled;

    @Value("${periscope.vault.auth.type:}")
    private String authType;

    @Value("${periscope.vault.auth.kubernetes.mount.path:}")
    private String kubernetesMountPath;

    @Value("${periscope.vault.auth.kubernetes.login.role:}")
    private String kubernetesLoginRole;

    @Value("${periscope.vault.auth.kubernetes.service.account.token.path:}")
