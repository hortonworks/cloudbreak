package com.sequenceiq.periscope.logger;
...
public class UniqueIdDiscriminator implements Discriminator<ILoggingEvent> {
    ...
    public UniqueIdDiscriminator() {
        String nodeUuidEnvVar = System.getenv("PERISCOPE_INSTANCE_NODE_ID");
        String nodeUuidEnvProperty = System.getProperty("periscope.instance.node.id");
