...
@Component
public class AccountEntitlementCacheImpalaSchedule extends AbstractCacheDefinition {
    public static final String CACHE_NAME = "accountEntitlementCacheImpalaSchedule";
