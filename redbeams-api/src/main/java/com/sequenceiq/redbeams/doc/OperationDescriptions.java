...
public final class OperationDescriptions {
    ...
    public static final class DatabaseServerOpDescription {
        ...
        public static final String MODIFY_USER_DEFINED_TAGS = "updates the user defined tags of the database server";
        public static final String DELETE_USER_DEFINED_TAGS = "deletes user defined tags from the database server";
