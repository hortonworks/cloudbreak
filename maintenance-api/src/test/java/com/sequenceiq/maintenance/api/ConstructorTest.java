package com.sequenceiq.maintenance.api;
...
class ConstructorTest {
    ...
    void testIfConstructorIsImplementedOnRequestResponses() throws ClassNotFoundException {
        Reflections reflections = new Reflections(new ConfigurationBuilder().forPackage("com.sequenceiq.maintenance.api").setScanners(Scanners.SubTypes));
