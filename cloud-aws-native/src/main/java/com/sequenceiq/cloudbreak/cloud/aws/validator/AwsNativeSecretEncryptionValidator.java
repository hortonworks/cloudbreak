...
@Component
public class AwsNativeSecretEncryptionValidator extends CommonSecretEncryptionValidator {

    private static final Logger LOGGER = LoggerFactory.getLogger(AwsNativeSecretEncryptionValidator.class);
