...
public class AwsNativeCloudWatchService {
    ...
    public void addCloudWatchAlarmsForSystemFailures(List<CloudResource> instances, String regionName, AwsCredentialView credentialView) {
        instances.stream().forEach(instance -> {
            try {
                PutMetricAlarmRequest metricAlarmRequest = createPutMetricAlarmRequest(instance.getInstanceId(), regionName);
                LOGGER.debug("The following cloudwatch alarm – for instanceId: {} – has created and about to put it on AWS side: [{}]",
                        instance.getInstanceId(), metricAlarmRequest);
