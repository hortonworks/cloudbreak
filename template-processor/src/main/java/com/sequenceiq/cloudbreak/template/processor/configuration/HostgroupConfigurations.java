...
public class HostgroupConfigurations implements Iterable<HostgroupConfiguration> {
    ...
    public static HostgroupConfigurations fromConfigEntryMap(Map<HostgroupEntry, List<TemplateConfigurationEntry>> configuration) {
        HostgroupConfigurations result = new HostgroupConfigurations();
        for (Map.Entry<HostgroupEntry, List<TemplateConfigurationEntry>> conf : configuration.entrySet()) {
            Map<String, Map<String, String>> config = new HashMap<>();
            for (TemplateConfigurationEntry blueprintConfigurationEntry : conf.getValue()) {
