...
public class HdfConfigProvider {
    ...
    public HdfConfigs createHdfConfig(Set<HostGroup> hostgroups,  Map<String, List<InstanceMetaData>> groupInstances, String blueprintText) {
        TemplateTextProcessor blueprintTextProcessor = createTextProcessor(blueprintText);
    ...
    private TemplateTextProcessor createTextProcessor(String blueprintText) {
        return blueprintProcessorFactory.get(blueprintText);
    }

    private Optional<String> getProxyHostsParameter(Set<InstanceGroup> nifiIgs, TemplateTextProcessor blueprintTextProcessor, Map<String,
