...
public class TemplateTextProcessorTest {
    ...
    private final List<String[]> rangerConfigurations = Lists.newArrayList(
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "admin-properties", "properties", "db_host"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "admin-properties", "properties", "db_user"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "admin-properties", "properties", "db_password"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "admin-properties", "properties", "db_name"});

    private final List<String[]> hivaConfigurations = Lists.newArrayList(
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "hive-site", "javax.jdo.option.ConnectionURL"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "hive-site", "javax.jdo.option.ConnectionDriverName"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "hive-site", "javax.jdo.option.ConnectionUserName"},
            new String[]{TemplateTextProcessor.CONFIGURATIONS_NODE, "hive-site", "javax.jdo.option.ConnectionPassword"});

    private final TemplateProcessorFactory underTest = new TemplateProcessorFactory();
    ...
    public void testAddConfigEntriesAddsRootConfigurationsNodeIfMissing() throws Exception {
        ...
        List<TemplateConfigurationEntry> configurationEntries = new ArrayList<>();
    ...
    public void testAddConfigEntriesAddsConfigFileEntryIfMissing() throws Exception {
        ...
        List<TemplateConfigurationEntry> configurationEntries = new ArrayList<>();
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "fs.AbstractFileSystem.wasb.impl", "org.apache.hadoop.fs.azure.Wasb"));
        String result = underTest.get(testBlueprint).addConfigEntries(configurationEntries, true).asText();
    ...
    public void testAddConfigEntriesAddsConfigEntriesToCorrectConfigBlockWithCorrectValues() throws Exception {
        ...
        List<TemplateConfigurationEntry> configurationEntries = new ArrayList<>();
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "fs.AbstractFileSystem.wasb.impl", "org.apache.hadoop.fs.azure.Wasb"));
        configurationEntries.add(new TemplateConfigurationEntry("hdfs-site", "dfs.blocksize", "134217728"));
        String result = underTest.get(testBlueprint).addConfigEntries(configurationEntries, true).asText();
    ...
    public void testAddConfigEntriesAddsConfigEntriesToExistingConfigBlockAndKeepsExistingEntries() throws Exception {
        ...
        List<TemplateConfigurationEntry> configurationEntries = new ArrayList<>();
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "fs.AbstractFileSystem.wasb.impl", "org.apache.hadoop.fs.azure.Wasb"));
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "io.serializations", "org.apache.hadoop.io.serializer.WritableSerialization"));
        String result = underTest.get(testBlueprint).addConfigEntries(configurationEntries, true).asText();
    ...
    public void testAddConfigEntriesAddsConfigEntriesToExistingConfigPropertiesBlockAndUpdatesExistingEntries() throws Exception {
        ...
        List<TemplateConfigurationEntry> configurationEntries = new ArrayList<>();
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "fs.defaultFS", "wasb://cloudbreak@dduihoab6jt1jl.cloudapp.net"));
        configurationEntries.add(new TemplateConfigurationEntry("core-site", "io.serializations", "org.apache.hadoop.io.serializer.WritableSerialization"));
        String result = underTest.get(testBlueprint).addConfigEntries(configurationEntries, true).asText();
    ...
    public void addToBlueprint() throws Exception {
        ...
        configs.add(new TemplateConfigurationEntry("zeppelin-env", "shiro_ini_content", "changed"));
    ...
    public void addSettingsToBlueprintWhenNoSettingsBlock() throws Exception {
        ...
        List<TemplateConfigurationEntry> configs = new ArrayList<>();
        configs.add(new TemplateConfigurationEntry("recovery_settings", "recovery_enabled", "true"));
        configs.add(new TemplateConfigurationEntry("cluster-env", "recovery_enabled", "true"));
        configs.add(new TemplateConfigurationEntry("cluster-env", "recovery_type", "AUTO_START"));
