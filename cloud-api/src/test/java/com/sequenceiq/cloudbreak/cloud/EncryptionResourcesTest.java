...
class EncryptionResourcesTest {
    ...
    @Test
    void enableAutoRotationForEncryptionKeyTest() {
        EncryptionResources underTest = new DummyEncryptionResources();

        assertThrows(UnsupportedOperationException.class,
                () -> underTest.enableAutoRotationForEncryptionKey(EncryptionKeyEnableAutoRotationRequest.builder().build()));
    }

    @Test
    void rotateEncryptionKeyTest() {
        EncryptionResources underTest = new DummyEncryptionResources();

        assertThrows(UnsupportedOperationException.class, () -> underTest.rotateEncryptionKey(EncryptionKeyRotationRequest.builder().build()));
    }
