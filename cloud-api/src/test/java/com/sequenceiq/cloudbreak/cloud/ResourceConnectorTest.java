...
class ResourceConnectorTest {
    ...
    private static class ResourceConnectorImpl implements ResourceConnector {
        ...
        @Override
        public void validateUpgradeDatabaseServer(AuthenticatedContext authenticatedContext, DatabaseStack stack, PersistenceNotifier persistenceNotifier, TargetMajorVersion targetMajorVersion) throws Exception {
