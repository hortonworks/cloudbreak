...
public class PublicKeyUnregisterRequest extends RegionAndCredentialAwareRequestBase {
    ...
    public PublicKeyUnregisterRequest() {
    }

    public PublicKeyUnregisterRequest(Builder builder) {
    ...
    public boolean equals(Object o) {
        ...
        PublicKeyUnregisterRequest that = (PublicKeyUnregisterRequest) o;
    ...
    public static class Builder {
        ...
        public PublicKeyUnregisterRequest build() {
            Objects.requireNonNull(credential);
            Objects.requireNonNull(region);
            Objects.requireNonNull(cloudPlatform);
            Objects.requireNonNull(publicKeyId);
            return new PublicKeyUnregisterRequest(this);
        }
    }
}
