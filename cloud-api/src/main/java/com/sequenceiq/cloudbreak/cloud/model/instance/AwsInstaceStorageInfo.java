...
public class AwsInstaceStorageInfo {
    ...
    @JsonCreator
    public AwsInstaceStorageInfo(@JsonProperty("instanceStorageSupport") boolean instanceStorageSupport,
