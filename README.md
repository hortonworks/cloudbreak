...
# use this as default CB_AZURE_IMAGE_URI="http://vmdepoteastus.blob.core.windows.net/linux-community-store/community-62091-a59dcdc1-d82d-4e76-9094-27b8c018a4a1-1.vhd
CB_AZURE_IMAGE_URI=

# Ambari default blueprint
# use this as default: CB_BLUEPRINT_DEFAULTS='lambda-architecture,multi-node-hdfs-yarn,single-node-hdfs-yarn'
...
ngrok 8080
```
_Note: In the terminal window you'll find displayed a value - this should be set as the CB_HOST_ADDR environment variable
