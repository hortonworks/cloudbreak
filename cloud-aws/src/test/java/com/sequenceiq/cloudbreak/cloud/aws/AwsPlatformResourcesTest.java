...
public class AwsPlatformResourcesTest {
    ...
    public void setUp() {
        ...
        when(awsDefaultZoneProvider.getDefaultZone(any(CloudCredential.class)))
                .thenReturn(REGION_NAME);
        when(awsClient.createAccess(any(CloudCredential.class)))
                .thenReturn(amazonEC2Client);
        when(awsClient.createAccess(any(AwsCredentialView.class), any()))
                .thenReturn(amazonEC2Client);
        when(amazonEC2Client.describeRegions(any(DescribeRegionsRequest.class)))
                .thenReturn(describeRegionsResult);
        ...
        when(describeRegionsResult.getRegions())
