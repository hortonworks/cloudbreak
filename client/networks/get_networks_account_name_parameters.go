...
// NewGetNetworksAccountNameParams creates a new GetNetworksAccountNameParams object
// with the default values initialized.
func NewGetNetworksAccountNameParams() *GetNetworksAccountNameParams {
	var ()
	return &GetNetworksAccountNameParams{}
}

/*GetNetworksAccountNameParams contains all the parameters to send to the API endpoint
for the get networks account name operation typically these are written to a http.Request
*/
