...
func (o *GetRdsconfigsIDOK) Error() string {
	return fmt.Sprintf("[GET /rdsconfigs/{id}][%d] getRdsconfigsIdOK  %+v", 200, o.Payload)
}

func (o *GetRdsconfigsIDOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
