...
func (o *PostRdsconfigsUserReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPostRdsconfigsUserOK()
...
func (o *PostRdsconfigsUserOK) Error() string {
	return fmt.Sprintf("[POST /rdsconfigs/user][%d] postRdsconfigsUserOK  %+v", 200, o.Payload)
}

func (o *PostRdsconfigsUserOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
