...
func (o *PostStacksValidateReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	default:
		result := NewPostStacksValidateDefault(response.Code())
...
func NewPostStacksValidateDefault(code int) *PostStacksValidateDefault {
	return &PostStacksValidateDefault{
		_statusCode: code,
	}
}
...
func (o *PostStacksValidateDefault) Error() string {
	return fmt.Sprintf("[POST /stacks/validate][%d] PostStacksValidate default ", o._statusCode)
}

func (o *PostStacksValidateDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
