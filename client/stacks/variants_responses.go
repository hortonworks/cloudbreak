...
func (o *VariantsOK) Error() string {
	return fmt.Sprintf("[GET /stacks/platformVariants][%d] variantsOK  %+v", 200, o.Payload)
}

func (o *VariantsOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
