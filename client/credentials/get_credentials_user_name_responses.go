...
func (o *GetCredentialsUserNameReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCredentialsUserNameOK()
...
func NewGetCredentialsUserNameOK() *GetCredentialsUserNameOK {
	return &GetCredentialsUserNameOK{}
}
...
func (o *GetCredentialsUserNameOK) Error() string {
	return fmt.Sprintf("[GET /credentials/user/{name}][%d] getCredentialsUserNameOK  %+v", 200, o.Payload)
}

func (o *GetCredentialsUserNameOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
