...
func (o *DeleteDefault) Error() string {
	return fmt.Sprintf("[DELETE /blueprints/{id}][%d] delete default ", o._statusCode)
}

func (o *DeleteDefault) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
