...
func (o *TestAmbariDatabaseReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTestAmbariDatabaseOK()
...
func (o *TestAmbariDatabaseOK) Error() string {
	return fmt.Sprintf("[POST /util/ambari-database][%d] testAmbariDatabaseOK  %+v", 200, o.Payload)
}

func (o *TestAmbariDatabaseOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.AmbariDatabaseTestResult)
