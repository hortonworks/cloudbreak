...
// NewGetSssdIDParams creates a new GetSssdIDParams object
// with the default values initialized.
func NewGetSssdIDParams() *GetSssdIDParams {
	var ()
	return &GetSssdIDParams{}
}

/*GetSssdIDParams contains all the parameters to send to the API endpoint
for the get sssd ID operation typically these are written to a http.Request
*/
