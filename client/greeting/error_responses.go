...
func (o *ErrorReader) ReadResponse(response client.Response, consumer httpkit.Consumer) (interface{}, error) {
...
func (o *ErrorOK) Error() string {
	return fmt.Sprintf("[GET /greeting/error][%d] errorOK  %+v", 200, o.Payload)
}

func (o *ErrorOK) readResponse(response client.Response, consumer httpkit.Consumer, formats strfmt.Registry) error {
