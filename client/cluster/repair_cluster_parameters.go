...
type RepairClusterParams struct {
	...
	/*Body*/
	Body *models.ClusterRepairRequest
	/*ID*/
	ID int64
}

// WithBody adds the body to the repair cluster params
func (o *RepairClusterParams) WithBody(body *models.ClusterRepairRequest) *RepairClusterParams {
	o.Body = body
	return o
}
...
func (o *RepairClusterParams) WriteToRequest(r client.Request, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(models.ClusterRepairRequest)
	}
