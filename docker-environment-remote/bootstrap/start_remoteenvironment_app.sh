...
: ${SERVICE_SPECIFIC_CERT_DIR:=/remoteenvironmentservice/certs}
...
mkdir -p /tmp/remote-environment-log
...
REMOTE_ENVIRONMENT_JAVA_OPTS="${REMOTE_ENVIRONMENT_JAVA_OPTS} ${SECURITY_OPTS} ${JACOCO_AGENT_OPTIONS}"
