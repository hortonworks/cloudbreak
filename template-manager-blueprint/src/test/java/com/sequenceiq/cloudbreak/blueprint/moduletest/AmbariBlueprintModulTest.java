...
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectForHbaseConfigurationForTwoHosts;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenADConfiguredWithRdsRanger;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenADPresentedThenRangerAndHadoopADShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenAtlasAndADPresentedThenBothShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenAtlasAndLdapPresentedThenBothShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenAtlasPresentedShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenCustomPropertiesBlueprintConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenDefaultBlueprintConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenDlmBlueprintConfiguredAndAD;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenDlmBlueprintConfiguredAndLdap;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenDruidAndRdsPresentedThenRdsDruidShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenDuplicatedStorageLocationKey;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenHiveAndRdsPresentedThenRdsHiveMetastoreShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenHiveInteractivePresentedTheLlapShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenKerberosPresentedThenKerberosShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenLdapAndDruidRdsConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenLdapConfiguredWithRdsRanger;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenLdapPresentedThenRangerAndHadoopLdapShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenNifiAndHdfAndLdapPresentedThenHdfShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenNifiAndHdfPresentedThenHdfShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenNothingSpecialThere;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenRangerAndRdsPresentedThenRdsRangerShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenRdsConfiguredWithRdsOozie;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenSharedServiceConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhenWebhcatConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWhereExecutioTypeHasConfiguredAsContainer;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWithZepelinAndHdp25PresentedThenZeppelinShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.blueprintObjectWithZepelinAndHdp26PresentedThenZeppelinShouldConfigured;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.getFileName;
import static com.sequenceiq.cloudbreak.blueprint.moduletest.AmbariBlueprintModulTestModelProvider.getTestFile;
