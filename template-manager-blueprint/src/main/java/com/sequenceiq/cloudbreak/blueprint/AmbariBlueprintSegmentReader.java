...
public class AmbariBlueprintSegmentReader implements ResourceLoaderAware {
    ...
    @Value("${cb.blueprint.ambari.template.path:blueprints/configurations}")
    private String blueprintTemplatePath;

    @Value("${cb.blueprint.ambari.basic.path:blueprints/basics}")
    private String basicTemplatePath;

    @Value("${cb.blueprint.ambari.settings.path:blueprints/settings}")
    private String settingsTemplatePath;

    @Value("${cb.blueprint.ambari.security.kerberos_descriptor.path:blueprints/security/kerberos_descriptor}")
