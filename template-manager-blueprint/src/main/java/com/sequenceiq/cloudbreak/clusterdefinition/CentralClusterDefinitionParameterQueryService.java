...
@Component
public class CentralClusterDefinitionParameterQueryService {

    private static final Logger LOGGER = LoggerFactory.getLogger(CentralClusterDefinitionParameterQueryService.class);
    ...
    public Set<String> queryDatalakeParameters(String sourceTemplate) throws ClusterDefinitionProcessingException {
        ...
        try {
            ...
            String message = String.format("Unable to query cluster definition parameters from cluster definition which was: %s", sourceTemplate);
            LOGGER.warn(message);
