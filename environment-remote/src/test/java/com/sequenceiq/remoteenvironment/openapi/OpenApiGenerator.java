package com.sequenceiq.remoteenvironment.openapi;
...
import com.sequenceiq.remoteenvironment.config.EndpointConfig;
...
public class OpenApiGenerator {
    ...
    public void generateSwaggerJson() throws Exception {
        ...
        OpenAPI openAPI = new JaxrsOpenApiContextBuilder<>()
                ...
                .buildContext(true)
                .read();
        Path path = Paths.get("./build/openapi/remoteenvironment.json");
