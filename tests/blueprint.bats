...
@test "Check blueprint create from url" {
  run create-blueprint from-url --name test --url https://gist.githubusercontent.com/mhalmy/8309c7e4a4649fa85f38b260a38146af/raw/5c3534c7f1849ffea64a81d467d5eee801858ff7/test.bp
  echo $output
  [ $status = 0 ]
}
...
@test "Check blueprint delete" {
  CHECK_RESULT=$( delete-blueprint "EDW-ETL: Apache Hive 1.2.1, Apache Spark 2.1" )
  echo $CHECK_RESULT >&2
}