...
class EnvironmentCrossRealmTrustSetupActionsTest {
    ...
    void testCrossRealmTrustSetupInFreeIpaAction() throws Exception {
        Action<?, ?> action = configureAction(() -> actions.crossRealmTrustSetupInFreeIpaAction());
    ...
    void testFailedAction() throws Exception {
        EnvironmentCrossRealmTrustSetupFailedEvent payload = mock(EnvironmentCrossRealmTrustSetupFailedEvent.class);
