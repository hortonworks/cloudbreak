...
class EnvironmentCrossRealmTrustSetupFinishActionsTest {
    ...
    @Mock
    private EnvironmentCrossRealmTrustSetupFinishEvent actionPayload;

    @InjectMocks
    private EnvironmentCrossRealmTrustSetupFinishActions actions;
    ...
    void setUp() {
        ...
        actions = new EnvironmentCrossRealmTrustSetupFinishActions(environmentStatusUpdateService, metricService);
    ...
    void testCrossRealmTrustSetupValidationAction() {
        Action<?, ?> action = configureAction(() -> actions.crossRealmFinishValidationAction());
    ...
    void testFinishedAction() {
        ...
        verify(metricService).incrementMetricCounter(any(MetricType.class), any(EnvironmentDto.class));
    }
    ...
    void testFailedAction() throws Exception {
        ...
        verify(metricService).incrementMetricCounter(
                MetricType.ENV_TRUST_SETUP_FAILED,
                environmentDto,
                ex
        );
    }
