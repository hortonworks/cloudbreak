...
class EnvDeleteActionsTest {
    ...
    void setUp() {
        ...
        action = underTest.idbmmsDeleteAction();
    ...
    void idbmmsDeleteActionTestNoEnvironment() {
        ...
        verifyIdbmmsDeleteActionSuccessEvent();
    }
    ...
    void idbmmsDeleteActionTestHappyPath() {
        ...
        verify(environment).setStatus(EnvironmentStatus.IDBROKER_MAPPINGS_DELETE_IN_PROGRESS);
        verify(notificationService).send(ResourceEvent.ENVIRONMENT_IDBROKER_MAPPINGS_DELETION_STARTED, response, FLOW_TRIGGER_USER_CRN);
        verify(eventBus).notify(selectorArgumentCaptor.capture(), eventArgumentCaptor.capture());
        verify(reactorEventFactory).createEvent(headersArgumentCaptor.capture(), payloadArgumentCaptor.capture());
    ...
    private void verifyIdbmmsDeleteActionSuccessEvent() {
        assertThat(selectorArgumentCaptor.getValue()).isEqualTo(DELETE_IDBROKER_MAPPINGS_EVENT.selector());
