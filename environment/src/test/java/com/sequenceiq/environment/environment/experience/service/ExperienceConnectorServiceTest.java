...
class ExperienceConnectorServiceTest {
    ...
    private static final String EXPERIENCE_BASE_PATH = "https://127.0.0.1:1234/dwx/api/v2/environments/someenvcrn";

    private static final String ENVIRONMENT_CRN = "someEnvironmentCrn";

    @Mock
    private WebTargetClientProvider webTargetClientProvider;
    ...
    void setUp() {
        ...
        when(webTargetClientProvider.getClient()).thenReturn(mockClient);
    ...
    @Test
    void testExperienceConnectorServiceCouldNotBeInstantiatedWithNullWebTargetClientProvider() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new ExperienceConnectorService(COMPONENT_TO_REPLACE_IN_PATH, null));
    }

    @Test
    void testExperienceConnectorServiceCouldNotBeInstantiatedWithNullComponentToReplaceInPathValue() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new ExperienceConnectorService(null, webTargetClientProvider));
    }

    @Test
    void testExperienceConnectorServiceCouldNotBeInstantiatedWithEmptyComponentToReplaceInPathValue() {
        Assertions.assertThrows(IllegalArgumentException.class, () -> new ExperienceConnectorService("", webTargetClientProvider));
    }

    @Test
    void testWhenGetWorkspaceNamesConnectedToEnvCalledWithNullExperienceBasePathValueThenIllegalArgumentExceptionComes() {
        ExperienceConnectorService underTest = new ExperienceConnectorService(COMPONENT_TO_REPLACE_IN_PATH, webTargetClientProvider);
