...
class EnvironmentStatusTest {
    ...
    static Object[][] isDeleteInProgressDataProvider() {
        return new Object[][] {
                ...
                { "ENVIRONMENT_ENCRYPTION_RESOURCES_DELETED", EnvironmentStatus.ENVIRONMENT_ENCRYPTION_RESOURCES_DELETED, true},
        };
    }
    // CHECKSTYLE:ON
    // @formatter:on
    ...
    static Object[][] isSuccessfullyDeletedDataProvider() {
        return new Object[][] {
                ...
                { "ENVIRONMENT_ENCRYPTION_RESOURCES_INITIALIZED", EnvironmentStatus.ENVIRONMENT_ENCRYPTION_RESOURCES_INITIALIZED, false},
                { "ENVIRONMENT_ENCRYPTION_RESOURCES_DELETED", EnvironmentStatus.ENVIRONMENT_ENCRYPTION_RESOURCES_DELETED, false},
        };
    }
    // CHECKSTYLE:ON
    // @formatter:on
