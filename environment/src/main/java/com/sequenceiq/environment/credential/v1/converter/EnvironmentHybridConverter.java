...
public class EnvironmentHybridConverter {
    ...
    public AddCrossRealmTrustResponse convertToAddCrossRealmTrustResponse(FlowIdentifier source) {
        AddCrossRealmTrustResponse response = new AddCrossRealmTrustResponse();
        response.setFlowIdentifier(source);
        return response;
    }
