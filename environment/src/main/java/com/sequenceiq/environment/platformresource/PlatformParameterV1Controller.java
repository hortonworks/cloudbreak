...
public class PlatformParameterV1Controller implements PlatformResourceV1Endpoint {
    ...
    @Override
    public PlatformVmtypesV1Response getVmTypesByCredential(String credentialName, String region, String platformVariant,
    ...
    @Override
    public PlatformDisksV1Response getDisktypes() {
    ...
    @Override
    public PlatformNetworksV1Response getCloudNetworks(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformIpPoolsV1Response getIpPoolsCredentialId(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformGatewaysV1Response getGatewaysCredentialId(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformEncryptionKeysV1Response getEncryptionKeys(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformSecurityGroupsV1Response getSecurityGroups(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformSshKeysV1Response getCloudSshKeys(String credentialName, String region, String platformVariant, String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public PlatformAccessConfigsV1Response getAccessConfigs(String credentialName, String region, String platformVariant,
            String availabilityZone) {
        String accountId = getAccountId();
        PlatformResourceRequest request = platformParameterService.getPlatformResourceRequest(accountId, credentialName, region, platformVariant,
                availabilityZone);
    ...
    @Override
    public TagSpecificationsV1Response getTagSpecifications() {
