...
public class EnvironmentModificationService {
    ...
    public FlowIdentifier addCrossRealmSetup(String accountId, NameOrCrn nameOrCrn, AddCrossRealmTrustV2Request request) {
        Environment environment = getEnvironment(accountId, nameOrCrn);
        return environmentReactorFlowManager.triggerAddCrossRealmTrust(
                environment.getId(),
                environment.getAccountId(),
                environment.getName(),
                environment.getCreator(),
    ...
    public FlowIdentifier cancelCrossRealmSetup(String accountId, NameOrCrn nameOrCrn) {
        Environment environment = getEnvironment(accountId, nameOrCrn);
