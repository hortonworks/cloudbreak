...
public class EnvironmentResponseConverter {
    ...
    private EnvironmentNetworkResponse networkDtoToResponse(NetworkDto network, Tunnel tunnel, boolean isDetailedResponse) {
        return networkDtoToResponseConverter.convert(network, tunnel, isDetailedResponse);
    }
