...
abstract class AbstractEnvClustersDeleteAction<P extends ResourceCrnPayload>
        extends AbstractAction<EnvClustersDeleteState, EnvClustersDeleteStateSelectors, CommonContext, P> {

    private static final Logger LOGGER = LoggerFactory.getLogger(AbstractEnvClustersDeleteAction.class);
