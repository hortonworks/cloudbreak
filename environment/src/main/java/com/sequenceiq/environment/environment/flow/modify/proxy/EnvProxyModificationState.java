...
import com.sequenceiq.environment.environment.flow.modify.proxy.action.ProxyConfigModificationDatahubsStateAction;
import com.sequenceiq.environment.environment.flow.modify.proxy.action.ProxyConfigModificationDatalakeStateAction;
...
public enum EnvProxyModificationState implements FlowState {
    ...
    PROXY_CONFIG_MODIFICATION_DATALAKE_STATE(ProxyConfigModificationDatalakeStateAction.class),
    PROXY_CONFIG_MODIFICATION_DATAHUBS_STATE(ProxyConfigModificationDatahubsStateAction.class),
