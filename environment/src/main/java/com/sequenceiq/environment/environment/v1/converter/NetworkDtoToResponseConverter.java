...
public class NetworkDtoToResponseConverter {
    ...
    public EnvironmentNetworkResponse convert(NetworkDto network, Tunnel tunnel, boolean isDetailedResponse) {
        return EnvironmentNetworkResponse.EnvironmentNetworkResponseBuilder.anEnvironmentNetworkResponse()
                ...
                .withPreferedSubnetId(getPreferedSubnetId(network, tunnel, isDetailedResponse))
    ...
    public String getPreferedSubnetId(NetworkDto network, Tunnel tunnel, boolean isDetailedResponse) {
        return isDetailedResponse ? subnetIdProvider.provide(network, tunnel, network.getCloudPlatform()) : null;
    }
}
