...
import static com.sequenceiq.cloudbreak.event.ResourceEvent.ENVIRONMENT_PREREQUISITES_CREATE_FAILED;
import static com.sequenceiq.cloudbreak.event.ResourceEvent.ENVIRONMENT_PREREQUISITES_CREATE_STARTED;
...
public class EnvCreationActions {
    ...
    public EnvCreationActions(EnvironmentService environmentService, EventSenderService eventService, EnvironmentMetricService metricService, EnvironmentJobService environmentJobService) {
        ...
        return new AbstractEnvironmentCreationAction<>(EnvCreationEvent.class) {
            ...
            protected void doExecute(CommonContext context, EnvCreationEvent payload, Map<Object, Object> variables) {
                environmentService.findEnvironmentById(payload.getResourceId()).ifPresentOrElse(environment -> {
                    ...
                    environment = environmentService.save(environment);
                    EnvironmentDto environmentDto = environmentService.getEnvironmentDto(environment);
                    eventService.sendEventAndNotification(environmentDto, context.getFlowTriggerUserCrn(), ENVIRONMENT_PREREQUISITES_CREATE_STARTED);
                    ...
                    EnvCreationFailureEvent failureEvent = new EnvCreationFailureEvent(
                            ...
                            null,
                            payload.getResourceCrn());
                    eventService.sendEventAndNotificationForMissingEnv(payload, ENVIRONMENT_PREREQUISITES_CREATE_FAILED, context.getFlowTriggerUserCrn());
