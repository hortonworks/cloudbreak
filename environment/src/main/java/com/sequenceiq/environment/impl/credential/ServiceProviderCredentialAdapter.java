...
import com.sequenceiq.environment.impl.credential.converter.CredentialToCloudCredentialConverter;
import com.sequenceiq.environment.impl.credential.converter.CredentialToExtendedCloudCredentialConverter;
...
public class ServiceProviderCredentialAdapter {
    ...
    public Credential verify(Credential credential, Long workspaceId, String userId) {
        ...
        CloudContext cloudContext = new CloudContext(credential.getId(), credential.getName(), credential.getCloudPlatform(), userId, workspaceId);
    ...
    public Map<String, String> interactiveLogin(Credential credential, Long workspaceId, String userId) {
        CloudContext cloudContext = new CloudContext(credential.getId(), credential.getName(),
                credential.getCloudPlatform(), userId, workspaceId);
