...
public class AwsParameters extends BaseParameters {
    ...
    public String getEncryptionKeyArn() { return getIfNotNull(encryptionKeyArn, Secret::getRaw); }

    public String getEncryptionKeyArnSecret() { return getIfNotNull(encryptionKeyArn, Secret::getSecret); }

    public void setEncryptionKeyArn(String encryptionKeyArn) { this.encryptionKeyArn = new Secret(encryptionKeyArn); }
}
