...
public enum DatalakeSecretType implements SecretType {
    ...
    CM_MGMT_ADMIN_PASSWORD(List.of(CLOUDBREAK_ROTATE_POLLING), Set.of(SKIP_SALT_UPDATE)),
    ...
    CM_SERVICE_SHARED_DB(List.of(CLOUDBREAK_ROTATE_POLLING), MultiSecretType.CM_SERVICE_SHARED_DB),
    DEMO_SECRET(List.of(CLOUDBREAK_ROTATE_POLLING), DEMO_MULTI_SECRET, Set.of(SKIP_SALT_UPDATE, INTERNAL)),
