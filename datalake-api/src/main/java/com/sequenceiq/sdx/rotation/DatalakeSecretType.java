...
public enum DatalakeSecretType implements SecretType {
    ...
    DL_CM_SERVICE_SHARED_DB(List.of(CLOUDBREAK_ROTATE_POLLING), Set.of(MULTI_SECRET)),
    DH_CM_SERVICE_SHARED_DB(List.of(CLOUDBREAK_ROTATE_POLLING), Set.of(MULTI_SECRET)),
