...
public enum SdxClusterStatusResponse {
    ...
    DATALAKE_UPDATE_TRUSTED_REALM_IN_PROGRESS,
    ...
    DATALAKE_ENABLE_ENCRYPTION_PROFILE_IN_PROGRESS,
    DATALAKE_ENABLE_ENCRYPTION_PROFILE_FAILED,
    DATALAKE_SKU_MIGRATION_CHANGE_IN_PROGRESS,
    DATALAKE_SKU_MIGRATION_CHANGE_FAILED,
    DATALAKE_UPDATE_PUBLIC_DNS_ENTRIES_IN_PROGRESS,
    DATALAKE_UPDATE_PUBLIC_DNS_ENTRIES_FAILED,
    DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_IN_PROGRESS,
    DATALAKE_ZOOKEEPER_TO_KRAFT_MIGRATION_FAILED,
    DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_IN_PROGRESS,
    DATALAKE_ZOOKEEPER_TO_KRAFT_FINALIZE_FAILED,
    DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_IN_PROGRESS,
    DATALAKE_ZOOKEEPER_TO_KRAFT_ROLLBACK_FAILED,
    STALE;
