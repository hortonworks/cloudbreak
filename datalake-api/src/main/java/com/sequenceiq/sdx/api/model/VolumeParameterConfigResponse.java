...
public class VolumeParameterConfigResponse {
    ...
    public String toString() {
        return "VolumeParameterConfigResponse{" + "volumeParameterType='" + volumeParameterType + '\'' + ", minimumSize=" + minimumSize + ", maximumSize=" + maximumSize + ", minimumNumber=" + minimumNumber + ", maximumNumber=" + maximumNumber + '}';
    }
}
