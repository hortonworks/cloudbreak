...
public final class DiagnosticsOperationDescriptions {
    ...
    public static final String GET_CM_ROLES = "Returns a list of CM Roles that can be used for filtering the diagnostics results. " + "Roles are immutable based on the deployment details";
