...
public interface ProgressEndpoint {
    ...
    @Operation(summary = "Get last flow operation progress details for resource by resource crn", description = "Flow operations progress", operationId ="getSdxLastFlowLogProgressByResourceCrn")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = "List recent flow operations progress details for resource by resource crn", description = "Flow operations progress", operationId ="getSdxFlowLogsProgressByResourceCrn")
