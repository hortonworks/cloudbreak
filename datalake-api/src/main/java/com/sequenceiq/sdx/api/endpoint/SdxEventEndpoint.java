...
public interface SdxEventEndpoint {
    ...
    List<CDPStructuredEvent> getAuditEvents(@QueryParam("environmentCrn") @NotNull(message = "The 'environmentCrn' query parameter must be specified.") String environmentCrn, @QueryParam("types") List<StructuredEventType> types, @QueryParam("page") @DefaultValue("0") Integer page, @QueryParam("size") @DefaultValue("100") Integer size);
    ...
    Response getDatalakeEventsZip(@QueryParam("environmentCrn") @NotNull(message = "The 'environmentCrn' query parameter must be specified.") String environmentCrn, @QueryParam("types") List<StructuredEventType> types);
}
