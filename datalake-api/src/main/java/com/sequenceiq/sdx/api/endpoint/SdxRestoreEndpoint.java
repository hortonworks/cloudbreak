...
@Api(value = "/sdx/{name}", protocols = "http,https", consumes = MediaType.APPLICATION_JSON)
public interface SdxRestoreEndpoint {

    @POST
    @Path("restoreDatalake")
