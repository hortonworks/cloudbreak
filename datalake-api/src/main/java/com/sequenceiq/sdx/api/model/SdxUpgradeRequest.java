...
public class SdxUpgradeRequest {
    ...
    public String toString() {
        return "SdxUpgradeRequest{" + "imageId='" + imageId + '\'' + ", runtime='" + runtime + '\'' + ", lockComponents=" + lockComponents + ", dryRun=" + dryRun + ", skipBackup=" + skipBackup + ", replaceVms=" + replaceVms + ", skipDataHubValidation=" + skipDataHubValidation + '}';
    }
}
