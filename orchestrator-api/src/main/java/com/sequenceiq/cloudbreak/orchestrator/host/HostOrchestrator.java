...
public interface HostOrchestrator extends HostRecipeExecutor {
    ...
    void runService(List<GatewayConfig> allGatewayConfigs, Set<Node> allNodes, ExitCriteriaModel exitCriteriaModel) throws CloudbreakOrchestratorException;
    ...
    Map<String, String> runCommandOnAllHosts(GatewayConfig gateway, String command, RetryType retryType)
            throws CloudbreakOrchestratorFailedException;
    ...
    void switchFreeIpaMasterToPrimaryGateway(GatewayConfig primaryGateway, Set<Node> allNodes, ExitCriteriaModel exitCriteriaModel)
            throws CloudbreakOrchestratorFailedException;
    ...
    void resizeDisksOnNodes(List<GatewayConfig> allGateway, Set<Node> nodesWithDiskDataInTargetGroup, ExitCriteriaModel exitModel)
            throws CloudbreakOrchestratorFailedException;
