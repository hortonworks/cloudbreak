...
public interface HostOrchestrator extends HostRecipeExecutor {
    ...
    void backupDatabase(GatewayConfig primaryGateway, Set<String> target, SaltConfig saltConfig, ExitCriteriaModel exitModel, Boolean isLongTimeBackupEnabled)
            throws CloudbreakOrchestratorFailedException;

    void restoreDatabase(GatewayConfig primaryGateway, Set<String> target, SaltConfig saltConfig, ExitCriteriaModel exitModel, Boolean isLongTimeBackupEnabled)
            throws CloudbreakOrchestratorFailedException;
