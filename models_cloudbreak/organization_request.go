...
/* polymorph OrganizationRequest description false */

/* polymorph OrganizationRequest name false */
...
func (m *OrganizationRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *OrganizationRequest) validateName(formats strfmt.Registry) error {
