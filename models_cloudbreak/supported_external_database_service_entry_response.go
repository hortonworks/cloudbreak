...
func (m *SupportedExternalDatabaseServiceEntryResponse) validateDatabases(formats strfmt.Registry) error {
...
func (m *SupportedExternalDatabaseServiceEntryResponse) UnmarshalBinary(b []byte) error {
	var res SupportedExternalDatabaseServiceEntryResponse
