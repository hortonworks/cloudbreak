...
/*ClusterFullResponse cluster full response

swagger:model ClusterFullResponse
*/
...
// Validate validates this cluster full response
func (m *ClusterFullResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterFullResponse) validateBlueprintInputs(formats strfmt.Registry) error {
...
var clusterFullResponseTypeConfigStrategyPropEnum []interface{}

func (m *ClusterFullResponse) validateConfigStrategyEnum(path, location string, value string) error {
	if clusterFullResponseTypeConfigStrategyPropEnum == nil {
		var res []string
		...
		for _, v := range res {
			clusterFullResponseTypeConfigStrategyPropEnum = append(clusterFullResponseTypeConfigStrategyPropEnum, v)
		}
	}
	if err := validate.Enum(path, location, value, clusterFullResponseTypeConfigStrategyPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ClusterFullResponse) validateConfigStrategy(formats strfmt.Registry) error {
...
func (m *ClusterFullResponse) validateHostGroups(formats strfmt.Registry) error {
...
func (m *ClusterFullResponse) validateRdsConfigIds(formats strfmt.Registry) error {
...
func (m *ClusterFullResponse) validateRdsConfigs(formats strfmt.Registry) error {
...
func (m *ClusterFullResponse) validateServiceEndPoints(formats strfmt.Registry) error {
