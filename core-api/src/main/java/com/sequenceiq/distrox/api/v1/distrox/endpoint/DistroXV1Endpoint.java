...
public interface DistroXV1Endpoint {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "", nickname = "attachRecipesByCrn")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = "", nickname = "attachRecipesByName")
