...
public class DistroXOpDescription {
    ...
    public static final String VERTICAL_SCALE_BY_NAME = "vertical scales the stack by name";
    public static final String VERTICAL_SCALE_BY_CRN = "vertical scales the stack by crn";
