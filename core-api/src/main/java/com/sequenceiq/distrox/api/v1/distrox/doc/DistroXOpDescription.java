...
public class DistroXOpDescription {
    ...
    public static final String OPERATIONS_BY_SDX_INSTANCE_HEALTH = "Get list of operations which are allowed or not based on sdx instance health";
    ...
    public static final String GET_STATUS_BY_ENV_CRN_INTERNAL = "get stack statuses by environment crn (for internal user)";
