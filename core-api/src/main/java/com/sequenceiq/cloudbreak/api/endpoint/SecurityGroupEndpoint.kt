...
interface SecurityGroupEndpoint {
    ...
    fun postPrivate(@Valid securityGroupJson: SecurityGroupJson): IdJson
    ...
    fun postPublic(@Valid securityGroupJson: SecurityGroupJson): IdJson

    val privates: Set<SecurityGroupJson>

    val publics: Set<SecurityGroupJson>
    ...
    fun getPrivate(@PathParam(value = "name") name: String): SecurityGroupJson
    ...
    fun getPublic(@PathParam(value = "name") name: String): SecurityGroupJson
    ...
    operator fun get(@PathParam(value = "id") id: Long?): SecurityGroupJson
    ...
    @Path("account/{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = OperationDescriptions.SecurityGroupOpDescription.DELETE_PUBLIC_BY_NAME, produces = ContentType.JSON, notes = Notes.SECURITY_GROUP_NOTES)
    fun deletePublic(@PathParam(value = "name") name: String)

    @DELETE
    @Path("user/{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = OperationDescriptions.SecurityGroupOpDescription.DELETE_PRIVATE_BY_NAME, produces = ContentType.JSON, notes = Notes.SECURITY_GROUP_NOTES)
