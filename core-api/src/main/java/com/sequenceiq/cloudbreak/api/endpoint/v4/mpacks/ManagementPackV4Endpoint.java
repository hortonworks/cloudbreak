...
public interface ManagementPackV4Endpoint {
    ...
    @ApiOperation(value = ManagementPackOpDescription.LIST_BY_WORKSPACE, produces = MediaType.APPLICATION_JSON, notes = Notes.MANAGEMENT_PACK_NOTES,
    ...
    @Path("/{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ManagementPackOpDescription.GET_BY_NAME_IN_WORKSPACE, produces = MediaType.APPLICATION_JSON, notes = Notes.MANAGEMENT_PACK_NOTES,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ManagementPackOpDescription.CREATE_IN_WORKSPACE, produces = MediaType.APPLICATION_JSON, notes = Notes.MANAGEMENT_PACK_NOTES,
    ...
    @Path("/{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ManagementPackOpDescription.DELETE_BY_NAME_IN_WORKSPACE, produces = MediaType.APPLICATION_JSON, notes = Notes.MANAGEMENT_PACK_NOTES,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ManagementPackOpDescription.DELETE_MULTIPLE_BY_NAME_IN_WORKSPACE, produces = MediaType.APPLICATION_JSON,
            notes = Notes.MANAGEMENT_PACK_NOTES, nickname = "deleteManagementPacksInWorkspace")
