...
public interface UserProfileV4Endpoint {
    ...
    @GET
    @Path("/terminated_instances_preferences")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = OperationDescriptions.UserProfileOpDescription.GET_TERMINATED_CLUSTERS_PREFERENCES, produces = ContentType.JSON,
            notes = Notes.SHOW_INSTANCES_PREFERENCES, nickname = "getShowTerminatedClusterPreferences")
    ShowTerminatedClusterPreferencesV4Response getShowClusterPreferences();

    @PUT
    @Path("/terminated_instances_preferences")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = OperationDescriptions.UserProfileOpDescription.PUT_TERMINATED_CLUSTERS_PREFERENCES, produces = ContentType.JSON,
    ...
    @Path("/terminated_instances_preferences")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = OperationDescriptions.UserProfileOpDescription.DELETE_TERMINATED_INSTANCES_PREFERENCES, produces = ContentType.JSON,
