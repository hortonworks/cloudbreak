...
public class InstanceGroupV4Base extends ProviderParametersBase implements JsonEntity {
    ...
    @Schema(description = InstanceGroupModelDescription.INSTANCE_GROUP_TYPE, allowableValues = "CORE,GATEWAY")
    ...
    @Schema(description = HostGroupModelDescription.RECOVERY_MODE, allowableValues = "MANUAL,AUTO")
