...
public interface StackV3Endpoint {
    ...
    StackResponse putSyncInOrganization(@PathParam("organizationId") Long organizationId, @PathParam("name") String name);
    ...
    StackResponse putStopInOrganization(@PathParam("organizationId") Long organizationId, @PathParam("name") String name);
    ...
    StackResponse putStartInOrganization(@PathParam("organizationId") Long organizationId, @PathParam("name") String name);
    ...
    StackResponse putScalingInOrganization(@PathParam("organizationId") Long organizationId, @PathParam("name") String name,
    ...
    StackResponse repairClusterInOrganization(@PathParam("organizationId") Long organizationId, @PathParam("name") String name,
