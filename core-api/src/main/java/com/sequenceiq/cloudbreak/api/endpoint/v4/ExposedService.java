...
public enum ExposedService {
    ...
    SMM_UI("Streams Messaging Manager", "SMM-UI", "SMM-UI", "/smm-ui/", true, 9991, 9991, false, false),
    SMM_API("Streams Messaging Manager Rest", "SMM-API", "SMM-API", "/smm-api/", true, 8585, 8587, true, true),
    SCHEMA_REGISTRY("Schema Registry", "SCHEMA-REGISTRY", "SCHEMA-REGISTRY", "/schema-registry/", true, 7788, 7790, false, false),
