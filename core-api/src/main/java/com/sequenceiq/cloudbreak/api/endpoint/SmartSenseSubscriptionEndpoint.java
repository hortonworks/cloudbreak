...
@Path("/smartsensesubscriptions")
@Consumes(MediaType.APPLICATION_JSON)
@Api(value = "/smartsensesubscriptions", description = ControllerDescription.SMARTSENSE_SUBSCRIPTION_DESCRIPTION, protocols = "http,https")
