...
public interface AutoscaleV4Endpoint {
    ...
    @ApiOperation(value = StackOpDescription.PUT_BY_ID, produces = MediaType.APPLICATION_JSON, notes = Notes.STACK_NOTES, nickname = "putStackForAutoscale")
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = StackOpDescription.PUT_BY_ID, produces = MediaType.APPLICATION_JSON, notes = Notes.STACK_NOTES, nickname = "putClusterForAutoscale")
    void putCluster(@PathParam("crn") String crn, @PathParam("userId") String userId, @Valid UpdateClusterV4Request updateRequest);

    @POST
    @Path("ambari")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = StackOpDescription.GET_BY_AMBARI_ADDRESS, produces = MediaType.APPLICATION_JSON, notes = Notes.STACK_NOTES,
    ...
    @Path("stack/all")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = StackOpDescription.GET_ALL, produces = MediaType.APPLICATION_JSON, notes = Notes.STACK_NOTES, nickname = "getAllStackForAutoscale")
    AutoscaleStackV4Responses getAllForAutoscale();

    @POST
    @Path("/stack/crn/{crn}/cluster/failurereport")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ClusterOpDescription.FAILURE_REPORT, produces = MediaType.APPLICATION_JSON, notes = Notes.FAILURE_REPORT_NOTES,
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ClusterOpDescription.CHANGED_NODES_REPORT, produces = MediaType.APPLICATION_JSON, notes = Notes.CHANGED_NODES_REPORT_NOTES,
    ...
    @Path("/stack/crn/{crn}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = StackOpDescription.GET_BY_CRN, produces = MediaType.APPLICATION_JSON, notes = Notes.STACK_NOTES, nickname = "getStackForAutoscale")
