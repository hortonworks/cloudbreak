...
public class GatewayV4Request implements JsonEntity {
    ...
    @Schema(description = GatewayModelDescription.KNOX_GATEWAY_TYPE, allowableValues = "CENTRAL,INDIVIDUAL")
    private GatewayType gatewayType;

    @Schema(description = GatewayModelDescription.KNOX_SSO_TYPE, allowableValues = "SSO_PROVIDER,SSO_PROVIDER_FROM_UMS,NONE,PAM")
