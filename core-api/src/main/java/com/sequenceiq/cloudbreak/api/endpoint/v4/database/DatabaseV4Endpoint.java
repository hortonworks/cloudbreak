...
public interface DatabaseV4Endpoint {
    ...
    @ApiOperation(value = DatabaseOpDescription.LIST, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = DatabaseOpDescription.CREATE, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = DatabaseOpDescription.GET_BY_NAME, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = DatabaseOpDescription.DELETE_BY_NAME, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = DatabaseOpDescription.DELETE_MULTIPLE_BY_NAME, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
    ...
    @Path("{name}/request")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = DatabaseOpDescription.GET_REQUEST, produces = ContentType.JSON, notes = Notes.DATABASE_NOTES,
