...
import static com.sequenceiq.cloudbreak.doc.OperationDescriptions.StackOpDescription.BACKUP_DATABASE;
...
public interface StackV4Endpoint {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = BACKUP_DATABASE, nickname = "backupClusterDatabaseByName")
    FlowIdentifier backupClusterDatabaseByName(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
