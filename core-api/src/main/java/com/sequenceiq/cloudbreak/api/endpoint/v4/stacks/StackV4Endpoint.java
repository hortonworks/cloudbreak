...
import static com.sequenceiq.cloudbreak.doc.OperationDescriptions.StackOpDescription.RESET_JVM_PARAMS;
...
import static com.sequenceiq.cloudbreak.doc.OperationDescriptions.StackOpDescription.STACK_UPGRADE_REINITIABLE;
...
public interface StackV4Endpoint {
    ...
    @GET
    @Path("internal/{name}/cluster_upgrade/reinitiable")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    @Operation(summary = "Get rotation progress information", operationId = "getSecretRotationProgress",
            responses = @ApiResponse(responseCode = "200", description = "successful operation", useReturnTypeSchema = true))
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary = RESET_JVM_PARAMS,
            operationId = "resetJvmParamsByCrnInternal",
            responses = @ApiResponse(responseCode = "200", description = "successful operation", useReturnTypeSchema = true))
