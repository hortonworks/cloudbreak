...
public interface StackV4Endpoint {
    ...
    StackV4Response post(@PathParam("workspaceId") Long workspaceId, @Valid StackV4Request request, @NotNull @QueryParam("accountId") String accountId);
    ...
    void delete(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @QueryParam("forced") @DefaultValue("false") boolean forced, @NotNull @QueryParam("accountId") String accountId);
    ...
    FlowIdentifier repairCluster(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @Valid ClusterRepairV4Request clusterRepairRequest, @NotNull @QueryParam("accountId") String accountId);
    ...
    GeneratedBlueprintV4Response postStackForBlueprint(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @Valid StackV4Request stackRequest, @NotNull @QueryParam("accountId") String accountId);
    ...
    FlowIdentifier changeImage(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @Valid StackImageChangeV4Request stackImageChangeRequest, @NotNull @QueryParam("accountId") String accountId);
    ...
    FlowIdentifier putPassword(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @Valid UserNamePasswordV4Request userNamePasswordJson, @NotNull @QueryParam("accountId") String accountId);
    ...
    FlowIdentifier setClusterMaintenanceMode(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            @NotNull MaintenanceModeV4Request maintenanceMode, @NotNull @QueryParam("accountId") String accountId);
    ...
    UpgradeV4Response checkForClusterUpgradeByName(@PathParam("workspaceId") Long workspaceId, @PathParam("name") String name,
            UpgradeV4Request request, @NotNull @QueryParam("accountId") String accountId);
