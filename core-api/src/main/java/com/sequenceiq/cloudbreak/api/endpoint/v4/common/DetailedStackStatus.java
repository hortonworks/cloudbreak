...
public enum DetailedStackStatus {
    ...
    EXTERNAL_DATABASE_UPGRADE_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    EXTERNAL_DATABASE_UPGRADE_FINISHED(Status.AVAILABLE),
    EXTERNAL_DATABASE_UPGRADE_FAILED(Status.UPDATE_FAILED),
    ...
    DATABASE_UPGRADE_FAILED(Status.UPDATE_FAILED),
    // Upgrade statuses
