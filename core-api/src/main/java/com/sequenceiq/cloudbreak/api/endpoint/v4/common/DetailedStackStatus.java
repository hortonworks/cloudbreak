...
public enum DetailedStackStatus {
    ...
    SECURITY_GROUP_VALIDATION_STARTED(Status.UPDATE_IN_PROGRESS),
    SECURITY_GROUP_VALIDATION_FAILED(Status.AVAILABLE),
    ...
    RESET_JVM_PARAMS(Status.UPDATE_IN_PROGRESS),
    RESET_JVM_PARAMS_FAILED(Status.AVAILABLE),
    ...
    USER_DEFINED_TAGS_UPDATE_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    USER_DEFINED_TAGS_UPDATE_COMPLETE(Status.AVAILABLE),
    USER_DEFINED_TAGS_UPDATE_FAILED(Status.UPDATE_FAILED),
    ...
    INSTALLING_KRAFT_SERVICE_FOR_MIGRATION_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    ...
    ROLLBACK_ZOOKEEPER_TO_KRAFT_MIGRATION_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    ROLLBACK_ZOOKEEPER_TO_KRAFT_MIGRATION_COMPLETE(Status.AVAILABLE),
    ROLLBACK_ZOOKEEPER_TO_KRAFT_MIGRATION_FAILED(Status.UPDATE_FAILED),
    CLUSTER_VERTICALSCALE_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    CLUSTER_VERTICALSCALE_COMPLETE(Status.AVAILABLE),
    CLUSTER_VERTICALSCALE_FAILED(Status.UPDATE_FAILED),
    UPDATE_PUBLIC_DNS_ENTRIES(Status.UPDATE_IN_PROGRESS),
    UPDATE_PUBLIC_DNS_ENTRIES_FAILED(Status.AVAILABLE),
    ENABLE_ENCRYPTION_PROFILE_ON_CLUSTER_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    ENABLE_ENCRYPTION_PROFILE_ON_CLUSTER_COMPLETE(Status.AVAILABLE),
    ENABLE_ENCRYPTION_PROFILE_ON_CLUSTER_FAILED(Status.AVAILABLE),
    // This was not used in PROD and can be removed after.
    @Deprecated (forRemoval = true)
    UPDATE_SSL_CONFIG_ON_CLUSTER_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    @Deprecated (forRemoval = true)
    UPDATE_SSL_CONFIG_ON_CLUSTER_COMPLETE(Status.AVAILABLE),
    @Deprecated (forRemoval = true)
    UPDATE_SSL_CONFIG_ON_CLUSTER_FAILED(Status.AVAILABLE),
    UPDATE_TRUSTED_REALM_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    UPDATE_TRUSTED_REALM_FAILED(Status.UPDATE_FAILED),
    VOLUME_MIGRATION_STARTED(Status.AVAILABLE),
    VOLUME_MIGRATION_COMPLETE(Status.AVAILABLE),
    DISK_METADATA_SYNC_FAILED(Status.AVAILABLE);
