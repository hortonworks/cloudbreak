...
public enum DetailedStackStatus {
    ...
    DATABASE_BACKUP_IN_PROGRESS(Status.DATABASE_BACKUP_IN_PROGRESS),
    DATABASE_BACKUP_FINISHED(Status.DATABASE_BACKUP_FINISHED),
    DATABASE_BACKUP_FAILED(Status.DATABASE_BACKUP_FAILED);
