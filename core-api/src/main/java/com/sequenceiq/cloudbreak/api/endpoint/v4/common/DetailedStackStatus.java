...
public enum DetailedStackStatus {
    ...
    // Atlas up-to-date check status.
    CHECK_ATLAS_UPDATED_IN_PROGRESS(Status.CHECK_ATLAS_UPDATED_IN_PROGRESS),
    CHECK_ATLAS_UPDATED_FINISHED(Status.AVAILABLE),
    CHECK_ATLAS_UPDATED_FAILED(Status.AVAILABLE),
