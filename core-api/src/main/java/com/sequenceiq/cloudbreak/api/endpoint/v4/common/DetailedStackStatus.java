...
public enum DetailedStackStatus {
    ...
    RESTART_INSTANCES_REQUESTED(Status.UPDATE_REQUESTED),
    RESTART_INSTANCES_IN_PROGRESS(Status.UPDATE_IN_PROGRESS),
    RESTART_INSTANCES_COMPLETED(Status.AVAILABLE),
    RESTART_INSTANCES_FAILED(Status.AVAILABLE),
