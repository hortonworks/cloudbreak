...
public class Notes {
    ...
    public static final String BLUEPRINT_NOTES = "Cluster definitions are a declarative "
    ...
    public static final String USER_NOTES = "Users can be invited under an account by the administrator, and all resources "
            + "(e.g. resources, networks, blueprint, credentials, clusters) can be shared across account users";
    ...
    public static final String CUSTOM_CONFIGS_NOTES = "Custom Configurations are sets of properties or name value pairs that "
            + "belong to any of the services present in Cluster Definitions (Blueprints). These can be used to override "
            + "and/or append properties to the corresponding Cluster Definition while launching Datahub Clusters.";
