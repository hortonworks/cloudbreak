...
public enum CloudbreakSecretType implements SecretType {
    ...
    SALT_PASSWORD(List.of(CUSTOM_JOB), Set.of(SKIP_SALT_UPDATE)),
    ...
    INTERNAL_DATALAKE_CM_SERVICE_SHARED_DB(List.of(CUSTOM_JOB, VAULT, SALT_PILLAR, SALT_STATE_APPLY, CM_SERVICE), Set.of(INTERNAL)),
    ...
    CM_MGMT_ADMIN_PASSWORD(List.of(VAULT, CM_USER, CLUSTER_PROXY_REREGISTER), Set.of(SKIP_SALT_UPDATE, INTERNAL));
