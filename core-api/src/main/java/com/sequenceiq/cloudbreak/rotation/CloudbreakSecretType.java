...
public enum CloudbreakSecretType implements SecretType {
    ...
    PRIVATE_HOST_CERTS(List.of(CUSTOM_JOB), Set.of(POST_FLOW)),
    ...
    EMBEDDED_DB_SSL_CERT(List.of(CUSTOM_JOB, SALT_STATE_APPLY), Set.of(SKIP_STATUS_CHECK, SKIP_SALT_HIGHSTATE)),
