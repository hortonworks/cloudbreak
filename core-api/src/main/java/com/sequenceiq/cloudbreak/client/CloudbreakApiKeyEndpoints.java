...
public class CloudbreakApiKeyEndpoints extends AbstractKeyBasedServiceEndpoint implements CloudbreakClient {
    ...
    @Override
    public CustomImageCatalogV4Endpoint customImageCatalogV4Endpoint() {
        return getEndpoint(CustomImageCatalogV4Endpoint.class);
    }
    ...
    @Override
    public StackKraftMigrationV4Endpoint stackKraftMigrationV4Endpoint() {
        return getEndpoint(StackKraftMigrationV4Endpoint.class);
    }
