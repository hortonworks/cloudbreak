...
public class JumpgateEndpointURLResolver implements EndpointURLResolver {

    private static final Logger LOGGER = LoggerFactory.getLogger(JumpgateEndpointURLResolver.class);

    private final String clusterProxyBaseUrl;

    public JumpgateEndpointURLResolver(String clusterProxyBaseUrl) {
