...
public class OpenStackMetaDataCollector implements MetadataCollector {
            ...
            if (resource.getType() == ResourceType.OPENSTACK_INSTANCE) {
                ...
                if (server != null) {
                    ...
                    if (template != null) {
                        ...
                        CloudInstance cloudInstance = new CloudInstance(instanceUUID, template, null, null, null);
    ...
    public InstanceTypeMetadata collectInstanceTypes(AuthenticatedContext ac, List<String> instanceIds) {
        throw new UnsupportedOperationException("Instance type collection is not supported on OpenStack");
    }
