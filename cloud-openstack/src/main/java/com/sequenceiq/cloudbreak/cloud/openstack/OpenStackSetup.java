...
import com.sequenceiq.cloudbreak.cloud.openstack.common.OpenStackFlavorVerifier;
import com.sequenceiq.cloudbreak.cloud.openstack.common.OpenStackImageImporter;
import com.sequenceiq.cloudbreak.cloud.openstack.common.OpenStackImageVerifier;
...
public class OpenStackSetup implements Setup {
    ...
    public ImageStatusResult checkImageStatus(AuthenticatedContext authenticatedContext, CloudStack stack, com.sequenceiq.cloudbreak.cloud.model.Image image) {
        String imageName = image.getImageName();
        OSClient osClient = openStackClient.createOSClient(authenticatedContext);
        Optional<org.openstack4j.model.image.v2.Image.ImageStatus> optionalImageStatus = openStackImageVerifier.getStatus(osClient, imageName);
        ...
        LOGGER.debug("OpenStack image result. name: {}, imageStatus: {}, imageStatusResult: {}", imageName, optionalImageStatus.orElse(null),
                imageStatusResult);
