...
public interface AuthRolesResourceApi {
    ...
    default ResponseEntity<ApiAuthRoleList> createAuthRoles(@ApiParam(value = "The unique id of CB cluster (works in CB test framework only)",required=true) @PathVariable("mockUuid") String mockUuid,@ApiParam(value = "List of auth roles to create."  )  @Valid @RequestBody ApiAuthRoleList body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"items\" : [ {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"clusters\" : [ {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    }, {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    } ],    \"users\" : [ {      \"name\" : \"...\"    }, {      \"name\" : \"...\"    } ],    \"externalUserMappings\" : [ {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_ATTRIBUTE\"    }, {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_SCRIPT\"    } ],    \"baseRole\" : {      \"displayName\" : \"...\",      \"name\" : \"...\",      \"uuid\" : \"...\"    },    \"uuid\" : \"...\",    \"isCustom\" : true  }, {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"clusters\" : [ {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    }, {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    } ],    \"users\" : [ {      \"name\" : \"...\"    }, {      \"name\" : \"...\"    } ],    \"externalUserMappings\" : [ {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_SCRIPT\"    }, {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_SCRIPT\"    } ],    \"baseRole\" : {      \"displayName\" : \"...\",      \"name\" : \"...\",      \"uuid\" : \"...\"    },    \"uuid\" : \"...\",    \"isCustom\" : true  } ]}", ApiAuthRoleList.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
    ...
    default ResponseEntity<ApiAuthRole> deleteAuthRole(@ApiParam(value = "The unique id of CB cluster (works in CB test framework only)",required=true) @PathVariable("mockUuid") String mockUuid,@ApiParam(value = "The uuid of the auth role to delete.",required=true) @PathVariable("uuid") String uuid) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"displayName\" : \"...\",  \"name\" : \"...\",  \"clusters\" : [ {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  }, {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  } ],  \"users\" : [ {    \"name\" : \"...\"  }, {    \"name\" : \"...\"  } ],  \"externalUserMappings\" : [ {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"LDAP\"  }, {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"LDAP\"  } ],  \"baseRole\" : {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"uuid\" : \"...\"  },  \"uuid\" : \"...\",  \"isCustom\" : true}", ApiAuthRole.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    default ResponseEntity<ApiAuthRole> readAuthRole(@ApiParam(value = "The unique id of CB cluster (works in CB test framework only)",required=true) @PathVariable("mockUuid") String mockUuid,@ApiParam(value = "The auth role to read.",required=true) @PathVariable("uuid") String uuid) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"displayName\" : \"...\",  \"name\" : \"...\",  \"clusters\" : [ {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  }, {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  } ],  \"users\" : [ {    \"name\" : \"...\"  }, {    \"name\" : \"...\"  } ],  \"externalUserMappings\" : [ {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"SAML_ATTRIBUTE\"  }, {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"SAML_ATTRIBUTE\"  } ],  \"baseRole\" : {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"uuid\" : \"...\"  },  \"uuid\" : \"...\",  \"isCustom\" : true}", ApiAuthRole.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    default ResponseEntity<ApiAuthRoleList> readAuthRoles(@ApiParam(value = "The unique id of CB cluster (works in CB test framework only)",required=true) @PathVariable("mockUuid") String mockUuid,@ApiParam(value = "", allowableValues = "EXPORT, EXPORT_REDACTED, FULL, FULL_WITH_HEALTH_CHECK_EXPLANATION, SUMMARY", defaultValue = "summary") @Valid @RequestParam(value = "view", required = false, defaultValue="summary") String view) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"items\" : [ {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"clusters\" : [ {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    }, {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    } ],    \"users\" : [ {      \"name\" : \"...\"    }, {      \"name\" : \"...\"    } ],    \"externalUserMappings\" : [ {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_SCRIPT\"    }, {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_ATTRIBUTE\"    } ],    \"baseRole\" : {      \"displayName\" : \"...\",      \"name\" : \"...\",      \"uuid\" : \"...\"    },    \"uuid\" : \"...\",    \"isCustom\" : true  }, {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"clusters\" : [ {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    }, {      \"clusterName\" : \"...\",      \"displayName\" : \"...\"    } ],    \"users\" : [ {      \"name\" : \"...\"    }, {      \"name\" : \"...\"    } ],    \"externalUserMappings\" : [ {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_ATTRIBUTE\"    }, {      \"uuid\" : \"...\",      \"name\" : \"...\",      \"type\" : \"SAML_ATTRIBUTE\"    } ],    \"baseRole\" : {      \"displayName\" : \"...\",      \"name\" : \"...\",      \"uuid\" : \"...\"    },    \"uuid\" : \"...\",    \"isCustom\" : true  } ]}", ApiAuthRoleList.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
    ...
    default ResponseEntity<ApiAuthRole> updateAuthRole(@ApiParam(value = "The unique id of CB cluster (works in CB test framework only)",required=true) @PathVariable("mockUuid") String mockUuid,@ApiParam(value = "Uuid of the auth role being updated.",required=true) @PathVariable("uuid") String uuid,@ApiParam(value = "The auth role information."  )  @Valid @RequestBody ApiAuthRole body) {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            if (getAcceptHeader().get().contains("application/json")) {
                try {
                    return new ResponseEntity<>(getObjectMapper().get().readValue("{  \"displayName\" : \"...\",  \"name\" : \"...\",  \"clusters\" : [ {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  }, {    \"clusterName\" : \"...\",    \"displayName\" : \"...\"  } ],  \"users\" : [ {    \"name\" : \"...\"  }, {    \"name\" : \"...\"  } ],  \"externalUserMappings\" : [ {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"EXTERNAL_PROGRAM\"  }, {    \"uuid\" : \"...\",    \"name\" : \"...\",    \"type\" : \"SAML_SCRIPT\"  } ],  \"baseRole\" : {    \"displayName\" : \"...\",    \"name\" : \"...\",    \"uuid\" : \"...\"  },  \"uuid\" : \"...\",  \"isCustom\" : true}", ApiAuthRole.class), HttpStatus.NOT_IMPLEMENTED);
                } catch (IOException e) {
                    log.error("Couldn't serialize response for content type application/json", e);
                    return new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR);
                }
