...
public class MockImageCatalogController {
    ...
    public String auth(@RequestParam("catalog-name") String name,
        ...
        LOGGER.info("Request to generate image catalog with name: {}, runtime: {}, cm: {}, default image uuid: {}, " +
                "non default image uuid: {}, mock server address: {}", name, runtime, cm, defaultImageUuid, nonDefaultImageUuid, mockServerAddress);
        String generatedImageCatalog = imageCatalogMockService.getImageCatalogByName(name, runtime, cm, defaultImageUuid,
