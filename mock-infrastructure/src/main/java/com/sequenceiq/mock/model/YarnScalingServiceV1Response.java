...
import com.sequenceiq.mock.model.YarnScalingServiceV1Request.HostGroupInstanceType;

@JsonIgnoreProperties(ignoreUnknown = true)
public class YarnScalingServiceV1Response {

    public static final String YARN_RESPONSE_DECOMMISSION_CANDIDATES_KEY = "candidates";
