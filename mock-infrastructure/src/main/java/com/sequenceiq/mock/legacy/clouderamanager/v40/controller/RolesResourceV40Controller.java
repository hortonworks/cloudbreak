...
import com.sequenceiq.mock.swagger.v40.api.RolesResourceApi;
...
@Controller
public class RolesResourceV40Controller implements RolesResourceApi {
    ...
    public ResponseEntity<ApiRole> deleteRole(String clusterName, String roleName, String serviceName) {
        return ProfileAwareResponse.exec(new ApiRole().name(roleName), defaultModelService);
    }
