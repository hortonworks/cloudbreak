...
func (o *PostPublicImageCatalogParams) WithBody(body *model.ImageCatalogRequest) *PostPublicImageCatalogParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post public image catalog params
func (o *PostPublicImageCatalogParams) SetBody(body *model.ImageCatalogRequest) {
	o.Body = body
}
