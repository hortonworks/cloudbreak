...
func (o *ModifyUserProfileInWorkspaceParams) WithBody(body *model.UserProfileRequest) *ModifyUserProfileInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the modify user profile in workspace params
func (o *ModifyUserProfileInWorkspaceParams) SetBody(body *model.UserProfileRequest) {
	o.Body = body
}
...
func (o *ModifyUserProfileInWorkspaceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.UserProfileRequest)
	}
