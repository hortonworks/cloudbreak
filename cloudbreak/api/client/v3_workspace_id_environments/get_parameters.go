...
// WithWorkspaceID adds the workspaceID to the get params
func (o *GetParams) WithWorkspaceID(workspaceID int64) *GetParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the get params
func (o *GetParams) SetWorkspaceID(workspaceID int64) {
