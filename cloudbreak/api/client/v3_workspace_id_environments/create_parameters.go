...
func (o *CreateParams) WithBody(body *model.EnvironmentRequest) *CreateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create params
func (o *CreateParams) SetBody(body *model.EnvironmentRequest) {
	o.Body = body
}

// WithWorkspaceID adds the workspaceID to the create params
func (o *CreateParams) WithWorkspaceID(workspaceID int64) *CreateParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the create params
func (o *CreateParams) SetWorkspaceID(workspaceID int64) {
