...
func (o *CreateEnvironmentParams) WithBody(body *model.EnvironmentRequest) *CreateEnvironmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create environment params
func (o *CreateEnvironmentParams) SetBody(body *model.EnvironmentRequest) {
	o.Body = body
}
...
func (o *CreateEnvironmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.EnvironmentRequest)
	}
