...
// WithWorkspaceID adds the workspaceID to the delete params
func (o *DeleteParams) WithWorkspaceID(workspaceID int64) *DeleteParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the delete params
func (o *DeleteParams) SetWorkspaceID(workspaceID int64) {
