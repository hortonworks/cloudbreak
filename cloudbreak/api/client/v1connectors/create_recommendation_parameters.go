...
func (o *CreateRecommendationParams) WithBody(body *model.RecommendationRequestJSON) *CreateRecommendationParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create recommendation params
func (o *CreateRecommendationParams) SetBody(body *model.RecommendationRequestJSON) {
	o.Body = body
}
