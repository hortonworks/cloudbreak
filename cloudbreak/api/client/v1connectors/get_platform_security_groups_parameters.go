...
func (o *GetPlatformSecurityGroupsParams) WithBody(body *model.PlatformResourceRequestJSON) *GetPlatformSecurityGroupsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get platform security groups params
func (o *GetPlatformSecurityGroupsParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
