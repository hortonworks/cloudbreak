...
func (o *PostPrivateBlueprintParams) WithBody(body *model.BlueprintRequest) *PostPrivateBlueprintParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post private blueprint params
func (o *PostPrivateBlueprintParams) SetBody(body *model.BlueprintRequest) {
	o.Body = body
}
