...
func (o *CreateFlexSubscriptionInWorkspaceParams) WithBody(body *model.FlexSubscriptionRequest) *CreateFlexSubscriptionInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create flex subscription in workspace params
func (o *CreateFlexSubscriptionInWorkspaceParams) SetBody(body *model.FlexSubscriptionRequest) {
	o.Body = body
}
