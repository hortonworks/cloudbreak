...
func (o *PostPrivateRecipeParams) WithBody(body *model.RecipeRequest) *PostPrivateRecipeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post private recipe params
func (o *PostPrivateRecipeParams) SetBody(body *model.RecipeRequest) {
	o.Body = body
}
