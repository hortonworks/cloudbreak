...
func (o *PutCredentialInWorkspaceParams) WithBody(body *model.CredentialRequest) *PutCredentialInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put credential in workspace params
func (o *PutCredentialInWorkspaceParams) SetBody(body *model.CredentialRequest) {
	o.Body = body
}
