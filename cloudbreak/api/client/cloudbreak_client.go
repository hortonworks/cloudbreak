...
import (
	...
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/autoscale"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1accountpreferences"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1audits"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1blueprints"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1connectors"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1credentials"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1events"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1flexsubscriptions"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1imagecatalogs"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1ldap"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1mpacks"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1proxyconfigs"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1rdsconfigs"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1recipes"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1repositoryconfigs"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1securityrules"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1settings"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1smartsensesubscriptions"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1stacks"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1subscriptions"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v1usages"
	...
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3_workspace_id_knoxservices"
	...
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3_workspace_id_proxyconfigs"
	...
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3_workspace_id_smartsensesubscriptions"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3_workspace_id_stacks"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3_workspace_id_users"
	"github.com/hortonworks/cb-cli/cloudbreak/api/client/v3utils"
