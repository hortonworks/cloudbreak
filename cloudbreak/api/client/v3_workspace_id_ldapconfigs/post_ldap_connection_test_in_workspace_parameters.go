...
func (o *PostLdapConnectionTestInWorkspaceParams) WithBody(body *model.LDAPTestRequest) *PostLdapConnectionTestInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post ldap connection test in workspace params
func (o *PostLdapConnectionTestInWorkspaceParams) SetBody(body *model.LDAPTestRequest) {
	o.Body = body
}
