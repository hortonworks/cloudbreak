...
type CreateClusterTemplateInWorkspaceParams struct {
	...
	/*Body*/
	Body *model.ClusterTemplateRequest
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *CreateClusterTemplateInWorkspaceParams) WithBody(body *model.ClusterTemplateRequest) *CreateClusterTemplateInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create cluster template in workspace params
func (o *CreateClusterTemplateInWorkspaceParams) SetBody(body *model.ClusterTemplateRequest) {
	o.Body = body
}
...
func (o *CreateClusterTemplateInWorkspaceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.ClusterTemplateRequest)
	}
