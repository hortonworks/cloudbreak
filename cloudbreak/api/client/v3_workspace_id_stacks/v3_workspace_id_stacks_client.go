...
func (a *Client) ChangeImageV3(params *ChangeImageV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "changeImageV3",
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/changeImage",
...
func (a *Client) CreateStackInWorkspace(params *CreateStackInWorkspaceParams) (*CreateStackInWorkspaceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewCreateStackInWorkspaceParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "createStackInWorkspace",
		Method:             "POST",
		PathPattern:        "/v3/{workspaceId}/stacks",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &CreateStackInWorkspaceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*CreateStackInWorkspaceOK), nil
...
func (a *Client) DeleteInstanceStackV3(params *DeleteInstanceStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "DELETE",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/instance/{instanceId}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) DeleteStackInWorkspace(params *DeleteStackInWorkspaceParams) error {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewDeleteStackInWorkspaceParams()
	}

	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "deleteStackInWorkspace",
		Method:             "DELETE",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &DeleteStackInWorkspaceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
...
func (a *Client) GetStackInWorkspace(params *GetStackInWorkspaceParams) (*GetStackInWorkspaceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewGetStackInWorkspaceParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "getStackInWorkspace",
		Method:             "GET",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &GetStackInWorkspaceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*GetStackInWorkspaceOK), nil
...
func (a *Client) GetStackRequestFromNameV3(params *GetStackRequestFromNameV3Params) (*GetStackRequestFromNameV3OK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/request",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) ListStacksByWorkspace(params *ListStacksByWorkspaceParams) (*ListStacksByWorkspaceOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewListStacksByWorkspaceParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "listStacksByWorkspace",
		Method:             "GET",
		PathPattern:        "/v3/{workspaceId}/stacks",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &ListStacksByWorkspaceReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*ListStacksByWorkspaceOK), nil
...
func (a *Client) PostStackForBlueprintV3(params *PostStackForBlueprintV3Params) (*PostStackForBlueprintV3OK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "POST",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/blueprint",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) PutpasswordStackV3(params *PutpasswordStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/ambari_password/{name}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) PutscalingStackV3(params *PutscalingStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/scaling",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) PutstartStackV3(params *PutstartStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "putstartStackV3",
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/start",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) PutstopStackV3(params *PutstopStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "putstopStackV3",
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/stop",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) PutsyncStackV3(params *PutsyncStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "putsyncStackV3",
		Method:             "PUT",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/sync",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) RepairClusterV3(params *RepairClusterV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "repairClusterV3",
		Method:             "POST",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/manualrepair",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) RetryStackV3(params *RetryStackV3Params) error {
	...
	_, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "retryStackV3",
		Method:             "POST",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/retry",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
...
func (a *Client) StatusStackV3(params *StatusStackV3Params) (*StatusStackV3OK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "statusStackV3",
		Method:             "GET",
		PathPattern:        "/v3/{workspaceId}/stacks/{name}/status",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
