...
func (o *PostPrivateLdapParams) WithBody(body *model.LdapConfigRequest) *PostPrivateLdapParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post private ldap params
func (o *PostPrivateLdapParams) SetBody(body *model.LdapConfigRequest) {
	o.Body = body
}
