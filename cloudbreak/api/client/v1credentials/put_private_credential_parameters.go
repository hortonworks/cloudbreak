...
func (o *PutPrivateCredentialParams) WithBody(body *model.CredentialRequest) *PutPrivateCredentialParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put private credential params
func (o *PutPrivateCredentialParams) SetBody(body *model.CredentialRequest) {
	o.Body = body
}
