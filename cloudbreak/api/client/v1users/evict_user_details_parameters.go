...
func (o *EvictUserDetailsParams) WithBody(body *model.User) *EvictUserDetailsParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the evict user details params
func (o *EvictUserDetailsParams) SetBody(body *model.User) {
	o.Body = body
}
