...
import com.sequenceiq.cloudbreak.orchestrator.yarn.client.filter.ContentTypeFilter;
    ...
    public ResponseContext createApplication(CreateApplicationRequest createApplicationRequest) throws
        ...
        try (Client client = getLoggingClient()) {
            ...
            try (Response response = webResource
                    ...
                    .post(Entity.entity(createApplicationRequest, MediaType.APPLICATION_JSON))) {
