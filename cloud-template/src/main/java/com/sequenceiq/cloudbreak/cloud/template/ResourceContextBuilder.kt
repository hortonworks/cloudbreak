 ...
 */
interface ResourceContextBuilder<C : ResourceBuilderContext> : CloudPlatformAware {
     ...
     */
    fun contextInit(cloudContext: CloudContext, auth: AuthenticatedContext, network: Network, resources: List<CloudResource>, build: Boolean): C
