...
/*
TODO:
- check DB instance statuses before upgrade, all should be running
- try what happens if instances are not in running state, e.g. stopped
- work on the poller, why does it not detect, that the upgrade has started
- what to do if instances are on different versions
