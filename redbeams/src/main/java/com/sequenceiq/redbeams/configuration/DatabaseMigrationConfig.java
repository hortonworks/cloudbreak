...
public class DatabaseMigrationConfig {
    ...
    private static final String DEFAULT_SCHEMA_LOCATION_IN_SOURCE = "redbeams/src/main/resources/schema";
    ...
    @Value("${redbeams.schema.scripts.location:" + DEFAULT_SCHEMA_LOCATION_IN_SOURCE + '}')
    private String schemaLocation;

    @Value("${redbeams.schema.migration.auto:true}")
