...
public enum RedbeamsProvisionEvent implements FlowEvent {
    ...
    REGISTER_DATABASE_SERVER_FINISHED_EVENT(EventSelectorUtil.selector(RegisterDatabaseServerSuccess.class)),
    REGISTER_DATABASE_SERVER_FAILED_EVENT(EventSelectorUtil.selector(RegisterDatabaseServerFailed.class)),
