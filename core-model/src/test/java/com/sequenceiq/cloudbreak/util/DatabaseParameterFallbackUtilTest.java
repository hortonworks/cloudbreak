...
public class DatabaseParameterFallbackUtilTest {
    ...
    public void testSetupDatabaseInitParams() {
        ...
        assertEquals(DatabaseAvailabilityType.HA, database.getExternalDatabaseCreationType());
    ...
    public void testGetDatabaseAvailabilityType() {
        ...
        sdxDatabase.setExternalDatabaseCreationType(DatabaseAvailabilityType.NONE);
