...
class LegacyMetricStucturedEventSenderTest {
    ...
    @InjectMocks
    private LegacyMetricStucturedEventSender underTest;
    ...
    void testEventIsNotStructuredFlowEvent() {
        underTest.create(new StructuredNotificationEvent());
    ...
    private static StructuredFlowEvent structuredFlowEvent(String flowChainType, String flowType, String nextFlowState) {
        return new StructuredFlowEvent(null, null, new FlowDetails(flowChainType, flowType, null, null, null, nextFlowState, null, 0L), null, null, null);
    }
