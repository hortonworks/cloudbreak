...
import static com.azure.resourcemanager.compute.models.ExecutionState.FAILED;
import static com.azure.resourcemanager.compute.models.ExecutionState.SUCCEEDED;
...
public class AzureManagedImageService {
    ...
    private Optional<VirtualMachineCustomImage> getImageByState(String imageName, String resourceGroup, VirtualMachineCustomImage image) {
        ExecutionState creationState = ExecutionState.fromString(image.innerModel().provisioningState());
