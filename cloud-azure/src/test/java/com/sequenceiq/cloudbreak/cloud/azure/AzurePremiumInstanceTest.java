...
public class AzurePremiumInstanceTest {
    ...
    public static Iterable<Object[]> data() {
        return Arrays.asList(new Object[][]{
                ...
                {"Standard_A11", false},
                {"Basic_A3", false},
                {"Standard_E32-16s_v3", false},
                {"Standard_DS3_v2", true},
                {"Standard_D11", false},
                {"Standard_E4_v3", false},
                {"Standard_E64s_v3", false},
                {"Standard_E64-32s_v3", false},
                {"Standard_B8ms", false},
                {"Standard_A2", false},
                {"Standard_DS14-4_v2", true},
                {"Standard_E32s_v3", false},
                ...
                {"Standard_E4s_v3", false},
                {"Standard_D3_v2", false},
                {"Standard_DS11_v2", true},
                {"Standard_D3", false},
                {"Standard_E32-8s_v3", false},
