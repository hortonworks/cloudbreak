...
public class RestCommonServiceTest {
    ...
    public void testWhenNameAndResourceCrnComeFromTheOperationButExistInRequestAndResponse() {
        ...
        Map<String, Object> actual = restCommonService.addClusterCrnAndNameIfPresent(event);
    ...
    public void testWhenNameAndResourceCrnNotExists() {
        ...
        UnsupportedOperationException exception = assertThrows(UnsupportedOperationException.class,
                () -> restCommonService.addClusterCrnAndNameIfPresent(event));
