 ...
 */
enum class Hints private constructor(private val message: String) {
    ...
    SELECT_SECURITY_GROUP("Use 'securitygroup list' to list the available security groups, a group could be selected by 'securitygroup select'" + " or created by 'securitygroup create' command"),
