...
public class RotateSaltPasswordRequest {
  ...
  public RotateSaltPasswordRequest environment(@jakarta.annotation.Nonnull String environment) {
  ...
  /**
   * Return true if this RotateSaltPasswordRequest object is equal to o.
   */
  @Override
