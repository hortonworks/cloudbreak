...
public class GetAccountTelemetryDefaultResponse {
  ...
  public GetAccountTelemetryDefaultResponse workloadAnalytics(@javax.annotation.Nullable Boolean workloadAnalytics) {
  ...
  public GetAccountTelemetryDefaultResponse reportDeploymentLogs(@javax.annotation.Nullable Boolean reportDeploymentLogs) {
  ...
  public GetAccountTelemetryDefaultResponse cloudStorageLogging(@javax.annotation.Nullable Boolean cloudStorageLogging) {
  ...
  public GetAccountTelemetryDefaultResponse rules(@javax.annotation.Nullable List<AnonymizationRuleResponse> rules) {
