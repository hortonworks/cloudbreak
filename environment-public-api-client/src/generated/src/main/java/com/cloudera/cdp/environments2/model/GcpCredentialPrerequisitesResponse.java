...
public class GcpCredentialPrerequisitesResponse {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `serviceAccountCreationCommand` to the URL query string
    if (getServiceAccountCreationCommand() != null) {
      joiner.add(String.format("%sserviceAccountCreationCommand%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getServiceAccountCreationCommand()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
