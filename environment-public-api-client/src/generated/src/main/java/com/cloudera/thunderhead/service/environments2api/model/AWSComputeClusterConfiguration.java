...
public class AWSComputeClusterConfiguration {
  ...
  public AWSComputeClusterConfiguration privateCluster(@jakarta.annotation.Nullable Boolean privateCluster) {
  ...
  public AWSComputeClusterConfiguration kubeApiAuthorizedIpRanges(@jakarta.annotation.Nullable List<String> kubeApiAuthorizedIpRanges) {
  ...
  public AWSComputeClusterConfiguration workerNodeSubnets(@jakarta.annotation.Nullable List<String> workerNodeSubnets) {
  ...
  /**
   * Return true if this AWSComputeClusterConfiguration object is equal to o.
   */
  @Override
