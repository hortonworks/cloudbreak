...
public class AzureDataServicesParameters {
  ...
  **/
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `sharedManagedIdentity` to the URL query string
    if (getSharedManagedIdentity() != null) {
      joiner.add(String.format("%ssharedManagedIdentity%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSharedManagedIdentity()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
