...
public class GetGovCloudAuditCredentialPrerequisitesResponse {
  ...
  public GetGovCloudAuditCredentialPrerequisitesResponse accountId(@jakarta.annotation.Nullable String accountId) {
  ...
  public GetGovCloudAuditCredentialPrerequisitesResponse aws(@jakarta.annotation.Nullable AwsCredentialPrerequisitesResponse aws) {
    this.aws = aws;
    return this;
  }
