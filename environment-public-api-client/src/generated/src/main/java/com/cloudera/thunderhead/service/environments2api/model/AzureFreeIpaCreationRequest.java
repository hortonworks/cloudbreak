...
public class AzureFreeIpaCreationRequest {
  ...
  public AzureFreeIpaCreationRequest instanceCountByGroup(@jakarta.annotation.Nullable Integer instanceCountByGroup) {
  ...
  public AzureFreeIpaCreationRequest recipes(@jakarta.annotation.Nullable List<String> recipes) {
  ...
  public AzureFreeIpaCreationRequest instanceType(@jakarta.annotation.Nullable String instanceType) {
  ...
  public AzureFreeIpaCreationRequest multiAz(@jakarta.annotation.Nullable Boolean multiAz) {
