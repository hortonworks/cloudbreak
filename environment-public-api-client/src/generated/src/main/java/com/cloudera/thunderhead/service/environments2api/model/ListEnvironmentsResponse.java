...
public class ListEnvironmentsResponse {
  ...
  public ListEnvironmentsResponse environments(List<EnvironmentSummary> environments) {
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getEnvironments() != null) {
      for (int i = 0; i < getEnvironments().size(); i++) {
        if (getEnvironments().get(i) != null) {
          joiner.add(getEnvironments().get(i).toUrlQueryString(String.format("%senvironments%s%s", prefix, suffix,
