...
class ProfilerAdminCloudStorageRoleConfigProviderTest {
    private ProfilerAdminCloudStorageRoleConfigProvider underTest;

    @BeforeEach
    public void setUp() {
        underTest = new ProfilerAdminCloudStorageRoleConfigProvider();
    }

    @Test
    void testProfilerAdminCloudStorageRoleConfigs() {
    ...
    @Test
    void testProfilerAdminCloudStorageConfigsWhenNoCloudStorageProvided() {
