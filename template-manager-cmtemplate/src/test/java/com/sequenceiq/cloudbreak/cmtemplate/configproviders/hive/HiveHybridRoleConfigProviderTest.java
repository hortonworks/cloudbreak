...
import static com.sequenceiq.cloudbreak.cmtemplate.configproviders.hive.HiveHybridRoleConfigProvider.HIVE_HOOK_PROTO_BASE_DIRECTORY_KEY;
import static com.sequenceiq.cloudbreak.cmtemplate.configproviders.hive.HiveHybridRoleConfigProvider.HIVE_HOOK_PROTO_BASE_DIRECTORY_VALUE;
...
class HiveHybridRoleConfigProviderTest {

    @Mock
    private HdfsConfigHelper hdfsConfigHelper;

    @InjectMocks
    private HiveHybridRoleConfigProvider underTest;
    ...
    void getServiceConfigsWithDatalakeHdfs() {
        ...
        List<ApiClusterTemplateConfig> result = underTest.getServiceConfigs(templateProcessor, source);
        assertThat(result).containsExactly(config(HIVE_HOOK_PROTO_BASE_DIRECTORY_KEY, "hdfs://ns1" + HIVE_HOOK_PROTO_BASE_DIRECTORY_VALUE));
    }
