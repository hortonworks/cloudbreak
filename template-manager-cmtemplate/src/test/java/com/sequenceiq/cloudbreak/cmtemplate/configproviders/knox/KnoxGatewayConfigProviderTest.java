...
public class KnoxGatewayConfigProviderTest {
    ...
    public void roleConfigsWithGatewayAndUserFacingCertificationGeneratedAndAutoTlsIsEnsabled() {
        final String gatewaySiteCustomUserFacingCertConfigValue = "<property><name>gateway.tls.certificate.path</name>"
                + "<value>/var/lib/knox/cloudbreak_resources/security/keystores/userfacing.p12</value>"
                + "</property><property><name>gateway.tls.cert.alias</name><value>userfacing-identity</value></property>";
        Gateway gateway = new Gateway();
        gateway.setKnoxMasterSecret("admin");
        gateway.setPath("/a/b/c");
        GeneralClusterConfigs generalClusterConfigs = new GeneralClusterConfigs();
