...
public class KerberosConfigToKerberosV4ResponseConverter extends AbstractConversionServiceAwareConverter<KerberosConfig, KerberosV4Response> {
    ...
    public KerberosV4Response convert(KerberosConfig source) {
        ...
        kerberosV4Response.setAdmin(getConversionService().convert(source.getAdminSecret(), SecretV4Response.class));
        kerberosV4Response.setPassword(getConversionService().convert(source.getPasswordSecret(), SecretV4Response.class));
        kerberosV4Response.setPrincipal(getConversionService().convert(source.getPrincipalSecret(), SecretV4Response.class));
        kerberosV4Response.setDescriptor(getConversionService().convert(source.getDescriptorSecret(), SecretV4Response.class));
        kerberosV4Response.setKrb5Conf(getConversionService().convert(source.getKrb5ConfSecret(), SecretV4Response.class));
