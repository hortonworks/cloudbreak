...
@Component
public class ManagementPackComponentToManagementPackV4EntryConverter extends AbstractConversionServiceAwareConverter<ManagementPackComponent, ManagementPackV4Entry> {
    @Override
