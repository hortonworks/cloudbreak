...
@Component
public class ShowTerminatedClusterPreferencesToShowTerminatedClusterPreferencesV4ResponseConverter extends AbstractConversionServiceAwareConverter<ShowTerminatedClustersPreferences, ShowTerminatedClusterPreferencesV4Response> {

    @Inject
    private ConverterUtil converterUtil;

    @Override
    public ShowTerminatedClusterPreferencesV4Response convert(ShowTerminatedClustersPreferences source) {
