...
public class StackRequestToStackConverter extends AbstractConversionServiceAwareConverter<StackRequest, Stack> {
    ...
    public Stack convert(StackRequest source) {
        ...
        stack.setTags(getTags(mergeTags(sourceTags, source.getUserDefinedTags(), getDefaultTags(source, email))));
    ...
    private Map<String, String> getDefaultTags(StackRequest source, String email) {
        Map<String, String> result = new HashMap<>();
        return defaultCostTaggingService.prepareDefaultTags(source.getAccount(), email, result, source.getCloudPlatform());
    }
