...
public class CloudbreakUserConfiguratorFilter extends OncePerRequestFilter {
    ...
    public CloudbreakUserConfiguratorFilter(LegacyRestRequestThreadLocalService legacyRestRequestThreadLocalService, AuthenticatedUserService authenticatedUserService) {
