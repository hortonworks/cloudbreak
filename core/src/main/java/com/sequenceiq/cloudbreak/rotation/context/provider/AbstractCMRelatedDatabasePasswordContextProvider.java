...
public abstract class AbstractCMRelatedDatabasePasswordContextProvider {
    ...
    protected Map<String, SaltPillarProperties> getRotationPillarProperties(String resource) {
        try {
            ...
            addPillarPropertiesIfNeeded(pillarPropertiesSet, stack);
    ...
    protected VaultRotationContext getVaultRotationContext(Map<RDSConfig, Pair<String, String>> newUserPassPairs, StackDto stack, String resource) {
    ...
    protected Map<RDSConfig, Pair<String, String>> getUserPassPairs(StackDto stack, String resource) {
        ...
        return rdsConfigService.findByClusterId(cluster.getId())
                ...
                .collect(Collectors.toMap(rdsConfig -> rdsConfig, rdsConfig -> getUserPassPairs(rdsConfig, resource)));
    }

    private Pair<String, String> getUserPassPairs(RDSConfig rdsConfig, String resource) {
        if (fullRotation(resource)) {
