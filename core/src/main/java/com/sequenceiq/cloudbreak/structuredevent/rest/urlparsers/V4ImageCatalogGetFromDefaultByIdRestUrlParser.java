...
@Component
public class V4ImageCatalogGetFromDefaultByIdRestUrlParser extends LegacyRestUrlParser {
    ...
    private static final Pattern PATTERN = Pattern.compile("v4/(\\d+)/(image_catalogs)\\/image\\/([\\w\\_\\:\\s]+)?");
