...
@Component
@Transactional
public class LegacyCoreStructuredFlowEventFactory implements StructuredFlowEventFactory<Stack> {

    private static final Logger LOGGER = LoggerFactory.getLogger(LegacyCoreStructuredFlowEventFactory.class);
    ...
    @Override
    public StructuredNotificationEvent createStructuredNotificationEvent(Stack stack, String notificationType, String message, Optional<String> groupName) {
        ...
        try {
            ...
            Cluster cluster = stack.getCluster();
            notificationDetails.setInstanceGroup(groupName.get());
            if (cluster != null) {
