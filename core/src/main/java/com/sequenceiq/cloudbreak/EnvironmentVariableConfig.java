...
public class EnvironmentVariableConfig {
    ...
    public static final String CB_DOCKER_CONTAINER_BAYWATCH_SERVER = "sequenceiq/baywatch:v0.5.1";
    public static final String CB_DOCKER_CONTAINER_BAYWATCH_CLIENT = "sequenceiq/baywatch-client:v0.5.1";
    ...
    public static final String CB_GCP_SOURCE_IMAGE_PATH = "cb-centos71-amb210-2015-06-30-rhel-71";
