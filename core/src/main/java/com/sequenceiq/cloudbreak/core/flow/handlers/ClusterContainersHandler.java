...
public class ClusterContainersHandler extends AbstractFlowHandler<ProvisioningContext> implements FlowHandler {
    ...
    protected Object execute(Event<ProvisioningContext> event) throws CloudbreakException {
        ...
        ProvisioningContext provisioningContext = (ProvisioningContext) getFlowFacade().runClusterContainers(event.getData());
        LOGGER.info("Cluster containers started. Context: {}", provisioningContext);
