...
public class AttachVolumesFinishedEvent extends StackEvent {
    ...
    @JsonCreator
    public AttachVolumesFinishedEvent(@JsonProperty("resourceId") Long resourceId,
        ...
        super(AddVolumesEvent.ATTACH_VOLUMES_FINISHED_EVENT.event(), resourceId);
    ...
    public String toString() {
        return new StringJoiner(", ", AttachVolumesFinishedEvent.class.getSimpleName() + "[", "]")
                .add("Type=" + type)
                .add("Size=" + size)
