...
@Component
public class DownscaleMetadataCollectHandler extends AbstractFlowHandler<StackScalingContext> implements FlowHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(DownscaleMetadataCollectHandler.class);
