...
@Component
public class CoreValidateEnableSeLinuxHandler extends ExceptionCatcherEventHandler<CoreValidateEnableSeLinuxHandlerEvent> {
    ...
    public String selector() {
        return EventSelectorUtil.selector(CoreValidateEnableSeLinuxHandlerEvent.class);
    }

    @Override
    protected Selectable defaultFailureEvent(Long resourceId, Exception e, Event<CoreValidateEnableSeLinuxHandlerEvent> event) {
        return new CoreEnableSeLinuxFailedEvent(resourceId, "VALIDATION_FAILED", e);
    }

    @Override
    public Selectable doAccept(HandlerEvent<CoreValidateEnableSeLinuxHandlerEvent> enableSeLinuxEventEvent) {
        CoreValidateEnableSeLinuxHandlerEvent eventData = enableSeLinuxEventEvent.getData();
        ...
        return new CoreEnableSeLinuxEvent(ENABLE_SELINUX_CORE_EVENT.selector(), eventData.getResourceId());
    }
