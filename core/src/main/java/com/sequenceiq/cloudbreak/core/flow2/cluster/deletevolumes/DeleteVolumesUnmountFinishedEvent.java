...
public class DeleteVolumesUnmountFinishedEvent extends StackEvent {
    ...
    @JsonCreator
    public DeleteVolumesUnmountFinishedEvent(@JsonProperty("resourceId") Long resourceId,
        ...
        super(DELETE_VOLUMES_UNMOUNT_FINISHED_EVENT.event(), resourceId);
    ...
    public String toString() {
        return new StringJoiner(",", DeleteVolumesUnmountFinishedEvent.class.getSimpleName() + "[", "]")
