...
public class ReactorNotifier {
    ...
    public void notify(Long stackId, String selector, Acceptable acceptable) {
        notify(stackId, selector, acceptable, stackService::getByIdWithTransaction);
    }

    public void notifyWithoutCheck(Long stackId, String selector, Acceptable acceptable) {
        notify(stackId, selector, acceptable, stackService::getByIdWithTransaction);
    }

    public void notify(Long stackId, String selector, Acceptable acceptable, Function<Long, Stack> getStackFn) {
