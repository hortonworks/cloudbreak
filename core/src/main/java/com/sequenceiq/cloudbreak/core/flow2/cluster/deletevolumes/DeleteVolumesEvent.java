...
public enum DeleteVolumesEvent implements FlowEvent {
    ...
    DELETE_VOLUMES_ORCHESTRATION_HANDLER_EVENT(EventSelectorUtil.selector(DeleteVolumesOrchestrationEvent.class)),
    DELETE_VOLUMES_ORCHESTRATION_FINISHED_EVENT(EventSelectorUtil.selector(DeleteVolumesOrchestrationFinishedEvent.class)),
