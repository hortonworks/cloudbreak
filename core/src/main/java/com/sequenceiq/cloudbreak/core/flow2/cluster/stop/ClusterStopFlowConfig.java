...
@Component
public class ClusterStopFlowConfig extends StackStatusFinalizerAbstractFlowConfig<ClusterStopState, ClusterStopEvent>
    ...
    @Override
    public FlowEdgeConfig<ClusterStopState, ClusterStopEvent> getEdgeConfig() {
        return EDGE_CONFIG;
    }
