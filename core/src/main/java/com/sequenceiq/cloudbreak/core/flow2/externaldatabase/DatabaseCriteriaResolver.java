...
class DatabaseCriteriaResolver {
    ...
    @NotNull
    AttemptResult<Object> resolveResultByCriteria(DatabaseOperation databaseOperation, DatabaseServerV4Response rdsStatus, ClusterView cluster) {
    ...
    private String getDatabaseOperationFailedResultMessage(ClusterView cluster, DatabaseServerV4Response rdsStatus) {
