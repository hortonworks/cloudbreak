...
public class DetermineDatalakeDataSizesFlowConfig
    ...
    private static final List<Transition<DetermineDatalakeDataSizesState, DetermineDatalakeDataSizesEvent>> TRANSITIONS =
            new Builder<DetermineDatalakeDataSizesState, DetermineDatalakeDataSizesEvent>()
                    ...
                    .to(DetermineDatalakeDataSizesState.DETERMINE_DATALAKE_DATA_SIZES_SUCCESS_STATE)
                    .event(DetermineDatalakeDataSizesEvent.DETERMINE_DATALAKE_DATA_SIZES_SUCCESS_EVENT).defaultFailureEvent()

                    .from(DetermineDatalakeDataSizesState.DETERMINE_DATALAKE_DATA_SIZES_SUCCESS_STATE)
                    .to(DetermineDatalakeDataSizesState.FINAL_STATE)
                    .event(DetermineDatalakeDataSizesEvent.DETERMINE_DATALAKE_DATA_SIZES_SUCCESS_HANDLED_EVENT).defaultFailureEvent()
