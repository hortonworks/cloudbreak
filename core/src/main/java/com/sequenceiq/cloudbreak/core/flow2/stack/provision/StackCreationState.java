...
public enum StackCreationState implements FlowState {
    ...
    VALIDATION_STATE,
    GENERATE_ENCRYPTION_KEYS_STATE,
    ...
    PROVISION_LOAD_BALANCER_STATE,
    PROVISIONING_FINISHED_STATE,
    COLLECTMETADATA_STATE,
    COLLECTMETADATA_LOADBALANCER_STATE,
    UPDATE_USERDATA_SECRETS_STATE,
    GET_TLS_INFO_STATE,
    TLS_SETUP_STATE,
    ATTACHED_VOLUME_CONSUMPTION_COLLECTION_SCHEDULING_STATE,
