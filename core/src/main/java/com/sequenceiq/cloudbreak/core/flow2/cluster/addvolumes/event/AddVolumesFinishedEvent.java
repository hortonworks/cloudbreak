...
public class AddVolumesFinishedEvent extends StackEvent {
    ...
    @JsonCreator
    public AddVolumesFinishedEvent(@JsonProperty("resourceId") Long resourceId,
        ...
        super(AddVolumesEvent.ADD_VOLUMES_FINISHED_EVENT.event(), resourceId);
    ...
    public String toString() {
        return new StringJoiner(", ", AddVolumesFinishedEvent.class.getSimpleName() + "[", "]")
                .add("Type=" + type)
                .add("Size=" + size)
