...
public class AddVolumesCMConfigHandlerEvent extends BaseFlowEvent implements Selectable {
    ...
    public AddVolumesCMConfigHandlerEvent(
        ...
        super(ADD_VOLUMES_CM_CONFIGURATION_HANDLER_EVENT.event(), stackId, null);
