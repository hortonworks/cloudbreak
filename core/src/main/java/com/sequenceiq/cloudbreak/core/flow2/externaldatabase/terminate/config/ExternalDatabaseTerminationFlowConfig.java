...
@Component
public class ExternalDatabaseTerminationFlowConfig
        extends StackStatusFinalizerAbstractFlowConfig<ExternalDatabaseTerminationState, ExternalDatabaseTerminationEvent>
