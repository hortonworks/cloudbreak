...
internal abstract class AbstractStackTerminationAction<P : Payload> protected constructor(payloadClass: Class<P>) : AbstractAction<StackTerminationState, StackTerminationEvent, StackTerminationContext, P>(payloadClass) {
    @Inject
    ...
    override fun createFlowContext(flowId: String, stateContext: StateContext<StackTerminationState, StackTerminationEvent>, payload: P): StackTerminationContext {
        ...
        return StackTerminationContext(flowId, stack, cloudContext, cloudCredential, cloudStack, resources)
    }

    override fun getFailurePayload(payload: P, flowContext: Optional<StackTerminationContext>, ex: Exception): Any {
