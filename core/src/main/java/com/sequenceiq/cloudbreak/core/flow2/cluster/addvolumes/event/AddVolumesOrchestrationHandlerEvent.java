...
public class AddVolumesOrchestrationHandlerEvent extends StackEvent {
    ...
    @JsonCreator
    public AddVolumesOrchestrationHandlerEvent(
        ...
        super(ADD_VOLUMES_ORCHESTRATION_HANDLER_EVENT.event(), stackId);
    ...
    public String toString() {
        return new StringJoiner(", ", AddVolumesOrchestrationHandlerEvent.class.getSimpleName() + "[", "]")
                .add("Type=" + type)
                .add("Size=" + size)
