...
public enum StackUpscaleEvent implements FlowEvent {
    ...
    VALIDATE_UPSCALE_EVENT(UpscaleStackValidationRequest.selector(UpscaleStackValidationRequest.class)),
    UPSCALE_VALID_EVENT(UpscaleStackValidationResult.selector(UpscaleStackValidationResult.class)),
    UPSCALE_INVALID_EVENT(UpscaleStackValidationResult.failureSelector(UpscaleStackValidationResult.class)),
