...
public class FlowChainTriggers {
    ...
    public static final String ENABLE_ENCRYPTION_PROFILE_CHAIN_TRIGGER_EVENT = "ENABLE_ENCRYPTION_PROFILE_CHAIN_TRIGGER_EVENT";

    public static final String DISABLE_ENCRYPTION_PROFILE_CHAIN_TRIGGER_EVENT = "DISABLE_ENCRYPTION_PROFILE_CHAIN_TRIGGER_EVENT";
