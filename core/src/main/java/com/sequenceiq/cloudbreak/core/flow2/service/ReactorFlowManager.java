...
public class ReactorFlowManager {
    ...
    public void triggerStackRemoveInstances(Long stackId, String hostGroup, Set<String> hostnames) {
        String selector = FlowChainTriggers.FULL_DOWNSCALE_TRIGGER_EVENT;
        ClusterAndStackDownscaleTriggerEvent event = new ClusterAndStackDownscaleTriggerEvent(selector, stackId, hostGroup, hostnames,
                ScalingType.DOWNSCALE_TOGETHER, new Promise<>());
        notify(selector, event);
    }
