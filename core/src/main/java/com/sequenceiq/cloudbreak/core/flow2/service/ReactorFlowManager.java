...
public class ReactorFlowManager {
    ...
    public FlowIdentifier triggerDatalakeDatabaseBackup(Long stackId, String location, String backupId, String userCrn) {
        ...
        return reactorNotifier.notify(stackId, selector,
            new DatabaseBackupTriggerEvent(selector, stackId, location, backupId, userCrn));
    }

    public FlowIdentifier triggerDatalakeDatabaseRestore(Long stackId, String location, String backupId, String userCrn) {
        String selector = DATABASE_RESTORE_IN_PROGRESS_EVENT.event();
        return reactorNotifier.notify(stackId, selector,
            new DatabaseRestoreTriggerEvent(selector, stackId, location, backupId, userCrn));
    }
