...
public enum ClusterUpgradeValidationState implements FlowState {
    ...
    CLUSTER_UPGRADE_S3GUARD_VALIDATION_STATE,
    CLUSTER_UPGRADE_PARCEL_CLEANUP_STATE,
    ...
    CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_STATE,
    CLUSTER_UPGRADE_FREEIPA_STATUS_VALIDATION_STATE,
