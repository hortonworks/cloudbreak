...
import com.sequenceiq.cloudbreak.core.flow2.stack.image.update.StackImageUpdateState;
...
abstract class AbstractImageValidationAction<P extends Payload> extends AbstractStackAction<StackImageUpdateState, StackImageUpdateEvent, StackContext, P> {
    ...
    protected AbstractImageValidationAction(Class<P> payloadClass) {
        super(payloadClass);
    }
