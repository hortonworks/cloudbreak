...
@Component
public class ExtendConsulMetadataHandler extends AbstractFlowHandler<StackScalingContext> implements FlowHandler {
    ...
    protected Object execute(Event<StackScalingContext> event) throws CloudbreakException {
        ...
        FlowContext context = getFlowFacade().extendConsulMetadata(event.getData());
