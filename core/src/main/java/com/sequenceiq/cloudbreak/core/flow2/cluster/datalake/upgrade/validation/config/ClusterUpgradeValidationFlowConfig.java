...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.ClusterUpgradeValidationState.CLUSTER_UPGRADE_CREDENTIAL_VALIDATION_STATE;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.event.ClusterUpgradeValidationStateSelectors.START_CLUSTER_UPGRADE_CREDENTIAL_VALIDATION_EVENT;
...
public class ClusterUpgradeValidationFlowConfig extends AbstractFlowConfiguration<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>
    ...
    private static final List<Transition<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>> TRANSITIONS =
            new Transition.Builder<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>()
                    ...
                    .from(CLUSTER_UPGRADE_DISK_SPACE_VALIDATION_STATE).to(CLUSTER_UPGRADE_CREDENTIAL_VALIDATION_STATE)
