...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.ClusterUpgradeValidationState.CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_STATE;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.ClusterUpgradeValidationState.CLUSTER_UPGRADE_PARCEL_CLEANUP_STATE;
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.ClusterUpgradeValidationState.CLUSTER_UPGRADE_S3GUARD_VALIDATION_STATE;
...
import static com.sequenceiq.cloudbreak.core.flow2.cluster.datalake.upgrade.validation.event.ClusterUpgradeValidationStateSelectors.START_CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_EVENT;
...
@Component
public class ClusterUpgradeValidationFlowConfig
        extends StackStatusFinalizerAbstractFlowConfig<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>
    ...
    private static final List<Transition<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>> TRANSITIONS =
            new Transition.Builder<ClusterUpgradeValidationState, ClusterUpgradeValidationStateSelectors>()
                    ...
                    .from(CLUSTER_UPGRADE_IMAGE_VALIDATION_STATE).to(CLUSTER_UPGRADE_PARCEL_CLEANUP_STATE)
                    .event(START_CLUSTER_UPGRADE_PARCEL_CLEANUP_EVENT)
                    .defaultFailureEvent()

                    .from(CLUSTER_UPGRADE_PARCEL_CLEANUP_STATE).to(CLUSTER_UPGRADE_DISK_SPACE_VALIDATION_STATE)
                    .event(START_CLUSTER_UPGRADE_DISK_SPACE_VALIDATION_EVENT)
                    .defaultFailureEvent()

                    .from(CLUSTER_UPGRADE_DISK_SPACE_VALIDATION_STATE).to(CLUSTER_UPGRADE_CLOUDPROVIDER_CHECK_UPDATE_STATE)
                    .event(START_CLUSTER_UPGRADE_CLOUDPROVIDER_CHECK_UPDATE_EVENT)
                    .defaultFailureEvent()

                    .from(CLUSTER_UPGRADE_CLOUDPROVIDER_CHECK_UPDATE_STATE).to(CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_STATE)
                    .event(START_CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_EVENT)
                    .defaultFailureEvent()

                    .from(CLUSTER_UPGRADE_EXISTING_UPGRADE_COMMAND_VALIDATION_STATE).to(CLUSTER_UPGRADE_FREEIPA_STATUS_VALIDATION_STATE)
                    .event(START_CLUSTER_UPGRADE_FREEIPA_STATUS_VALIDATION_EVENT)
                    .defaultFailureEvent()
    ...
    public ClusterUpgradeValidationStateSelectors getRetryableEvent() {
        return HANDLED_FAILED_CLUSTER_UPGRADE_VALIDATION_EVENT;
    }
}
