...
public class DatabaseBackupActions {
    ...
    public Action<?, ?> backupDatabase() {
        return new AbstractBackupRestoreActions<>(DatabaseBackupTriggerEvent.class) {
            ...
            protected Object getFailurePayload(DatabaseBackupTriggerEvent payload, Optional<BackupRestoreContext> flowContext, Exception ex) {
                return DatalakeBackupFailedEvent.from(payload, ex, DetailedStackStatus.DATABASE_BACKUP_FAILED);
            }
        };
    }
    ...
    public Action<?, ?> checkForFullBackupStatus() {
        return new AbstractBackupRestoreActions<>(FullBackupInProgressEvent.class) {
            ...
            protected Object getFailurePayload(FullBackupInProgressEvent payload, Optional<BackupRestoreContext> flowContext, Exception ex) {
                return DatalakeBackupFailedEvent.from(payload, ex, DetailedStackStatus.FULL_BACKUP_FAILED);
            }
        };
    }

    @Bean(name = "BACKUP_FINISHED_STATE")
    public Action<?, ?> datalakeBackupFinished() {
        return new AbstractBackupRestoreActions<>(DatalakeBackupSuccess.class) {

            @Override
            protected void doExecute(BackupRestoreContext context, DatalakeBackupSuccess payload, Map<Object, Object> variables) {
    ...
    public Action<?, ?> datalakeBackupFailedAction() {
        return new AbstractBackupRestoreActions<>(DatalakeBackupFailedEvent.class) {
            ...
            @Override
            protected void doExecute(BackupRestoreContext context, DatalakeBackupFailedEvent payload, Map<Object, Object> variables) {
