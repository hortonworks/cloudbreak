...
public abstract class AbstractClusterUpgradePreparationAction<P extends Payload>
        extends AbstractAction<ClusterUpgradePreparationState, ClusterUpgradePreparationStateSelectors, StackContext, P> {
    ...
    protected AbstractClusterUpgradePreparationAction(Class<P> payloadClass) {
        super(payloadClass);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters, StateContext<ClusterUpgradePreparationState,
            ClusterUpgradePreparationStateSelectors> stateContext, P payload) {
