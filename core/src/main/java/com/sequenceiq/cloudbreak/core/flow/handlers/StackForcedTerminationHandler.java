...
@Service
public class StackForcedTerminationHandler extends AbstractFlowHandler<DefaultFlowContext> implements FlowHandler {
    ...
    protected Object execute(Event<DefaultFlowContext> event) throws CloudbreakException {
        ...
        DefaultFlowContext context = (DefaultFlowContext) getFlowFacade().forceTerminateStack(event.getData());
