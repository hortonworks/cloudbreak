...
@Component
public class ManualStackRepairTriggerFlowConfig extends StackStatusFinalizerAbstractFlowConfig<ManualStackRepairTriggerState, ManualStackRepairTriggerEvent> {
