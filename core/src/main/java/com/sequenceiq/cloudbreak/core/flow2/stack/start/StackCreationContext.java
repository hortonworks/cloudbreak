...
public class StackCreationContext extends StackContext {
    ...
    public StackCreationContext(FlowParameters flowParameters, Stack stack, CloudContext cloudContext, CloudCredential cloudCredential, CloudStack cloudStack, ProvisionType provisionType) {
