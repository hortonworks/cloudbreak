...
public enum RollingVerticalScaleEvent implements FlowEvent {
    ...
    ROLLING_VERTICALSCALE_STOP_INSTANCES_EVENT(EventSelectorUtil.selector(RollingVerticalScaleDecommissionInstancesResult.class)),
    ...
    ROLLING_VERTICALSCALE_CLUSTER_MANAGER_COMMISSION_EVENT(EventSelectorUtil.selector(RollingVerticalScaleStartInstancesResult.class)),
    ROLLING_VERTICALSCALE_FINISHED_EVENT(EventSelectorUtil.selector(RollingVerticalScaleCommissionInstancesResult.class)),
