...
abstract class AbstractDiskValidationAction<P extends Payload> extends AbstractStackAction<DiskValidationState, DiskValidationEvent, StackContext, P> {
    ...
    protected AbstractDiskValidationAction(Class<P> payloadClass) {
        super(payloadClass);
    }

    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters, StateContext<DiskValidationState, DiskValidationEvent> stateContext, P payload) {
