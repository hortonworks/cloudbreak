...
@Component
public class UpgradeEmbeddedDBPreparationFlowConfig extends StackStatusFinalizerAbstractFlowConfig<UpgradeEmbeddedDBPreparationState, UpgradeEmbeddedDBPreparationEvent>
    ...
    public FlowTriggerCondition getFlowTriggerCondition() {
        return getApplicationContext().getBean(UpgradeEmbeddedDBPreparationFlowTriggerCondition.class);
    }
