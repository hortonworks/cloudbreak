...
public abstract class AbstractModifyUserDefinedTagsAction<P extends Payload>
        extends AbstractAction<ModifyUserDefinedTagsState, ModifyUserDefinedTagsStateSelectors, StackContext, P> {
    ...
    protected StackContext createFlowContext(FlowParameters flowParameters,
            StateContext<ModifyUserDefinedTagsState, ModifyUserDefinedTagsStateSelectors> stateContext, P payload) {
    ...
    protected Object getFailurePayload(P payload, Optional<StackContext> flowContext, Exception ex) {
        return new ModifyUserDefinedTagsFailedEvent(payload.getResourceId(), "Unexpected error during action", ex);
    }
}
