...
public abstract class AbstractClusterUpgradeValidationAction<P extends Payload>
        extends AbstractAction<FlowState, FlowEvent, StackContext, P> {
    ...
    @Override
    protected StackContext createFlowContext(FlowParameters flowParameters, StateContext<FlowState, FlowEvent> stateContext, P payload) {
