...
public enum RestartEvent implements FlowEvent {
    ...
    RESTART_FINISHED_EVENT(CloudPlatformResult.selector(RebootInstancesResult.class)),
    RESTART_FAILURE_EVENT(CloudPlatformResult.failureSelector(RebootInstancesResult.class)),
