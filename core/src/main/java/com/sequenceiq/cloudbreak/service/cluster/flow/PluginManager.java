...
public interface PluginManager {
    ...
    void prepareKeyValues(ConsulClientConfig clientConfig, Map<String, String> keyValues);

    Map<String, Set<String>> installPlugins(ConsulClientConfig clientConfig, Map<String, PluginExecutionType> plugins, Set<String> hosts);
