...
@Component
public class FilterBasedImageCatalogService implements ImageCatalogService {

    private static final Logger LOGGER = LoggerFactory.getLogger(FilterBasedImageCatalogService.class);
    ...
    public StatedImages getImages(CloudbreakImageCatalogV3 imageCatalogV3, ImageFilter imageFilter) {
        return filterBasedImageProvider.getImages(imageCatalogV3, imageFilter);
    }
    ...
    public ImageFilterResult getImageFilterResult(CloudbreakImageCatalogV3 imageCatalogV3) {
        ...
        LOGGER.debug("{} image id(s) found", imageIds.size());
        String message = String.format("%d image id(s) found", imageIds.size());
    ...
    private Set<String> getImageIds(CloudbreakImageCatalogV3 imageCatalogV3) {
        ...
        for (CloudbreakVersion exactMatchedImg : cbVersionsFromImageCatalog) {
