...
public class ClusterCommonService {
    ...
    public Response put(Long stackId, UpdateClusterJson updateJson, Long organizationId) {
        ...
        if (updateJson.getBlueprintId() != null && updateJson.getHostgroups() != null && stack.getCluster().isCreateFailed()) {
            ...
            try {
                recreateCluster(stackId, updateJson, organizationId);
    ...
    private void recreateCluster(Long stackId, UpdateClusterJson updateJson, Long organizationId) throws TransactionExecutionException {
        Set<HostGroup> hostGroups = new HashSet<>();
        for (HostGroupRequest json : updateJson.getHostgroups()) {
            HostGroup hostGroup = conversionService.convert(json, HostGroup.class);
            hostGroup = hostGroupDecorator.decorate(hostGroup, json, stackId, false, organizationId);
