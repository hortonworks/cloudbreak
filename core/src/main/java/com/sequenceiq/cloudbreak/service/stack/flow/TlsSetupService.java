...
public class TlsSetupService {
    ...
    public void generateCertAndSaveForStack(Stack stack) {
        ...
        try {
            ...
            securityConfig.setUserFacingCert(String.join("\n", certs));
            securityConfigService.save(securityConfig);
        } catch (IOException e) {
            throw new CloudbreakServiceException("The cert could not be generated by Cluster DNS generator service: " + e.getMessage(), e);
        }
    }
