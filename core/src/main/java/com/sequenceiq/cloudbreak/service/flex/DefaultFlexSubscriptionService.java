...
@Service
public class DefaultFlexSubscriptionService extends AbstractOrganizationAwareResourceService<FlexSubscription> implements LegacyFlexSubscriptionService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultFlexSubscriptionService.class);
