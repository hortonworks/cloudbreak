...
public class CredentialParameterSetterUtil {
    ...
    public void setProperParameters(String cloudPlatform, CredentialV4Base response, Map<String, Object> parameters) {
        if (CloudPlatform.AWS.name().equals(cloudPlatform)) {
            ...
            response.setAzure(exec(() -> new Json(parameters).get(AzureCredentialV4Parameters.class), AzureCredentialV4Parameters.class));
