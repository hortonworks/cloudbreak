...
public class DetermineDatalakeDataSizesService {
    ...
    public void determineDatalakeDataSizes(Stack stack) {
        MDCBuilder.buildMdcContext(stack);
        LOGGER.info("Initiating determination of datalake data sizes for stack {}", stack.getId());
        flowManager.triggerDetermineDatalakeDataSizes(stack.getId());
    }
}
