...
@Service
public class DefaultLdapConfigService extends AbstractOrganizationAwareResourceService<LdapConfig> implements LegacyLdapConfigService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultLdapConfigService.class);
