...
public class FinalizationCleanUpService {
    ...
    public void detachClusterComponentRelatedAuditEntries() throws CleanUpException {
        ...
        executeCleanUp(() -> clusterComponentConfigProvider.cleanUpDetachedEntries(clusterService.findDeletedClusterIds()), ClusterComponentHistoryView.class);
    }
    ...
    public void cleanUpStructuredEventsForTenant(String tenantName) {
        structuredEventDBService.deleteEntriesForTenantThatIsOlderThanThreeMonths(tenantName);
    }
