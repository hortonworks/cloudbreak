...
public class ComponentLocatorService {
    ...
    public Map<String, List<String>> getComponentPrivateIp(Long clusterId, BlueprintTextProcessor blueprintTextProcessor, Collection<String> componentNames) {
    ...
    private Map<String, List<String>> getComponentAttribute(Long clusterId, BlueprintTextProcessor blueprintTextProcessor, Collection<String> componentNames,
            Function<InstanceMetaData, String> getterFunction) {
        Map<String, List<String>> result = new HashMap<>();
