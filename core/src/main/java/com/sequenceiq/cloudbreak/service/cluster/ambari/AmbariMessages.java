...
public enum AmbariMessages {
    ...
    AMBARI_CLUSTER_SERVICES_STARTING_FAILED("ambari.cluster.services.starting.failed"),
    ...
    AMBARI_CLUSTER_SERVICES_STOPPING_FAILED("ambari.cluster.services.stopping.failed");
