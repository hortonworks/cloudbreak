...
public class GcpResourceReadyPollerObject extends StackContext {
    ...
    public GcpResourceReadyPollerObject(Compute.ZoneOperations.Get zoneOperations, Stack stack, String name, String operationName, ResourceType resourceType) {
        super(stack);
    ...
    public GcpResourceReadyPollerObject(Compute.RegionOperations.Get regionOperations, Stack stack, String name, String operationName,
    ...
    public GcpResourceReadyPollerObject(Compute.GlobalOperations.Get globalOperations, Stack stack, String name, String operationName,
            ResourceType resourceType) {
        super(stack);
