...
import static com.sequenceiq.cloudbreak.cmtemplate.CMRepositoryVersionUtil.CLOUDERAMANAGER_VERSION_7_13_2_30000;
...
public class CLOServiceRdsConfigProvider extends AbstractRdsConfigProvider {
    ...
    protected boolean isRdsConfigNeeded(StackDtoDelegate stackDtoDelegate) {
        ...
        return clouderaManagerRepoDetails != null
                ...
                && isVersionNewerOrEqualThanLimited(clouderaManagerRepoDetails::getVersion, CLOUDERAMANAGER_VERSION_7_13_2_30000);
    }
}
