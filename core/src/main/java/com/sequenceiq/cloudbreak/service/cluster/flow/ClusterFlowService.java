...
public class ClusterFlowService {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ClusterFlowService.class);
    ...
    @Measure(ClusterFlowService.class)
    ...
    private void triggerClusterInstall(Stack stack) {
    ...
    public Cluster recreate(Stack stack, String blueprintName, Set<HostGroup> hostGroups, boolean validateBlueprint,
            StackRepoDetails stackRepoDetails) throws TransactionService.TransactionExecutionException {
        return transactionService.required(() -> {
            ...
            triggerClusterInstall(stackWithLists);
