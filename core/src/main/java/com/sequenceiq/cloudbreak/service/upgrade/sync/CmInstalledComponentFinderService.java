...
public class CmInstalledComponentFinderService {
    ...
    void findParcelComponents(Stack stack, Set<Image> candidateImages, Set<Component> syncedFromServer) {
    ...
    void findCmRepoComponent(Stack stack, Set<Image> candidateImages, Set<Component> syncedComponents) {
