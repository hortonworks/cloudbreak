...
public class CmInstalledComponentFinderService {
    ...
    CmParcelSyncOperationResult findParcelComponents(Stack stack, Set<Image> candidateImages) {
    ...
    CmRepoSyncOperationResult findCmRepoComponent(Stack stack, Set<Image> candidateImages) {
