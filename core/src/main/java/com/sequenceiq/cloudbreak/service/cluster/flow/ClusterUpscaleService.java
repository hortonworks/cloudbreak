...
public class ClusterUpscaleService {
    ...
    public void addClusterContainers(Long stackId, String cloudPlatform, String hostGroupName, Integer scalingAdjustment) throws CloudbreakException {
        ...
        if (orchestratorType.containerOrchestrator()) {
            Map<String, List<Container>> containers = containerRunner.addClusterContainers(stackId, cloudPlatform, hostGroupName, scalingAdjustment);
        ...
        instanceMetadataService.updateInstanceStatus(stack.getInstanceGroups(), InstanceStatus.REGISTERED, allHosts);
