...
@Service
public class DatabaseInstanceTypeService {

    private static final Logger LOGGER = LoggerFactory.getLogger(DatabaseInstanceTypeService.class);
    ...
    public DatabaseInstanceTypesV4Response listDatabaseInstanceTypes(String environmentCrn, DatabaseCapabilityType databaseType, String architecture) {
        ...
        LOGGER.info("Returning {} curated database instance types for datahub in region {} (default: {})", filtered.size(), region, defaultInstanceType);
