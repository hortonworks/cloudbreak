...
@Provider
class SpringBadRequestExceptionMapper : ExceptionMapper<BadRequestException> {
    ...
    companion object {
        ...
        private val LOGGER = LoggerFactory.getLogger(SpringBadRequestExceptionMapper::class.java)
    }
}