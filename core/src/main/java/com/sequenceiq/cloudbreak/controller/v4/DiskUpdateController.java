...
public class DiskUpdateController implements DiskUpdateEndpoint {
    ...
    @Override
    @AccountIdNotNeeded
    public void updateDiskTypeAndSize(DiskModificationRequest diskModificationRequest) throws Exception {
    ...
    @Override
    @AccountIdNotNeeded
    public FlowIdentifier resizeDisks(long stackId, String instanceGroup) throws Exception {
        return diskUpdateService.resizeDisks(stackId, instanceGroup);
    }
}
