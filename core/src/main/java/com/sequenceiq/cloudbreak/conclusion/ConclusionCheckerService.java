...
public class ConclusionCheckerService {
    ...
    public void runConclusionChecker(Long resourceId, String eventType, ResourceEvent resourceEvent, String... eventMessageArgs) {
        try {
    ...
    private static String[] getFullEventMessageArgs(String[] eventMessageArgs, ConclusionResult conclusionResult) {
        ...
        fullEventMessageList.add(conclusionResult.getConclusionTexts().toString());
