...
public class RollingVerticalScaleCommissionInstancesResult extends StackEvent {

    private final RollingVerticalScaleResult rollingVerticalScaleResult;

    @JsonCreator
    public RollingVerticalScaleCommissionInstancesResult(
    ...
    public String toString() {
        return new StringJoiner(", ", RollingVerticalScaleCommissionInstancesResult.class.getSimpleName() + "[", "]")
