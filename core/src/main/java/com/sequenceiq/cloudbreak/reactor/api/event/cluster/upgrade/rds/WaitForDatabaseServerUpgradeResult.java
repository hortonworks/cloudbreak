...
public class WaitForDatabaseServerUpgradeResult extends AbstractUpgradeRdsEvent {
    private final FlowIdentifier flowIdentifier;

    @JsonCreator
    public WaitForDatabaseServerUpgradeResult(
    ...
    public String toString() {
        return "WaitForDatabaseServerUpgradeResult{" +
