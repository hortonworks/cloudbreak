...
public class RollingVerticalScaleStopInstancesResult extends StackEvent {
    private final RollingVerticalScaleResult rollingVerticalScaleResult;

    @JsonCreator
    public RollingVerticalScaleStopInstancesResult(
            @JsonProperty("resourceId") Long resourceId,
            @JsonProperty("rollingVerticalScaleResult") RollingVerticalScaleResult result) {
        super(ROLLING_VERTICALSCALE_SCALE_INSTANCES_EVENT.event(), resourceId);
    ...
    public String toString() {
        return new StringJoiner(", ", RollingVerticalScaleStopInstancesResult.class.getSimpleName() + "[", "]")
