    ...
    public void loadBlueprintsFromFile() {
        ...
        for (String blueprintText : blueprints) {
            try {
                ...
                if (clusterDefinitionUtils.isBlueprintNamePreConfigured(blueprintText, split)) {
                    ...
                    JsonNode jsonNode = clusterDefinitionUtils.convertStringToJsonNode(clusterDefinitionUtils.readDefaultBlueprintFromFile(split));
                    ...
                    Map<String, Object> tagParameters = clusterDefinitionUtils.prepareTags(tags);
