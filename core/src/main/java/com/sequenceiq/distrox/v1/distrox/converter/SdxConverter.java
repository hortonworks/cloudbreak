    ...
    public SharedServiceV4Request getSharedService(SdxClusterResponse sdx) {
        ...
        if (sdx.getStatus() != SdxClusterStatusResponse.RUNNING) {
            throw new BadRequestException(
                    String.format("You current Environment %s contains one Data Lake the name of which is %s. " +
                            ...
                            "If your Data Lake has failed to provision state please check our documentation " +
