...
<html>
    ...
    <body style="font-size:16px; line-height:24px; color:#333333; font-family:Arial, Helvetica, sans-serif; " >
        <table width="100%" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto; " >
            <tr >
                <td >
                    <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto; border:1px solid #dbdbdb; " class="deviceWidth" >
                        <tr >
                            <td style="font-size:1px; line-height:0px; " class="responsive hide" >
                                <div class="mktEditable" id="banner-above" ><img src="http://info.hortonworks.com/rs/h2source/images/banner-above.jpg" alt="" border="0"></div>
                            </td>
                        </tr>
                        <tr >
                        ...
                        <tr >
                            <td style="font-size:1px; line-height:0px; " class="responsive hide" >
                                <div class="mktEditable" id="banner-below" ><img src="http://info.hortonworks.com/rs/h2source/images/banner-below.jpg" alt="" border="0"></div>
                            </td>
                        </tr>
                        <tr >
                            <td >
                                <table width="540" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto; " class="deviceWidth1" >
                                    ...
                                    <tr >
                                        <td style="font-size:30px; line-height:35px; font-family:Arial, Helvetica, sans-serif; color:#69be28; text-align:center; " >
                                            <div class="mktEditable" id="heading" ><strong>Hello</strong></div>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr >
                                        <td style="font-size:20px; line-height:24px; font-family:Arial, Helvetica, sans-serif; color:#333333; text-align:center; " >
                                            <div class="mktEditable" id="sub-heading" ><em>${text}</em></div>
                                        </td>
                                    </tr>
                                    </#if>
                                    <tr>
                                    ...
                                    <#if state == "TERMINATION_SUCCESS">
                                    <tr >
                                        <td style="font-size:16px; line-height:24px; color:#333333; font-family:Arial, Helvetica, sans-serif; text-align:center; " >
                                    ...
                                    <tr >
                                        <td style="font-size:16px; line-height:24px; color:#333333; font-family:Arial, Helvetica, sans-serif; text-align:center; " >
                                            <div class="mktEditable" id="text" >
                                                <p>Click the following link to go to your <#if hwx_cloud>Hortonworks Data Cloud instance:<#else> your cluster</#if><br /> <br /></p>
