...
UPDATE instancemetadata SET instancestatus = 'REGISTERED' WHERE instancestatus = 'WAITING_FOR_REPAIR';
UPDATE instancemetadata SET instancestatus = 'DECOMMISSIONED' WHERE instancestatus = 'DELETE_REQUESTED';
