-- // CB-388 renaming from blueprint to cluster definition
...
ALTER TABLE ONLY clusterdefinition RENAME COLUMN ambariname TO stackname;
...
ALTER TABLE ONLY clusterdefinition RENAME COLUMN stackname TO ambariname;
