...
class ClusterUpgradeDiskSpaceValidationHandlerTest {
    ...
    private HandlerEvent<ClusterUpgradeDiskSpaceValidationEvent> createEvent() {
        ...
        return new HandlerEvent<>(new Event<>(new ClusterUpgradeDiskSpaceValidationEvent(VALIDATE_DISK_SPACE_EVENT.selector(), STACK_ID,
                clusterUpgradeProperties.getTargetImageId(), clusterUpgradeProperties, REQUIRED_FREE_SPACE)));
    }
}