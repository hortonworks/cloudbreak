...
class CoreValidateEnableSeLinuxHandlerTest {
    ...
    @InjectMocks
    private CoreValidateEnableSeLinuxHandler underTest;

    private CoreValidateEnableSeLinuxHandlerEvent event;
    ...
    @BeforeEach
    void setUp() {
        event = new CoreValidateEnableSeLinuxHandlerEvent(1L);
    }
    ...
    void testValidateEnableSeLinuxHandlerSuccess() throws CloudbreakOrchestratorFailedException {
        ...
        assertEquals(ENABLE_SELINUX_CORE_EVENT.selector(), response.getSelector());
    ...
    @Test
    void testSelector() {
        assertEquals(EventSelectorUtil.selector(CoreValidateEnableSeLinuxHandlerEvent.class), underTest.selector());
    }
