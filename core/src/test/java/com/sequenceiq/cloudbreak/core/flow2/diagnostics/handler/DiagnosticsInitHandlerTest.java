...
public class DiagnosticsInitHandlerTest {
    ...
    @InjectMocks
    private DiagnosticsInitHandler underTest;
    ...
    @BeforeEach
    public void setUp() {
        underTest = new DiagnosticsInitHandler();
    ...
    public void testDoAccept() throws CloudbreakOrchestratorFailedException {
        ...
        // WHEN
        DiagnosticsCollectionEvent event = new DiagnosticsCollectionEvent(INIT_DIAGNOSTICS_EVENT.selector(), STACK_ID, "crn",
    ...
    public void testDoAcceptOnError() throws CloudbreakOrchestratorFailedException {
        ...
        // WHEN
        DiagnosticsCollectionEvent event = new DiagnosticsCollectionEvent(INIT_DIAGNOSTICS_EVENT.selector(),
    ...
    public void testFailureType() {
        assertEquals(UsageProto.CDPVMDiagnosticsFailureType.Value.INITIALIZATION_FAILURE, underTest.getFailureType());
    }

    @Test
    public void testSelector() {
        assertEquals(INIT_DIAGNOSTICS_EVENT.selector(), underTest.selector());
    }
