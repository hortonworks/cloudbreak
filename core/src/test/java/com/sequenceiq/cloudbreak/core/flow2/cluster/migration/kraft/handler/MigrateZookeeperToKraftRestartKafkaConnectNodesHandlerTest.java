...
public class MigrateZookeeperToKraftRestartKafkaConnectNodesHandlerTest {
    ...
    void testDoAcceptSuccess() {
        ...
        verify(clusterModificationService).rollingRestartServiceRoleByType(KAFKA_SERVICE_TYPE, KAFKA_CONNECT_ROLE, false);
    }
    ...
    void testDoAcceptSuccessWhenStaleConfigsOnlyRestartNeeded() {
        ...
        assertInstanceOf(MigrateZookeeperToKraftEvent.class, result);
        assertEquals(START_MIGRATE_ZOOKEEPER_TO_KRAFT_EVENT.name(), result.getSelector());
        verify(clusterModificationService).rollingRestartServiceRoleByType(KAFKA_SERVICE_TYPE, KAFKA_CONNECT_ROLE, true);
    }
    ...
    void testDoAcceptSuccessWhenConnectRoleNotFound() {
        ...
        verify(clusterModificationService, times(0)).rollingRestartServiceRoleByType(KAFKA_SERVICE_TYPE, KAFKA_CONNECT_ROLE, false);
    }
    ...
    void testDoAcceptFailure() {
        ...
        doThrow(new RuntimeException("error")).when(clusterModificationService)
                .rollingRestartServiceRoleByType(KAFKA_SERVICE_TYPE, KAFKA_CONNECT_ROLE, false);
