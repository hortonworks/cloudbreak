...
class ExternalDatabaseServiceTest {
    ...
    void upgradeDatabaseFlowFailed() {
        ...
        CloudbreakServiceException cloudbreakServiceException = assertThrows(CloudbreakServiceException.class,
                () -> underTest.upgradeDatabase(cluster, targetMajorVersion));
        String expected = String.format("Database flow failed in Redbeams with error: 'upgrade error happened'. Database crn: %s, flow: "
                        + "FlowIdentifier{type=FLOW, pollableId='%s'}",
    ...
    void rotateDatabaseSecretsShouldFailIfRedbeamsFlowChainIsNotTriggered() {
        ...
        String expected = String.format("Database flow failed in Redbeams with error: 'Flow null not triggered'. Database crn: %s, flow: "
    ...
    void rotateDatabaseSecretsShouldFailIfRedbeamsFlowChainFailed() {
        ...
        String expected = String.format("Database flow failed in Redbeams with error: '%s'. Database crn: %s, flow: FlowIdentifier{type=%s, pollableId='%s'}",
