...
public class DiagnosticsCollectionHandlerTest {

    private static final Long STACK_ID = 1L;

    @InjectMocks
    private DiagnosticsCollectionHandler underTest;
    ...
    @BeforeEach
    public void setUp() {
        underTest = new DiagnosticsCollectionHandler();
    ...
    public void testDoAccept() throws CloudbreakOrchestratorFailedException {
        ...
        // WHEN
        DiagnosticsCollectionEvent event = new DiagnosticsCollectionEvent(COLLECT_DIAGNOSTICS_EVENT.selector(), STACK_ID, "crn",
    ...
    public void testDoAcceptOnError() throws CloudbreakOrchestratorFailedException {
        ...
        // WHEN
        DiagnosticsCollectionEvent event = new DiagnosticsCollectionEvent(COLLECT_DIAGNOSTICS_EVENT.selector(),
    ...
    public void testFailureType() {
        assertEquals(UsageProto.CDPVMDiagnosticsFailureType.Value.COLLECTION_FAILURE, underTest.getFailureType());
    }

    @Test
    public void testSelector() {
        assertEquals(COLLECT_DIAGNOSTICS_EVENT.selector(), underTest.selector());
    }
