...
public class CredentialRequestToCredentialConverterTest {
    ...
    public void testGovCloudFlagConversion() {
        when(credentialDefinitionService.processProperties(any(), any())).thenReturn(createParametersWithGovCloud(govCloud));

        Credential credential = underTest.convert(new CredentialRequest());
