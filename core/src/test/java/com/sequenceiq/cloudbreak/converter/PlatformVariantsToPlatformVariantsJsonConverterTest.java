...
public class PlatformVariantsToPlatformVariantsJsonConverterTest extends AbstractEntityConverterTest<PlatformVariants> {
    ...
    private PlatformVariantsToPlatformVariantsJsonConverter underTest;

    @Before
    public void setUp() {
        underTest = new PlatformVariantsToPlatformVariantsJsonConverter();
    }
