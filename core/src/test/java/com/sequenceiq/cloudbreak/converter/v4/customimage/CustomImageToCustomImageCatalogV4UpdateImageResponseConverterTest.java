...
public class CustomImageToCustomImageCatalogV4UpdateImageResponseConverterTest {
    ...
    private CustomImageToCustomImageCatalogV4UpdateImageResponseConverter victim;

    @BeforeEach
    public void initTest() {
        victim = new CustomImageToCustomImageCatalogV4UpdateImageResponseConverter();
    }
