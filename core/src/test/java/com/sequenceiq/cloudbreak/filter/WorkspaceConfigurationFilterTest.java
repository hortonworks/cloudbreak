...
public class WorkspaceConfigurationFilterTest {
    ...
    public void filterWhenCbUserWithCrnAndWorkspaceExist() throws ServletException, IOException {
        ...
        verify(workspaceService, times(1)).getByName(eq(Crn.fromString(cbUser.getCrn()).getAccountId()), any());
    ...
    public void filterWhenWorkspaceDoesntExistAndCrnIsPresent() throws ServletException, IOException {
        ...
        assertEquals(Crn.fromString(cbUser.getCrn()).getAccountId(), workspaceCaptor.getValue().getName());
    ...
    private CloudbreakUser createCbUserWithCrn() {
        return new CloudbreakUser("userId", "username", "email", "tenant", Crn.builder()
            .setAccountId("1")
            .setResource("1")
    ...
    private CloudbreakUser createCbUserWithoutCrn() {
        return new CloudbreakUser("userId", "username", "email", "tenant", null);
    }
