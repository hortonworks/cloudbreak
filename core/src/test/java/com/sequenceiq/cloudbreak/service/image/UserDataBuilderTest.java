...
public class UserDataBuilderTest {
    ...
    public void testBuildUserDataAzure() throws IOException {
        ...
        Map<InstanceGroupType, String> userdata = userDataBuilder.buildUserData(Platform.platform("AZURE_RM"), "ssh-rsa public", "ssh-rsa test", "cloudbreak",
                getPlatformParameters(), true, "pass");
