...
class JavaVersionUpgradeValidatorTest {
    ...
    public void testValidate(String targetRuntimeVersion, Integer currentJavaVersion, boolean shouldPermitUpgrade, String containedMessage) {
    ...
    private static Stream<Arguments> provideTestParameters() {
        return Stream.of(
                Arguments.of("7.3.0", 8, true, null),
                Arguments.of("7.3.0", 11, true, null),
                Arguments.of("7.3.0", 17, true, null),
                Arguments.of("7.3.1", 8, true, null),
                Arguments.of("7.3.1", 11, false, "You cannot upgrade to 7.3.1 because your current cluster uses JDK 11"),
                Arguments.of("7.3.1", 17, true, null),
                Arguments.of("7.3.2", 8, false, "You cannot upgrade to 7.3.2 because your current cluster uses JDK 8"),
                Arguments.of("7.3.2", 11, false, "You cannot upgrade to 7.3.2 because your current cluster uses JDK 11"),
                Arguments.of("7.3.2", 17, true, null)
        );
    }
