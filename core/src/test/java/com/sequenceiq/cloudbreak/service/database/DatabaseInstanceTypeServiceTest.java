...
class DatabaseInstanceTypeServiceTest {
    ...
    @InjectMocks
    private DatabaseInstanceTypeService underTest;
    ...
    void filtersByMatchingCpuAndMemory() {
        ...
        List<DatabaseInstanceTypeV4> result = DatabaseInstanceTypeService.filterByDefaultSpec(
    ...
    @Test
    void returnsFallbackWhenVmTypesEmpty() {
        List<DatabaseInstanceTypeV4> result = DatabaseInstanceTypeService.filterByDefaultSpec(
                Set.of(), "db.m5.large", List.of("db.m5.xlarge"));
