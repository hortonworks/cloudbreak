...
public class StackMatrixServiceTest {
    ...
    public void getStackMatrix() {
        ...
        assertEquals(2L, stackMatrixV4.getHdf().size());
        assertEquals(3L, stackMatrixV4.getHdp().size());

        assertEquals("2.6", stackMatrixV4.getHdf().get("3.1").getMinAmbari());
        assertEquals("3.1.2.0", stackMatrixV4.getHdf().get("3.1").getVersion());
        assertEquals("2.6.1.0", stackMatrixV4.getHdf().get("3.1").getAmbari().getVersion());
        assertEquals("http://redhat6-base/2.6.1.0", stackMatrixV4.getHdf().get("3.1").getAmbari().getRepo().get("redhat6").getBaseUrl());

        assertEquals("2.7", stackMatrixV4.getHdf().get("3.2").getMinAmbari());
        assertEquals("3.2.4.1", stackMatrixV4.getHdf().get("3.2").getVersion());
        assertEquals("2.7.0.3", stackMatrixV4.getHdf().get("3.2").getAmbari().getVersion());
        assertEquals("http://redhat7-base/2.7.0.3", stackMatrixV4.getHdf().get("3.2").getAmbari().getRepo().get("redhat7").getBaseUrl());

        assertEquals("2.5", stackMatrixV4.getHdp().get("2.6").getMinAmbari());
        assertEquals("2.6.5.0", stackMatrixV4.getHdp().get("2.6").getVersion());
        assertEquals("2.5.0.0", stackMatrixV4.getHdp().get("2.6").getAmbari().getVersion());
        assertEquals("http://redhat6-base/2.5.0.0", stackMatrixV4.getHdp().get("2.6").getAmbari().getRepo().get("redhat6").getBaseUrl());

        assertEquals("2.7", stackMatrixV4.getHdp().get("3.1").getMinAmbari());
        assertEquals("3.1.8.0", stackMatrixV4.getHdp().get("3.1").getVersion());
        assertEquals("2.7.0.3", stackMatrixV4.getHdp().get("3.1").getAmbari().getVersion());
        assertEquals("http://redhat7-base/2.7.0.3", stackMatrixV4.getHdp().get("3.1").getAmbari().getRepo().get("redhat7").getBaseUrl());
    }
    ...
    public void getStackMatrixWithoutAmbari() {
        ...
        assertEquals("2.6", stackMatrixV4.getHdf().get("3.1").getMinAmbari());
        assertEquals("3.1.2.0", stackMatrixV4.getHdf().get("3.1").getVersion());
        assertNull(stackMatrixV4.getHdf().get("3.1").getAmbari().getRepo());
        assertNull(stackMatrixV4.getHdf().get("3.1").getAmbari().getVersion());

        assertEquals("2.7", stackMatrixV4.getHdf().get("3.2").getMinAmbari());
        assertEquals("3.2.4.1", stackMatrixV4.getHdf().get("3.2").getVersion());
        assertNull(stackMatrixV4.getHdf().get("3.2").getAmbari().getRepo());
        assertNull(stackMatrixV4.getHdf().get("3.2").getAmbari().getVersion());

        assertEquals("2.5", stackMatrixV4.getHdp().get("2.6").getMinAmbari());
        assertEquals("2.6.5.0", stackMatrixV4.getHdp().get("2.6").getVersion());
        assertNull(stackMatrixV4.getHdp().get("2.6").getAmbari().getRepo());
        assertNull(stackMatrixV4.getHdp().get("2.6").getAmbari().getVersion());

        assertEquals("2.7", stackMatrixV4.getHdp().get("3.1").getMinAmbari());
        assertEquals("3.1.8.0", stackMatrixV4.getHdp().get("3.1").getVersion());
        assertNull(stackMatrixV4.getHdp().get("3.1").getAmbari().getRepo());
        assertNull(stackMatrixV4.getHdp().get("3.1").getAmbari().getVersion());
    }
