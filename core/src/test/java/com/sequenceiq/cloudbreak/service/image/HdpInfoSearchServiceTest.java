...
public class HdpInfoSearchServiceTest {
    ...
    public void testWithNotExsisting() {
        ...
        Assert.assertNull("HDP info shall be null for non existing combination", hdpInfo);
    ...
    @Test
    public void testExactVersionWithUnspecifiedCbVersion() {
    ...
    @Test
    public void testExactVersionWithNullCbVersion() {
    ...
    @Test
    public void testExactVersionWithSpecificCbVersion() {
        ReflectionTestUtils.setField(underTest, "cbVersion", "1.4-rc1");

        HDPInfo hdpInfo = underTest.searchHDPInfo("2.5", "2.4");
    ...
    @Test
    public void testExactVersionWithSpecificCbVersionThatDoesNotExist() {
        ReflectionTestUtils.setField(underTest, "cbVersion", "1.4-rc2");

        HDPInfo hdpInfo = underTest.searchHDPInfo("2.5", "2.4");
        Assert.assertNull("HDP info shall be null for non existing combination", hdpInfo);

        hdpInfo = underTest.searchHDPInfo("2.5", "2.5");
        Assert.assertNull("HDP info shall be null for non existing combination", hdpInfo);
    }

    @Test
    public void testExactVersionWithEmptyCbVersion() {
