...
public class WorkspaceModificationVerifierServiceTest {
    ...
    public void testAuthorizeWorkspaceManipulationWithAccess() {
        when(altusAuthorizationService.getUsersOfWorkspace(any(), any())).thenReturn(Sets.newHashSet(initiator));
        doNothing().when(altusAuthorizationService).checkRightOfUserForResource(any(), any(), any(), any());
    ...
    public void testAuthorizeWorkspaceManipulationWithNoManagePermission() {
        when(altusAuthorizationService.getUsersOfWorkspace(any(), any())).thenReturn(Sets.newHashSet(initiator));
        doThrow(AccessDeniedException.class).when(altusAuthorizationService).checkRightOfUserForResource(any(), any(), any(), any(), anyString());
    ...
    public void testAuthorizeWorkspaceManipulationWhenUserIsNotPartOfWs() {
        when(altusAuthorizationService.getUsersOfWorkspace(any(), any())).thenReturn(Sets.newHashSet());
        doNothing().when(altusAuthorizationService).checkRightOfUserForResource(any(), any(), any(), any());
    ...
    public void testValidateAllUsersAreAlreadyInTheWorkspace() {
        ...
        when(altusAuthorizationService.getUsersOfWorkspace(any(), any())).thenReturn(users);
    ...
    public void testValidateAllUsersAreAlreadyInTheWorkspaceWithUsersNotInWs() {
        ...
        user2.setTenant(testTenant);
        Set<User> users = Set.of(user1, user2);
        when(altusAuthorizationService.getUsersOfWorkspace(any(), any())).thenReturn(Sets.newHashSet(user1));
