...
public class DefaulClusterDefinitionCacheTest {
    ...
    public void testOnlyReleasedBps() throws IOException {
        ...
        when(clusterDefinitionUtils.convertStringToJsonNode(any())).thenReturn(bpText1);
        ...
        when(clusterDefinitionUtils.convertStringToJsonNode(any())).thenReturn(bpText2);

        when(clusterDefinitionUtils.isBlueprintNamePreConfigured(anyString(), any())).thenReturn(true);
