...
public class HdfConfigProviderTest {
    ...
    public void testNifiNodeIdentitiesWhenMasterIsAvailable() throws IOException {
        String blueprintText = FileReaderUtils.readFileFromClasspath("blueprints/bp-kerberized-test.bp");
        ...
        when(blueprintProcessor.getHostGroupsWithComponent(blueprintText, "NIFI_MASTER")).thenReturn(Sets.newHashSet("master"));
        ...
        verify(blueprintProcessor, times(1)).getHostGroupsWithComponent(blueprintText, "NIFI_MASTER");
    }
