...
public class DatabaseMigrationConfig {
    ...
    private static final String DEFAULT_SCHEMA_LOCATION_IN_SOURCE = "usersync/src/main/resources/schema";
    ...
    @Value("${usersync.schema.scripts.location:" + DEFAULT_SCHEMA_LOCATION_IN_SOURCE + '}')
    private String schemaLocation;

    @Value("${usersync.schema.migration.auto:true}")
