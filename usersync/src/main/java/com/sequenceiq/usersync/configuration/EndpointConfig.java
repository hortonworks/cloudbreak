...
import com.sequenceiq.usersync.controller.mapper.DefaultExceptionMapper;
import com.sequenceiq.usersync.controller.mapper.WebApplicaitonExceptionMapper;

import io.swagger.jaxrs.config.BeanConfig;
import io.swagger.jaxrs.config.SwaggerConfigLocator;
import io.swagger.jaxrs.config.SwaggerContextService;

@ApplicationPath(UsersyncApi.API_ROOT_CONTEXT)
@Configuration
public class EndpointConfig extends ResourceConfig {
    ...
    @Value("${usersync.structuredevent.rest.enabled:false}")
    ...
    private void registerSwagger() {
        ...
        swaggerConfig.setTitle("Usersync API");
        ...
        swaggerConfig.setBasePath(UsersyncApi.API_ROOT_CONTEXT);
        swaggerConfig.setLicenseUrl("https://github.com/sequenceiq/cloudbreak/blob/master/LICENSE");
        swaggerConfig.setResourcePackage("com.sequenceiq.usersync.api");
