...
public interface DistroXAutoScaleClusterV1Endpoint {
    ...
    @Operation(summary =  ClusterOpDescription.CLUSTER_GET_ALL, description =  DistroXClusterNotes.NOTES)
    List<DistroXAutoscaleClusterResponse> getClusters();

    @GET
    @Path("crn/{crn}")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary =  ClusterOpDescription.CLUSTER_GET, description =  DistroXClusterNotes.NOTES)
    ...
    @Path("name/{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(summary =  ClusterOpDescription.CLUSTER_DELETE_ALERTS, description =  DistroXClusterNotes.NOTES)
