...
**Please note that authorization-related annotations should be applied to Controller classes, while validation-related annotations should be used on Endpoint interfaces.**
