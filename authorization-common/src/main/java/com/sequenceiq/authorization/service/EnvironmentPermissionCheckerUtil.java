...
public class EnvironmentPermissionCheckerUtil {
    ...
    public static List<String> getResourceCrnList(ProceedingJoinPoint proceedingJoinPoint, MethodSignature methodSignature) {
        Object result = getParameter(proceedingJoinPoint, methodSignature, ResourceCrnList.class);
    ...
    public static List<String> getResourceNameList(ProceedingJoinPoint proceedingJoinPoint, MethodSignature methodSignature) {
        Object result = getParameter(proceedingJoinPoint, methodSignature, ResourceNameList.class);
        return (List<String>) result;
    }
