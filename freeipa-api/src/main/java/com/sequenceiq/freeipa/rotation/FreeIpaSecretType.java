...
public enum FreeIpaSecretType implements SecretType {
    ...
    FREEIPA_SALT_SIGN_KEY_PAIR(List.of(VAULT, CUSTOM_JOB), Set.of(SKIP_SALT_UPDATE)),
    ...
    FREEIPA_LUKS_VOLUME_PASSPHRASE(List.of(CUSTOM_JOB, SALT_STATE_APPLY)),
    USER_KEYPAIR(List.of(SALT_STATE_RUN, CUSTOM_JOB)),
    FREEIPA_SALT_PASSWORD(List.of(CUSTOM_JOB), Set.of(SKIP_SALT_UPDATE));
