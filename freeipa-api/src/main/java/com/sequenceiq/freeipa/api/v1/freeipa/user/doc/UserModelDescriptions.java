...
public class UserModelDescriptions {
    ...
    public static final String USERSYNC_OPTIONAL_ENVIRONMENT_CRNS = "Optional environment crns to sync";
    public static final String USERSYNC_OPTIONAL_USER_CRNS = "Optional user crns to sync";
    public static final String USERSYNC_OPTIONAL_MACHINEUSER_CRNS = "Optional machine user crns to sync";
