...
@Schema(name = "AddCrossRealmTrustV2Response")
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public class AddCrossRealmTrustV2Response extends PrepareCrossRealmTrustBase {
    ...
    public String toString() {
        return "AddCrossRealmTrustV2Response{" +
