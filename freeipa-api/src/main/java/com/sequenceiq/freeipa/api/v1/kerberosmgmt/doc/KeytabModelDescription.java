...
public class KeytabModelDescription {
    ...
    public static final String SERVICE_HOST = "Hostname (FQDN) where the service is running";
    public static final String SERVICE_HOST_ALIAS = "Alias name for the service";
