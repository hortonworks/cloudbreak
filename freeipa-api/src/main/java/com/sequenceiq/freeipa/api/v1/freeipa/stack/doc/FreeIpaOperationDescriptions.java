...
public final class FreeIpaOperationDescriptions {
    ...
    public static final String INTERNAL_GET_OUTBOUND_TYPE_NO_ACTOR =
            "Get the outbound type of the FreeIPA stack by environment CRN using the internal actor";
    ...
    public static final String DELETE_USER_DEFINED_TAGS_BY_CRN = "Deletes user defined tags from FreeIPA instances";
