...
public enum Status {
    ...
    public static final Collection<Status> REMOVABLE_STATUSES =
            List.of(AVAILABLE, UPDATE_FAILED, CREATE_FAILED, DELETE_FAILED, DELETE_COMPLETED, STOPPED, START_FAILED,
                    STOP_FAILED, REPAIR_FAILED, UPSCALE_FAILED, UPSCALE_VALIDATION_FAILED, DOWNSCALE_FAILED,
                    UPGRADE_CCM_FAILED, UPGRADE_DEFAULT_OUTBOUND_FAILED, MODIFY_PROXY_CONFIG_FAILED);

    public static final Collection<Status> FAILED_STATUSES =
            List.of(UPDATE_FAILED, CREATE_FAILED, DELETE_FAILED, START_FAILED, STOP_FAILED, REPAIR_FAILED,
                    REPAIR_FAILED, UPSCALE_FAILED, UPSCALE_VALIDATION_FAILED, DOWNSCALE_FAILED, UPGRADE_CCM_FAILED,
                    UPGRADE_DEFAULT_OUTBOUND_FAILED, MODIFY_PROXY_CONFIG_FAILED);

    public static final Collection<Status> FREEIPA_UNREACHABLE_STATUSES =
            List.of(REQUESTED, UNREACHABLE, STOPPED, DELETED_ON_PROVIDER_SIDE, DELETE_IN_PROGRESS,
                    DELETE_COMPLETED, STALE);

    public static final Collection<Status> FREEIPA_VERTICALLY_NON_SCALABLE_STATUSES =
            List.of(DELETED_ON_PROVIDER_SIDE, DELETE_IN_PROGRESS, DELETE_COMPLETED);

    public static final Collection<Status> FREEIPA_CROSS_REALM_SETUP_FINISH_ENABLE_STATUSES =
            List.of(TRUST_SETUP_FINISH_REQUIRED, TRUST_SETUP_FINISH_FAILED, AVAILABLE);

    public static final Collection<Status> FREEIPA_CROSS_REALM_SETUP_ENABLE_STATUSES =
            List.of(AVAILABLE, TRUST_SETUP_FAILED, CANCEL_TRUST_SETUP_SUCCESSFUL);
    ...
    public static final Collection<Status> FREEIPA_SYNC_DISABLED_STATUSES = List.of(
            REQUESTED,
            CREATE_IN_PROGRESS,
            STACK_AVAILABLE,
            DELETE_IN_PROGRESS,
    ...
    private static final Map<Status, Status> IN_PROGRESS_TO_FINAL_STATUS_MAPPING = ImmutableMap.<Status, Status>builder()
            ...
            .put(REBUILD_VALIDATION_FAILED, REBUILD_VALIDATION_FAILED)
