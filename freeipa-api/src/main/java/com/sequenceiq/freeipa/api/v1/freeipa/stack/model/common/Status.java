...
public enum Status {
    ...
    REBUILD_FAILED,
    STALE,
    PREPARE_CROSS_REALM_TRUST_IN_PROGRESS,
    PREPARE_CROSS_REALM_TRUST_PENDING,
    PREPARE_CROSS_REALM_TRUST_FAILED,
    FINISH_CROSS_REALM_TRUST_SUCCESSFUL,
    FINISH_CROSS_REALM_TRUST_FAILED,
    FINISH_CROSS_REALM_TRUST_IN_PROGRESS;
    ...
    public static final Collection<Status> FAILED_STATUSES = List.of(UPDATE_FAILED, CREATE_FAILED, DELETE_FAILED, START_FAILED,
            STOP_FAILED, REPAIR_FAILED, UPSCALE_FAILED, DOWNSCALE_FAILED, UPGRADE_CCM_FAILED, MODIFY_PROXY_CONFIG_FAILED);
    ...
    private static final Map<Status, Status> IN_PROGRESS_TO_FINAL_STATUS_MAPPING = ImmutableMap.<Status, Status>builder()
            ...
            .put(PREPARE_CROSS_REALM_TRUST_IN_PROGRESS, PREPARE_CROSS_REALM_TRUST_FAILED)
            .put(FINISH_CROSS_REALM_TRUST_IN_PROGRESS, FINISH_CROSS_REALM_TRUST_FAILED)
            .build();
    ...
    public boolean isInProgress() {
        return switch (this) {
            case REQUESTED, UPDATE_REQUESTED, STOP_REQUESTED, START_REQUESTED, MODIFY_PROXY_CONFIG_REQUESTED, CREATE_IN_PROGRESS, UPDATE_IN_PROGRESS,
                 ...
                 UPGRADE_CCM_IN_PROGRESS, START_IN_PROGRESS, WAIT_FOR_SYNC, REBUILD_IN_PROGRESS, PREPARE_CROSS_REALM_TRUST_IN_PROGRESS,
                 FINISH_CROSS_REALM_TRUST_IN_PROGRESS -> true;
            default -> false;
        };
    }
