...
public enum DetailedStackStatus {
    ...
    PREPARE_CROSS_REALM_TRUST_IN_PROGRESS(Status.PREPARE_CROSS_REALM_TRUST_IN_PROGRESS, AvailabilityStatus.UNAVAILABLE),
    PREPARE_CROSS_REALM_TRUST_PENDING(Status.PREPARE_CROSS_REALM_TRUST_PENDING, AvailabilityStatus.AVAILABLE),
    PREPARE_CROSS_REALM_TRUST_FAILED(Status.PREPARE_CROSS_REALM_TRUST_FAILED, AvailabilityStatus.UNAVAILABLE),
    FINISH_CROSS_REALM_TRUST_SUCCESSFUL(Status.FINISH_CROSS_REALM_TRUST_SUCCESSFUL, AvailabilityStatus.AVAILABLE),
    FINISH_CROSS_REALM_TRUST_FAILED(Status.FINISH_CROSS_REALM_TRUST_FAILED, AvailabilityStatus.UNAVAILABLE),
    FINISH_CROSS_REALM_TRUST_IN_PROGRESS(Status.FINISH_CROSS_REALM_TRUST_IN_PROGRESS, AvailabilityStatus.UNAVAILABLE);
