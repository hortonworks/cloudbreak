...
public enum DetailedStackStatus {
    ...
    ADDING_LOAD_BALANCER(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
    CREATING_LOAD_BALANCER_FINISHED(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.UNAVAILABLE),
    ADDING_LOAD_BALANCER_FINISHED(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
    // Start statuses
    ...
    IMAGE_CHANGE_IN_PROGRESS(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
    IMAGE_CHANGE_FINISHED(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
    IMAGE_CHANGE_FAILED(Status.UPDATE_FAILED, AvailabilityStatus.AVAILABLE),
    ...
    AWS_VARIANT_MIGRATION_IN_PROGRESS(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
    AWS_VARIANT_MIGRATION_FAILED(Status.UPDATE_FAILED, AvailabilityStatus.AVAILABLE),
    MULTI_AZ_MIGRATION_IN_PROGRESS(Status.UPDATE_IN_PROGRESS, AvailabilityStatus.AVAILABLE),
