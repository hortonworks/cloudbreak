...
public class DatabaseMigrationConfig {
    ...
    private static final String DEFAULT_SCHEMA_LOCATION_IN_SOURCE = "rdb/src/main/resources/schema";
    ...
    @Value("${rdb.schema.scripts.location:" + DEFAULT_SCHEMA_LOCATION_IN_SOURCE + '}')
    private String schemaLocation;

    @Value("${rdb.schema.migration.auto:true}")
