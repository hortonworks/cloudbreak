...
import com.sequenceiq.rdb.api.RdbApi;
import com.sequenceiq.rdb.controller.mapper.DefaultExceptionMapper;
import com.sequenceiq.rdb.controller.mapper.WebApplicationExceptionMapper;

import io.swagger.jaxrs.config.BeanConfig;
import io.swagger.jaxrs.config.SwaggerConfigLocator;
import io.swagger.jaxrs.config.SwaggerContextService;

@ApplicationPath(RdbApi.API_ROOT_CONTEXT)
@Configuration
public class EndpointConfig extends ResourceConfig {
    ...
    @Value("${rdb.structuredevent.rest.enabled:false}")
    ...
    private void registerSwagger() {
        ...
        swaggerConfig.setTitle("RDB API");
        ...
        swaggerConfig.setBasePath(RdbApi.API_ROOT_CONTEXT);
        swaggerConfig.setLicenseUrl("https://github.com/sequenceiq/cloudbreak/blob/master/LICENSE");
        swaggerConfig.setResourcePackage("com.sequenceiq.rdb.api");
