...
public class MaintenanceWindowTaskDispatchEvaluator {
    ...
    private TaskDispatchSkipReason mapImplicitPrerequisiteBlockReason(TaskDispatchSkipReason prerequisiteReason) {
        return switch (prerequisiteReason) {
            ...
            case SCHEDULE_OCCURRENCE_SKIPPED, WINDOW_ENDED, DEPENDENCY_NOT_FOUND, DEPENDENCY_SCOPE_MISMATCH,
                    IMPLICIT_PLATFORM_ORDERING, IMPLICIT_PREREQUISITE_FAILED, IMPLICIT_PREREQUISITE_SKIPPED, DEDUP_RUNNING,
                    DEDUP_COMPLETED, DEDUP_SKIPPED, RETRY_NOT_ALLOWED, RETRY_COOLDOWN ->
