...
// EnvironmentChangeCredentialV1Request environment change credential v1 request
// swagger:model EnvironmentChangeCredentialV1Request
...
func (m *EnvironmentChangeCredentialV1Request) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *EnvironmentChangeCredentialV1Request) validateCredential(formats strfmt.Registry) error {
...
func (m *EnvironmentChangeCredentialV1Request) UnmarshalBinary(b []byte) error {
	var res EnvironmentChangeCredentialV1Request
