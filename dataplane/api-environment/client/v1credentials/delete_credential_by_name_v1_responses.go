...
func (o *DeleteCredentialByNameV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCredentialByNameV1OK()
...
func NewDeleteCredentialByNameV1OK() *DeleteCredentialByNameV1OK {
	return &DeleteCredentialByNameV1OK{}
}
...
func (o *DeleteCredentialByNameV1OK) Error() string {
	return fmt.Sprintf("[DELETE /v1/credentials/name/{name}][%d] deleteCredentialByNameV1OK  %+v", 200, o.Payload)
}

func (o *DeleteCredentialByNameV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
