...
func (o *DeleteCredentialByResourceCrnV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteCredentialByResourceCrnV1OK()
...
func NewDeleteCredentialByResourceCrnV1OK() *DeleteCredentialByResourceCrnV1OK {
	return &DeleteCredentialByResourceCrnV1OK{}
}
...
func (o *DeleteCredentialByResourceCrnV1OK) Error() string {
	return fmt.Sprintf("[DELETE /v1/credentials/crn/{crn}][%d] deleteCredentialByResourceCrnV1OK  %+v", 200, o.Payload)
}

func (o *DeleteCredentialByResourceCrnV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
