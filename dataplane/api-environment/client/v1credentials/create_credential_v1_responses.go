...
func (o *CreateCredentialV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCreateCredentialV1OK()
...
func (o *CreateCredentialV1OK) Error() string {
	return fmt.Sprintf("[POST /v1/credentials][%d] createCredentialV1OK  %+v", 200, o.Payload)
}

func (o *CreateCredentialV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
