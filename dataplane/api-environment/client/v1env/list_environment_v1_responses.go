...
func (o *ListEnvironmentV1OK) Error() string {
	return fmt.Sprintf("[GET /v1/env][%d] listEnvironmentV1OK  %+v", 200, o.Payload)
}

func (o *ListEnvironmentV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
