...
func (o *DeleteEnvironmentsByCrnReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteEnvironmentsByCrnOK()
...
func (o *DeleteEnvironmentsByCrnOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/env/crn][%d] deleteEnvironmentsByCrnOK  %+v", 200, o.Payload)
}

func (o *DeleteEnvironmentsByCrnOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
