...
// NewGetProxyConfigByNameV1Params creates a new GetProxyConfigByNameV1Params object
// with the default values initialized.
func NewGetProxyConfigByNameV1Params() *GetProxyConfigByNameV1Params {
	var ()
	return &GetProxyConfigByNameV1Params{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetProxyConfigByNameV1ParamsWithTimeout creates a new GetProxyConfigByNameV1Params object
...
// NewGetProxyConfigByNameV1ParamsWithContext creates a new GetProxyConfigByNameV1Params object
...
// NewGetProxyConfigByNameV1ParamsWithHTTPClient creates a new GetProxyConfigByNameV1Params object
...
/*GetProxyConfigByNameV1Params contains all the parameters to send to the API endpoint
for the get proxy config by name v1 operation typically these are written to a http.Request
*/
type GetProxyConfigByNameV1Params struct {
