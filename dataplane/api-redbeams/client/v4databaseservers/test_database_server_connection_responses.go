...
func (o *TestDatabaseServerConnectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTestDatabaseServerConnectionOK()
...
func NewTestDatabaseServerConnectionOK() *TestDatabaseServerConnectionOK {
	return &TestDatabaseServerConnectionOK{}
}
...
func (o *TestDatabaseServerConnectionOK) Error() string {
	return fmt.Sprintf("[POST /v4/databaseservers/test][%d] testDatabaseServerConnectionOK  %+v", 200, o.Payload)
}

func (o *TestDatabaseServerConnectionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.DatabaseServerTestV4Response)
