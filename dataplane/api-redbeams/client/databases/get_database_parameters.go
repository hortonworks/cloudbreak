...
// WithEnvironmentCrn adds the environmentCrn to the get database params
func (o *GetDatabaseParams) WithEnvironmentCrn(environmentCrn string) *GetDatabaseParams {
	o.SetEnvironmentCrn(environmentCrn)
	return o
}

// SetEnvironmentCrn adds the environmentCrn to the get database params
func (o *GetDatabaseParams) SetEnvironmentCrn(environmentCrn string) {
