...
type DatabaseServerV4Responses struct {
	...
	// responses
	Responses []*DatabaseServerV4Response `json:"responses"`
}

// Validate validates this database server v4 responses
func (m *DatabaseServerV4Responses) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DatabaseServerV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *DatabaseServerV4Responses) UnmarshalBinary(b []byte) error {
	var res DatabaseServerV4Responses
