...
type ListFlexSubscriptionsByWorkspaceOK struct {
	Payload *model.FlexSubscriptionV4Responses
}

func (o *ListFlexSubscriptionsByWorkspaceOK) Error() string {
	return fmt.Sprintf("[GET /v4/{workspaceId}/flex_subscriptions][%d] listFlexSubscriptionsByWorkspaceOK  %+v", 200, o.Payload)
}
...
func (o *ListFlexSubscriptionsByWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(model.FlexSubscriptionV4Responses)
