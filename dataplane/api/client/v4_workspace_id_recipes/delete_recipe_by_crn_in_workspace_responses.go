...
func (o *DeleteRecipeByCrnInWorkspaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteRecipeByCrnInWorkspaceOK()
...
func NewDeleteRecipeByCrnInWorkspaceOK() *DeleteRecipeByCrnInWorkspaceOK {
	return &DeleteRecipeByCrnInWorkspaceOK{}
}
...
func (o *DeleteRecipeByCrnInWorkspaceOK) Error() string {
	return fmt.Sprintf("[DELETE /v4/{workspaceId}/recipes/crn/{crn}][%d] deleteRecipeByCrnInWorkspaceOK  %+v", 200, o.Payload)
}

func (o *DeleteRecipeByCrnInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
