...
type ChangeCredentialInEnvironmentParams struct {
	...
	/*Body*/
	Body *model.EnvironmentChangeCredentialV4Request
	/*Name*/
	Name string
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *ChangeCredentialInEnvironmentParams) WithBody(body *model.EnvironmentChangeCredentialV4Request) *ChangeCredentialInEnvironmentParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change credential in environment params
func (o *ChangeCredentialInEnvironmentParams) SetBody(body *model.EnvironmentChangeCredentialV4Request) {
	o.Body = body
}
