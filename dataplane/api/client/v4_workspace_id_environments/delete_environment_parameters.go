...
func (o *DeleteEnvironmentParams) WithWorkspaceID(workspaceID int64) *DeleteEnvironmentParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the delete environment params
func (o *DeleteEnvironmentParams) SetWorkspaceID(workspaceID int64) {
