...
type CreateSmartSenseSubscriptionInWorkspaceParams struct {
	...
	/*Body*/
	Body *model.SmartSenseSubscriptionV4Response
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *CreateSmartSenseSubscriptionInWorkspaceParams) WithBody(body *model.SmartSenseSubscriptionV4Response) *CreateSmartSenseSubscriptionInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create smart sense subscription in workspace params
func (o *CreateSmartSenseSubscriptionInWorkspaceParams) SetBody(body *model.SmartSenseSubscriptionV4Response) {
	o.Body = body
}
