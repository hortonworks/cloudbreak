...
func (o *GetEncryptionKeysParams) WithBody(body *model.PlatformResourceRequestJSON) *GetEncryptionKeysParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get encryption keys params
func (o *GetEncryptionKeysParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
