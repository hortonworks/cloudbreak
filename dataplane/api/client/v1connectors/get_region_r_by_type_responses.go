...
func (o *GetRegionRByTypeOK) Error() string {
	return fmt.Sprintf("[GET /v1/connectors/regions/r/{type}][%d] getRegionRByTypeOK  %+v", 200, o.Payload)
}

func (o *GetRegionRByTypeOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
