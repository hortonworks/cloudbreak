...
func (o *GetPlatformNetworksParams) WithBody(body *model.PlatformResourceRequestJSON) *GetPlatformNetworksParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get platform networks params
func (o *GetPlatformNetworksParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
