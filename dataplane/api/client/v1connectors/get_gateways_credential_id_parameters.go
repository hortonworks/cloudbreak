...
func (o *GetGatewaysCredentialIDParams) WithBody(body *model.PlatformResourceRequestJSON) *GetGatewaysCredentialIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get gateways credential Id params
func (o *GetGatewaysCredentialIDParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
