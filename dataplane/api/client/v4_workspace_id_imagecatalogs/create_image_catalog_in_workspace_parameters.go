...
type CreateImageCatalogInWorkspaceParams struct {
	...
	/*Body*/
	Body *model.ImageCatalogV4Request
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *CreateImageCatalogInWorkspaceParams) WithBody(body *model.ImageCatalogV4Request) *CreateImageCatalogInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create image catalog in workspace params
func (o *CreateImageCatalogInWorkspaceParams) SetBody(body *model.ImageCatalogV4Request) {
	o.Body = body
}
