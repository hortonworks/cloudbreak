...
type GetImageCatalogRequestFromNameInWorkspaceOK struct {
	Payload *model.ImageCatalogV4Request
}

func (o *GetImageCatalogRequestFromNameInWorkspaceOK) Error() string {
	return fmt.Sprintf("[GET /v4/{workspaceId}/image_catalogs/{name}/request][%d] getImageCatalogRequestFromNameInWorkspaceOK  %+v", 200, o.Payload)
}
...
func (o *GetImageCatalogRequestFromNameInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(model.ImageCatalogV4Request)
