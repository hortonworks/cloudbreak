...
func (o *DeleteDistroXV1ByCrnReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	result := NewDeleteDistroXV1ByCrnDefault(response.Code())
...
func NewDeleteDistroXV1ByCrnDefault(code int) *DeleteDistroXV1ByCrnDefault {
	return &DeleteDistroXV1ByCrnDefault{
		_statusCode: code,
	}
}
...
func (o *DeleteDistroXV1ByCrnDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/distrox/crn/{crn}][%d] deleteDistroXV1ByCrn default ", o._statusCode)
}

func (o *DeleteDistroXV1ByCrnDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
