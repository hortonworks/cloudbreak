...
type CreateSmartSenseSubscriptionInWorkspaceParams struct {
	...
	/*Body*/
	Body *model.SmartSenseSubscriptionJSON
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *CreateSmartSenseSubscriptionInWorkspaceParams) WithBody(body *model.SmartSenseSubscriptionJSON) *CreateSmartSenseSubscriptionInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create smart sense subscription in workspace params
func (o *CreateSmartSenseSubscriptionInWorkspaceParams) SetBody(body *model.SmartSenseSubscriptionJSON) {
	o.Body = body
}
...
func (o *CreateSmartSenseSubscriptionInWorkspaceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.SmartSenseSubscriptionJSON)
	}
