...
func (o *GetVMTypesByCredentialIDParams) WithBody(body *model.PlatformResourceRequestJSON) *GetVMTypesByCredentialIDParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get Vm types by credential Id params
func (o *GetVMTypesByCredentialIDParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
