...
// WithClusterDefinitionName adds the clusterDefinitionName to the create recommendation for workspace params
func (o *CreateRecommendationForWorkspaceParams) WithClusterDefinitionName(clusterDefinitionName *string) *CreateRecommendationForWorkspaceParams {
	o.SetClusterDefinitionName(clusterDefinitionName)
	return o
}

// SetClusterDefinitionName adds the clusterDefinitionName to the create recommendation for workspace params
func (o *CreateRecommendationForWorkspaceParams) SetClusterDefinitionName(clusterDefinitionName *string) {
...
func (o *CreateRecommendationForWorkspaceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ClusterDefinitionName != nil {

		// query param clusterDefinitionName
		var qrClusterDefinitionName string
		if o.ClusterDefinitionName != nil {
