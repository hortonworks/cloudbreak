...
func (o *CreateLdapConfigsInWorkspaceParams) WithBody(body *model.LdapConfigRequest) *CreateLdapConfigsInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create ldap configs in workspace params
func (o *CreateLdapConfigsInWorkspaceParams) SetBody(body *model.LdapConfigRequest) {
	o.Body = body
}
