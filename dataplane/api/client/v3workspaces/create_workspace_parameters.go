...
func (o *CreateWorkspaceParams) WithBody(body *model.WorkspaceRequest) *CreateWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create workspace params
func (o *CreateWorkspaceParams) SetBody(body *model.WorkspaceRequest) {
	o.Body = body
}
...
func (o *CreateWorkspaceParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.WorkspaceRequest)
	}
