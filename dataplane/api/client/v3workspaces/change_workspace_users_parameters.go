...
func (o *ChangeWorkspaceUsersParams) WithBody(body []*model.ChangeWorkspaceUsersJSON) *ChangeWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change workspace users params
func (o *ChangeWorkspaceUsersParams) SetBody(body []*model.ChangeWorkspaceUsersJSON) {
	o.Body = body
}
