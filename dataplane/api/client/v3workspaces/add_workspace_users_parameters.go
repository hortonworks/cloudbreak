...
func (o *AddWorkspaceUsersParams) WithBody(body []*model.ChangeWorkspaceUsersJSON) *AddWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add workspace users params
func (o *AddWorkspaceUsersParams) SetBody(body []*model.ChangeWorkspaceUsersJSON) {
	o.Body = body
}
