...
// WithWorkspaceID adds the workspaceID to the get tag specifications params
func (o *GetTagSpecificationsParams) WithWorkspaceID(workspaceID int64) *GetTagSpecificationsParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the get tag specifications params
func (o *GetTagSpecificationsParams) SetWorkspaceID(workspaceID int64) {
