...
type PostLdapConnectionTestInWorkspaceOK struct {
	Payload *model.LdapTestV4Response
}

func (o *PostLdapConnectionTestInWorkspaceOK) Error() string {
	return fmt.Sprintf("[POST /v4/{workspaceId}/ldaps/test][%d] postLdapConnectionTestInWorkspaceOK  %+v", 200, o.Payload)
}
...
func (o *PostLdapConnectionTestInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(model.LdapTestV4Response)
