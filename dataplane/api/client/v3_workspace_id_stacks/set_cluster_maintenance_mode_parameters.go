...
type SetClusterMaintenanceModeParams struct {
	...
	/*Body*/
	Body *model.MaintenanceModeJSON
	/*Name*/
	Name string
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *SetClusterMaintenanceModeParams) WithBody(body *model.MaintenanceModeJSON) *SetClusterMaintenanceModeParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the set cluster maintenance mode params
func (o *SetClusterMaintenanceModeParams) SetBody(body *model.MaintenanceModeJSON) {
	o.Body = body
}
...
func (o *SetClusterMaintenanceModeParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.MaintenanceModeJSON)
	}
