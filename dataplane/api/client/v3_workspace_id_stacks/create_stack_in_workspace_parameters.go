...
func (o *CreateStackInWorkspaceParams) WithBody(body *model.StackV2Request) *CreateStackInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create stack in workspace params
func (o *CreateStackInWorkspaceParams) SetBody(body *model.StackV2Request) {
	o.Body = body
}
