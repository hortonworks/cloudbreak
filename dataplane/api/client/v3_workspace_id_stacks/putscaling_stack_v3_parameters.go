...
type PutscalingStackV3Params struct {
	...
	/*Body*/
	Body *model.StackScaleRequestV2
	/*Name*/
	Name string
	/*WorkspaceID*/
	WorkspaceID int64
...
func (o *PutscalingStackV3Params) WithBody(body *model.StackScaleRequestV2) *PutscalingStackV3Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the putscaling stack v3 params
func (o *PutscalingStackV3Params) SetBody(body *model.StackScaleRequestV2) {
	o.Body = body
}
...
func (o *PutscalingStackV3Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.StackScaleRequestV2)
	}
