...
func (o *GetServiceVersionsByBlueprintNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetServiceVersionsByBlueprintNameOK()
...
func (o *GetServiceVersionsByBlueprintNameOK) Error() string {
	return fmt.Sprintf("[GET /v4/{workspaceId}/blueprints_util/service_versions][%d] getServiceVersionsByBlueprintNameOK  %+v", 200, o.Payload)
}

func (o *GetServiceVersionsByBlueprintNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.BlueprintServicesV4Response)
