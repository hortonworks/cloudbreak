...
func (o *DeleteClusterTemplatesInWorkspaceReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteClusterTemplatesInWorkspaceOK()
...
func NewDeleteClusterTemplatesInWorkspaceOK() *DeleteClusterTemplatesInWorkspaceOK {
	return &DeleteClusterTemplatesInWorkspaceOK{}
}
...
func (o *DeleteClusterTemplatesInWorkspaceOK) Error() string {
	return fmt.Sprintf("[DELETE /v4/{workspaceId}/cluster_templates][%d] deleteClusterTemplatesInWorkspaceOK  %+v", 200, o.Payload)
}

func (o *DeleteClusterTemplatesInWorkspaceOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.ClusterTemplateV4Responses)
