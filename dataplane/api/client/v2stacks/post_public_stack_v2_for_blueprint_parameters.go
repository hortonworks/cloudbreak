...
func (o *PostPublicStackV2ForBlueprintParams) WithBody(body *model.StackV2Request) *PostPublicStackV2ForBlueprintParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post public stack v2 for blueprint params
func (o *PostPublicStackV2ForBlueprintParams) SetBody(body *model.StackV2Request) {
	o.Body = body
}
