...
func (o *PutscalingStackV2Params) WithBody(body *model.StackScaleRequestV2) *PutscalingStackV2Params {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the putscaling stack v2 params
func (o *PutscalingStackV2Params) SetBody(body *model.StackScaleRequestV2) {
	o.Body = body
}
