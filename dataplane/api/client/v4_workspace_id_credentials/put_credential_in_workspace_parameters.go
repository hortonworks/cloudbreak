...
func (o *PutCredentialInWorkspaceParams) WithBody(body *model.CredentialV4Request) *PutCredentialInWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the put credential in workspace params
func (o *PutCredentialInWorkspaceParams) SetBody(body *model.CredentialV4Request) {
	o.Body = body
}
