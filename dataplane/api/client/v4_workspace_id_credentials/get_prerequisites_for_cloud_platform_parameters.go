...
// SetWorkspaceID adds the workspaceId to the get prerequisites for cloud platform params
func (o *GetPrerequisitesForCloudPlatformParams) SetWorkspaceID(workspaceID int64) {
