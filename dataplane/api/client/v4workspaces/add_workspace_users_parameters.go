...
func (o *AddWorkspaceUsersParams) WithBody(body *model.ChangeWorkspaceUsersV4Requests) *AddWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add workspace users params
func (o *AddWorkspaceUsersParams) SetBody(body *model.ChangeWorkspaceUsersV4Requests) {
	o.Body = body
}
