...
func (o *UpdateWorkspaceUsersParams) WithBody(body *model.ChangeWorkspaceUsersV4Requests) *UpdateWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update workspace users params
func (o *UpdateWorkspaceUsersParams) SetBody(body *model.ChangeWorkspaceUsersV4Requests) {
	o.Body = body
}
