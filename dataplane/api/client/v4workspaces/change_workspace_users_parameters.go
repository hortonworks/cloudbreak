...
type ChangeWorkspaceUsersParams struct {
	...
	/*Body*/
	Body *model.ChangeWorkspaceUsersV4Requests
	/*Name*/
	Name string
...
func (o *ChangeWorkspaceUsersParams) WithBody(body *model.ChangeWorkspaceUsersV4Requests) *ChangeWorkspaceUsersParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change workspace users params
func (o *ChangeWorkspaceUsersParams) SetBody(body *model.ChangeWorkspaceUsersV4Requests) {
	o.Body = body
}
