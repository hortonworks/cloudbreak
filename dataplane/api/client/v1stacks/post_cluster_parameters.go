...
func (o *PostClusterParams) WithBody(body *model.ClusterRequest) *PostClusterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the post cluster params
func (o *PostClusterParams) SetBody(body *model.ClusterRequest) {
	o.Body = body
}
...
func (o *PostClusterParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.Body == nil {
		o.Body = new(model.ClusterRequest)
	}
