...
func (o *ValidateStackParams) WithBody(body *model.StackValidationRequest) *ValidateStackParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the validate stack params
func (o *ValidateStackParams) SetBody(body *model.StackValidationRequest) {
	o.Body = body
}
