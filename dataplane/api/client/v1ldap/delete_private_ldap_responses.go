...
func (o *DeletePrivateLdapDefault) Error() string {
	return fmt.Sprintf("[DELETE /v1/ldap/user/{name}][%d] deletePrivateLdap default ", o._statusCode)
}

func (o *DeletePrivateLdapDefault) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
