...
func (o *GetPlatformSShKeysForWorkspaceParams) WithBody(body *model.PlatformResourceRequestJSON) *GetPlatformSShKeysForWorkspaceParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the get platform s sh keys for workspace params
func (o *GetPlatformSShKeysForWorkspaceParams) SetBody(body *model.PlatformResourceRequestJSON) {
	o.Body = body
}
