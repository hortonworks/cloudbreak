...
func (m *CompactRegionResponse) validateValues(formats strfmt.Registry) error {
...
func (m *CompactRegionResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CompactRegionResponse) UnmarshalBinary(b []byte) error {
	var res CompactRegionResponse
