...
// ClouderaManagerV1Request cloudera manager v1 request
// swagger:model ClouderaManagerV1Request
...
func (m *ClouderaManagerV1Request) validateProducts(formats strfmt.Registry) error {
...
func (m *ClouderaManagerV1Request) validateRepository(formats strfmt.Registry) error {
...
func (m *ClouderaManagerV1Request) UnmarshalBinary(b []byte) error {
	var res ClouderaManagerV1Request
