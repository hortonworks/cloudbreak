...
// DurationV4Request duration v4 request
// swagger:model DurationV4Request
...
func (m *DurationV4Request) validateDays(formats strfmt.Registry) error {
...
func (m *DurationV4Request) validateHours(formats strfmt.Registry) error {
...
func (m *DurationV4Request) validateMinutes(formats strfmt.Registry) error {
