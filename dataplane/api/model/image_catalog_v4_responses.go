...
// ImageCatalogV4Responses image catalog v4 responses
// swagger:model ImageCatalogV4Responses
...
func (m *ImageCatalogV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *ImageCatalogV4Responses) UnmarshalBinary(b []byte) error {
	var res ImageCatalogV4Responses
