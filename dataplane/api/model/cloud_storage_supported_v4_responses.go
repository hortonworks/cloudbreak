...
// CloudStorageSupportedV4Responses cloud storage supported v4 responses
// swagger:model CloudStorageSupportedV4Responses
...
func (m *CloudStorageSupportedV4Responses) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CloudStorageSupportedV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *CloudStorageSupportedV4Responses) UnmarshalBinary(b []byte) error {
	var res CloudStorageSupportedV4Responses
