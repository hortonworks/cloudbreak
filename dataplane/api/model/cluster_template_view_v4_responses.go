...
// ClusterTemplateViewV4Responses cluster template view v4 responses
// swagger:model ClusterTemplateViewV4Responses
...
func (m *ClusterTemplateViewV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *ClusterTemplateViewV4Responses) UnmarshalBinary(b []byte) error {
	var res ClusterTemplateViewV4Responses
