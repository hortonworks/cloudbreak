...
// ClouderaManagerProductV1Request cloudera manager product v1 request
// swagger:model ClouderaManagerProductV1Request
...
func (m *ClouderaManagerProductV1Request) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClouderaManagerProductV1Request) validateName(formats strfmt.Registry) error {
...
func (m *ClouderaManagerProductV1Request) UnmarshalBinary(b []byte) error {
	var res ClouderaManagerProductV1Request
