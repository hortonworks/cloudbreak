...
// AuditEventV4Responses audit event v4 responses
// swagger:model AuditEventV4Responses
...
func (m *AuditEventV4Responses) validateResponses(formats strfmt.Registry) error {
