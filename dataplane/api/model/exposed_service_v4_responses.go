...
// ExposedServiceV4Responses exposed service v4 responses
// swagger:model ExposedServiceV4Responses
...
func (m *ExposedServiceV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *ExposedServiceV4Responses) UnmarshalBinary(b []byte) error {
	var res ExposedServiceV4Responses
