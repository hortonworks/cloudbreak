...
// StackViewV4Responses stack view v4 responses
// swagger:model StackViewV4Responses
...
func (m *StackViewV4Responses) validateResponses(formats strfmt.Registry) error {
