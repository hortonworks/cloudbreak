...
// SupportedVersionV4Response supported version v4 response
// swagger:model SupportedVersionV4Response
...
func (m *SupportedVersionV4Response) validateServices(formats strfmt.Registry) error {
...
func (m *SupportedVersionV4Response) UnmarshalBinary(b []byte) error {
	var res SupportedVersionV4Response
