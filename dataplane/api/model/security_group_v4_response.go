...
// SecurityGroupV4Response security group v4 response
// swagger:model SecurityGroupV4Response
...
func (m *SecurityGroupV4Response) validateSecurityGroupIds(formats strfmt.Registry) error {
...
func (m *SecurityGroupV4Response) validateSecurityRules(formats strfmt.Registry) error {
...
func (m *SecurityGroupV4Response) UnmarshalBinary(b []byte) error {
	var res SecurityGroupV4Response
