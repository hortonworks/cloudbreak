...
// WorkspaceV4Responses workspace v4 responses
// swagger:model WorkspaceV4Responses
...
func (m *WorkspaceV4Responses) validateResponses(formats strfmt.Registry) error {
