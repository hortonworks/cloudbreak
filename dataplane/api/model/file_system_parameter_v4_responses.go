...
// FileSystemParameterV4Responses file system parameter v4 responses
// swagger:model FileSystemParameterV4Responses
...
func (m *FileSystemParameterV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *FileSystemParameterV4Responses) UnmarshalBinary(b []byte) error {
	var res FileSystemParameterV4Responses
