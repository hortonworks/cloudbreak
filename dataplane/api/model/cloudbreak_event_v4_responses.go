...
// CloudbreakEventV4Responses cloudbreak event v4 responses
// swagger:model CloudbreakEventV4Responses
...
func (m *CloudbreakEventV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *CloudbreakEventV4Responses) UnmarshalBinary(b []byte) error {
	var res CloudbreakEventV4Responses
