...
// ClouderaManagerRepositoryV1Request cloudera manager repository v1 request
// swagger:model ClouderaManagerRepositoryV1Request
...
func (m *ClouderaManagerRepositoryV1Request) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClouderaManagerRepositoryV1Request) validateVersion(formats strfmt.Registry) error {
...
func (m *ClouderaManagerRepositoryV1Request) UnmarshalBinary(b []byte) error {
	var res ClouderaManagerRepositoryV1Request
