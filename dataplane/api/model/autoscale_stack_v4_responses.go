...
// AutoscaleStackV4Responses autoscale stack v4 responses
// swagger:model AutoscaleStackV4Responses
...
func (m *AutoscaleStackV4Responses) validateResponses(formats strfmt.Registry) error {
...
func (m *AutoscaleStackV4Responses) UnmarshalBinary(b []byte) error {
	var res AutoscaleStackV4Responses
