...
// WithID adds the id to the get sync users status v1 params
func (o *GetSyncUsersStatusV1Params) WithID(id *string) *GetSyncUsersStatusV1Params {
	o.SetID(id)
	return o
}

// SetID adds the id to the get sync users status v1 params
func (o *GetSyncUsersStatusV1Params) SetID(id *string) {
	o.ID = id
}
