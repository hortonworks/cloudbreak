...
// SecurityRuleV1Response security rule v1 response
// swagger:model SecurityRuleV1Response
...
func (m *SecurityRuleV1Response) validatePorts(formats strfmt.Registry) error {
...
func (m *SecurityRuleV1Response) validateProtocol(formats strfmt.Registry) error {
...
func (m *SecurityRuleV1Response) validateSubnet(formats strfmt.Registry) error {
...
func (m *SecurityRuleV1Response) UnmarshalBinary(b []byte) error {
	var res SecurityRuleV1Response
