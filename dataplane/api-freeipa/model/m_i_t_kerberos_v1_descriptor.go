...
// MITKerberosV1Descriptor m i t kerberos v1 descriptor
...
func (m *MITKerberosV1Descriptor) validateAdminURL(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validateNameServers(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validatePassword(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validatePrincipal(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validateRealm(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validateTCPAllowed(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) validateURL(formats strfmt.Registry) error {
...
func (m *MITKerberosV1Descriptor) UnmarshalBinary(b []byte) error {
	var res MITKerberosV1Descriptor
