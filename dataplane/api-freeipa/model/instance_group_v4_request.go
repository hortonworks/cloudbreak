...
const (
	...
	// InstanceGroupV4RequestTypeMASTER captures enum value "MASTER"
	InstanceGroupV4RequestTypeMASTER string = "MASTER"

	// InstanceGroupV4RequestTypeSLAVE captures enum value "SLAVE"
	InstanceGroupV4RequestTypeSLAVE string = "SLAVE"
)
