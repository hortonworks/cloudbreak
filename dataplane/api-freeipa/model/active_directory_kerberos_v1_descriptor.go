...
// ActiveDirectoryKerberosV1Descriptor active directory kerberos v1 descriptor
...
func (m *ActiveDirectoryKerberosV1Descriptor) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateAdminURL(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateContainerDn(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateLdapURL(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateNameServers(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validatePassword(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validatePrincipal(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateRealm(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateTCPAllowed(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) validateURL(formats strfmt.Registry) error {
...
func (m *ActiveDirectoryKerberosV1Descriptor) UnmarshalBinary(b []byte) error {
	var res ActiveDirectoryKerberosV1Descriptor
