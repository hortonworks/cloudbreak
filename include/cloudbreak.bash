...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.12.0-dev.2
    env-import DOCKER_TAG_CLOUDBREAK 1.12.0-dev.2
    env-import DOCKER_TAG_ULUWATU 1.12.0-dev.2
    env-import DOCKER_TAG_SULTANS 1.12.0-dev.2
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.12.0-dev.2
