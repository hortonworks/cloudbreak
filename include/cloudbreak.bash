...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.3.0-dev.123
    env-import DOCKER_TAG_CLOUDBREAK 1.3.0-dev.123
    env-import DOCKER_TAG_ULUWATU 1.3.0-dev.123
    env-import DOCKER_TAG_SULTANS 1.3.0-dev.123
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.3.0-dev.123
