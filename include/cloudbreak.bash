...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.17.0-dev.3
    env-import DOCKER_TAG_CLOUDBREAK 1.17.0-dev.3
    env-import DOCKER_TAG_ULUWATU 1.17.0-dev.3
    env-import DOCKER_TAG_SULTANS 1.17.0-dev.3
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.17.0-dev.3
