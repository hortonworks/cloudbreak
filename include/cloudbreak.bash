...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.16.0-dev.26
    env-import DOCKER_TAG_CLOUDBREAK 1.16.0-dev.26
    env-import DOCKER_TAG_ULUWATU 1.16.0-dev.26
    env-import DOCKER_TAG_SULTANS 1.16.0-dev.26
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.16.0-dev.26
    env-import DOCKER_TAG_POSTGRES 9.6.1-alpine

    env-import DOCKER_TAG_CBD_SMARTSENSE 0.5.0
