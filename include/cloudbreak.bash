...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.8.0-rc.95
    env-import DOCKER_TAG_CLOUDBREAK 2.8.0-rc.95
    env-import DOCKER_TAG_ULUWATU 2.8.0-rc.95
    env-import DOCKER_TAG_SULTANS 2.8.0-rc.95
