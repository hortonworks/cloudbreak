...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.5.0-dev.3
    env-import DOCKER_TAG_CLOUDBREAK 2.5.0-dev.3
    env-import DOCKER_TAG_ULUWATU 2.5.0-dev.3
    env-import DOCKER_TAG_SULTANS 2.5.0-dev.3
