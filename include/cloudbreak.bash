...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.7.0-dev.70
    env-import DOCKER_TAG_CLOUDBREAK 2.7.0-dev.70
    env-import DOCKER_TAG_ULUWATU 2.7.0-dev.70
    env-import DOCKER_TAG_SULTANS 2.7.0-dev.70
