...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.7.0-dev.15
    env-import DOCKER_TAG_CLOUDBREAK 1.7.0-dev.15
    env-import DOCKER_TAG_ULUWATU 1.7.0-dev.15
    env-import DOCKER_TAG_SULTANS 1.7.0-dev.15
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.7.0-dev.15
