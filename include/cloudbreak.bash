...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 1.8.0-dev.14
    env-import DOCKER_TAG_CLOUDBREAK 1.8.0-dev.14
    env-import DOCKER_TAG_ULUWATU 1.8.0-dev.14
    env-import DOCKER_TAG_SULTANS 1.8.0-dev.14
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 1.8.0-dev.14
