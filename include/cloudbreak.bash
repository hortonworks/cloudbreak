...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.2.0-dev.22
    env-import DOCKER_TAG_CLOUDBREAK 2.2.0-dev.22
    env-import DOCKER_TAG_ULUWATU 2.2.0-dev.22
    env-import DOCKER_TAG_SULTANS 2.2.0-dev.22
    env-import DOCKER_TAG_CLOUDBREAK_SHELL 2.2.0-dev.22
