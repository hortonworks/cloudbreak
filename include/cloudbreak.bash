...
cloudbreak-conf-tags() {
    ...
    env-import DOCKER_TAG_PERISCOPE 2.6.0-rc.15
    env-import DOCKER_TAG_CLOUDBREAK 2.6.0-rc.15
    env-import DOCKER_TAG_ULUWATU 2.6.0-rc.15
    env-import DOCKER_TAG_SULTANS 2.6.0-rc.15
